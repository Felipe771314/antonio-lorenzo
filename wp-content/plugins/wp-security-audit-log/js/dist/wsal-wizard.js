try {
  jQuery(document).ready(function () {
    jQuery('#editor-users-add, #editor-roles-add, #exuser-query-add, #exrole-query-add, #ipaddr-query-add').click(
      function () {
    ...
    jQuery(
      '#editor-users-box, #editor-roles-box, #exuser-query-box, #exrole-query-box, #ipaddr-query-box',
    ...
    jQuery('#editor-list>span>a, #exuser-list>span>a, #exrole-list>span>a, #ipaddr-list>span>a').click(
      removeSecToken,
    );
  ...
  console.error('An error has occurred wsal-wizard.js: ' + e.stack);
}
