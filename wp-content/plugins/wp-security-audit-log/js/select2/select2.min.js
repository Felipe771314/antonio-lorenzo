                    ...
                    e.opened() &&
                      ...
                      c.more === !0
                        ? (b
                            .detach()
                            .appendTo(a)
                            .text(K(e.opts.formatLoadMore, e.opts.element, d + 1)),
                          window.setTimeout(function () {
                            e.loadMoreIfNeeded();
                          }, 10))
                        : b.remove(),
            ...
            function m() {
              d.removeClass('select2-active'),
                ...
                e.find('.select2-no-results,.select2-selection-limit,.select2-searching').length
                  ...
                  : h.liveRegion.text(h.opts.formatMatches(e.find('.select2-result-selectable').length));
            }
            function n(a) {
              e.html(a), m();
            }
                ...
                this.bind(function (a) {
                  if (this.isInterfaceEnabled()) {
                    ...
                    if (
                      ...
                      return (
                        this.selectChoice(d.find('.select2-search-choice:not(.select2-locked)').last()), A(a), void 0
                      );
