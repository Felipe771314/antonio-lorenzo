...
jQuery(document).ready(function () {
  ...
  jQuery(
    '.js-query-box, #ViewerQueryBox, #EditorQueryBox, #ExRoleQueryBox, #ExUserQueryBox, #ExUserSubjectQueryBox, #CustomQueryBox, #IpAddrQueryBox, #IpAddrSubjectQueryBox, #ExCPTsQueryBox, #ExURLsQueryBox',
  ...
  jQuery(
    '.js-query-add, #ViewerQueryAdd, #EditorQueryAdd, #ExRoleQueryAdd, #ExUserQueryAdd, #CustomQueryAdd, #IpAddrQueryAdd, #ExCPTsQueryAdd, #ExURLsQueryAdd, #StatusQueryAdd',
  ).click(function () {
      ...
      function (data) {
        ...
        if (data.success) {
          ...
          jQuery('#' + type + 'List').append(
            jQuery('<span class="sectoken-' + data.tokenType + '"/>')
              .text(data.token)
              .append(
                jQuery('<input type="hidden" name="' + type + 's[]"/>').val(data.token),
                jQuery('<a href="javascript:;" title="' + wsal_data.remove + '">&times;</a>').click(
                  RemoveSecToken,
                ),
              ),
          );
  ...
  jQuery(
    '.js-list>span>a, #ViewerList>span>a, #EditorList>span>a, #ExRoleList>span>a, #ExUserList>span>a, #CustomList>span>a, #IpAddrList>span>a, #ExCPTsList>span>a, #ExURLsList>span>a, #StatusList>span>a',
  ).click(RemoveSecToken);
