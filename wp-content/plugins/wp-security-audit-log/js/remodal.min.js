...
!(function (a, b) {
  ...
  function c(a) {
    ...
    var b,
      ...
      h =
        ...
        '1';
    for (
      f = f.split(', '), g = g.split(', '), h = h.split(', '), e = 0, c = f.length, b = Number.NEGATIVE_INFINITY;
      e < c;
      e++
    )
  ...
  function m(a, c) {
    ...
    (f.settings = b.extend({}, t, c)),
      ...
      (f.$modal = a
        .addClass(q + ' ' + k('is-initialized') + ' ' + f.settings.modifier + ' ' + k('is', u.CLOSED))
        .attr('tabindex', '-1')),
      (f.$wrapper = b('<div>')
    ...
    (m.prototype.destroy = function () {
      ...
      i(this),
        ...
        0 === a &&
          (this.$overlay.remove(),
          this.$bg.removeClass(
            k('is', u.CLOSING) + ' ' + k('is', u.OPENING) + ' ' + k('is', u.CLOSED) + ' ' + k('is', u.OPENED),
          ));
    }),
    (b[p] = { lookup: [] }),
    (b.fn[p] = function (a) {
        ...
        this.each(function (e, f) {
          (d = b(f)),
            null == d.data(p)
              ? ((c = new m(d, a)),
                d.data(p, c.index),
                c.settings.hashTracking && d.attr('data-remodal-id') === location.hash.substr(1) && c.open())
