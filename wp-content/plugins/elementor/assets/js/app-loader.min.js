  ...
  var C = {
      71177: (C, T, B) => {
                      ...
                      if (C && 'object' == typeof C) {
                        ...
                        if (T) {
                          ...
                          if (4 === U)
                            ...
                            else for (var $ = B.length; $ < q.length; $++) L[$] = !0;
                            for (var V = Math.min(q.length, B.length), H = 0; H < V; H++)
                              q.hasOwnProperty(H) || (L[H] = !0), void 0 === L[H] && n(q[H]);
                          }
                        }
                      }
                    })(C.p[0]),
              ...
              (this.O = V),
                ...
                (this.produce = function (C, B, q) {
                  if ('function' == typeof C && 'function' != typeof B) {
                    ...
                    return function (C) {
                      var T = this;
                      void 0 === C && (C = L);
                      for (var q = arguments.length, W = Array(q > 1 ? q - 1 : 0), $ = 1; $ < q; $++)
                        W[$ - 1] = arguments[$];
                ...
                (this.produceWithPatches = function (C, B) {
                  if ('function' == typeof C)
                    return function (B) {
                      for (var q = arguments.length, L = Array(q > 1 ? q - 1 : 0), U = 1; U < q; U++)
                        L[U - 1] = arguments[U];
                  ...
                  for (; W; )
                    try {
                      if (
                        ((B = 1),
                        q &&
                          (L = 2 & U[0] ? q.return : U[0] ? q.throw || ((L = q.return) && L.call(q), 0) : q.next) &&
                          !(L = L.call(q, U[1])).done)
                      )
                        return L;
            ...
            var $ = null != q ? q(C) : Object.entries(C),
              ...
              _loop_2 = function (C, $) {
                ...
                if (
                  ...
                  return 'continue';
                return B($)
                  ? 'object' == typeof $ && (W = findNonSerializableValue($, H, B, q, L, U))
                    ? { value: W }
                    : void 0
        ...
        function createEntityAdapter(C) {
          ...
          return __spreadValues(__spreadValues(__spreadValues({ selectId: B, sortComparer: q }, L), U), W);
        }
                        ...
                        return __generator(this, function (te) {
                          switch (te.label) {
                            case 0:
                              return (
                                ...
                                (function isThenable(C) {
                                  ...
                                  (Z =
                                    null == (W = null == B ? void 0 : B.condition)
                                      ? void 0
                                      : W.call(B, C, {
                                          getState: V,
                                          extra: H,
                                ...
                                $(
                                  L(
                                    ...
                                    null == (J = null == B ? void 0 : B.getPendingMeta)
                                      ? void 0
                                      : J.call(B, { requestId: X, arg: C }, { getState: V, extra: H }),
                                  ),
                                ),
                                [
                                  4,
                            ...
                            case 4:
                              return (
                                (ee = te.sent()),
                                (Q = ee instanceof Ce ? U(null, X, C, ee.payload, ee.meta) : U(ee, X, C)),
                                [3, 5]
                              );
                            case 5:
                              return (
                                (B && !B.dispatchConditionRejection && U.match(Q) && Q.meta.condition) || $(Q), [2, Q]
                              );
                          }
                        });
                      });
        ...
        var createPause = function (C) {
          ...
          getListenerEntryPropsFrom = function (C) {
            ...
            return assertFunction(U, 'options.listener'), { predicate: L, type: T, effect: U };
          },
                ...
                return __generator(this, function (X) {
                  switch (X.label) {
                    ...
                    case 2:
                      return X.sent(), [3, 6];
                    case 3:
                      return (K = X.sent()) instanceof Be || safelyNotifyError(U, K, { raisedBy: 'effect' }), [3, 6];
                    case 4:
                ...
                return function () {
                  ...
                  return Object.assign({}, L, {
                    ...
                    dispatch: function (C) {
                      ...
                      try {
                        return (
                          (U = !(null == (T = null == C ? void 0 : C.meta) ? void 0 : T[Ve])),
            ...
            (0, U.default)(Close, [
              {
                ...
                value: function apply() {
                  return (
                    !!this.component.close() && (this.component.iframe.remove(), (this.component.iframe = null), !0)
                  );
                },
              },
            ]),
      ...
      98185: (C, T, B) => {
        'use strict';
        var q = B(73203);
        Object.defineProperty(T, '__esModule', { value: !0 }), (T.default = T.Load = void 0);
        var L = q(B(78983)),
          U = q(B(42081)),
          W = q(B(58724)),
          $ = q(B(71173)),
        ...
        U = (function () {
          function AppLoader() {
            (0, T.default)(this, AppLoader),
              (0, q.default)(this, 'selector', 'a.elementor-app-link, .elementor-app-link .ab-item'),
