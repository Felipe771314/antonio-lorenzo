...
/******/ (() => {
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! reselect */ '../node_modules/reselect/es/index.js',
        );
        /* harmony import */ var redux_thunk__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        function configureStore(options) {
          ...
          var middlewareEnhancer = redux__WEBPACK_IMPORTED_MODULE_0__.applyMiddleware.apply(
            void 0,
            finalMiddleware,
          );
              ...
              if (update.id in state.entities) {
                updatesPerEntity[update.id] = {
                  ...
                  changes: __spreadValues(
                    __spreadValues({}, updatesPerEntity[update.id] ? updatesPerEntity[update.id].changes : null),
                    update.changes,
                  ),
                };
              }
  ...
  \*******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _instanceType = _interopRequireDefault(
          __webpack_require__(/*! ./instance-type */ '../assets/dev/js/modules/imports/instance-type.js'),
        );
  ...
  \*******************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _commands = _interopRequireDefault(
          __webpack_require__(/*! ./core/commands */ '../modules/web-cli/assets/js/core/commands.js'),
        );
        ...
        var _components = _interopRequireDefault(
          __webpack_require__(/*! ./core/components */ '../modules/web-cli/assets/js/core/components.js'),
        );
        var _data = _interopRequireDefault(
          __webpack_require__(/*! ./core/data.js */ '../modules/web-cli/assets/js/core/data.js'),
        );
        ...
        var _hookBreak = _interopRequireDefault(
          __webpack_require__(/*! ./modules/hook-break */ '../modules/web-cli/assets/js/modules/hook-break.js'),
        );
        var _hooks = _interopRequireDefault(
          __webpack_require__(/*! ./core/hooks */ '../modules/web-cli/assets/js/core/hooks.js'),
        );
        var _routes = _interopRequireDefault(
          __webpack_require__(/*! ./core/routes */ '../modules/web-cli/assets/js/core/routes.js'),
        );
        var _shortcuts = _interopRequireDefault(
          __webpack_require__(/*! ./core/shortcuts */ '../modules/web-cli/assets/js/core/shortcuts.js'),
        );
        var _store = _interopRequireDefault(
          __webpack_require__(/*! ./core/store */ '../modules/web-cli/assets/js/core/store.js'),
        );
        var _uiStates = _interopRequireDefault(
          __webpack_require__(/*! ./core/ui-states */ '../modules/web-cli/assets/js/core/ui-states.js'),
        );
        ...
        var hookUI = _interopRequireWildcard(
          __webpack_require__(/*! ./modules/hooks/ui */ '../modules/web-cli/assets/js/modules/hooks/ui/index.js'),
        );
  ...
  \**************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _commands = _interopRequireDefault(
          __webpack_require__(/*! ./commands.js */ '../modules/web-cli/assets/js/core/commands.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \*****************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _console = _interopRequireDefault(
          __webpack_require__(/*! elementor-api/utils/console */ '../modules/web-cli/assets/js/utils/console.js'),
        );
        var _deprecation = _interopRequireDefault(
          __webpack_require__(
            /*! elementor-api/utils/deprecation */ '../modules/web-cli/assets/js/utils/deprecation.js',
            ...
            Object.defineProperty((0, _assertThisInitialized2.default)(_this), 'classes', {
              get: function get() {
                ...
                return _objectSpread(
                  _objectSpread(
                    _objectSpread(_objectSpread({}, $e.commands.commands), $e.commandsInternal.commands),
                    $e.data.commands,
                  ),
                  $e.routes.commands,
                );
            ...
            },
            {
              ...
              value: (function () {
                var _applyRunAfterAsyncResult = (0, _asyncToGenerator2.default)(
                  /*#__PURE__*/ _regenerator.default.mark(function _callee2(instance, result) {
                      ...
                      function _callee2$(_context2) {
                        while (1)
                          switch ((_context2.prev = _context2.next)) {
                            case 0:
                              // Run Data hooks.
                              (results = instance.onAfterApply(instance.args, result)),
                                (promises = Array.isArray(results)
                                  ? results.flat().filter(function (filtered) {
                  ...
                  if ($e.devTools) {
                    $e.devTools.log.warn(
                      "Command: '"
                        ...
                        .concat(instance.component.getNamespace(), "' while current component is: '")
  ...
  \*************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _cache = _interopRequireDefault(
          __webpack_require__(/*! ./data/cache */ '../modules/web-cli/assets/js/core/data/cache.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
          ...
          (0, _createClass2.default)(Data, [
            ...
            },
            {
              ...
              value: function getEndpointURL(requestData) {
                var endpoint =
                  arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : requestData.endpoint;
                // Allow to request data override default namespace and args.
                var _requestData$baseEndp = requestData.baseEndpointURL,
                  baseEndpointURL =
                    _requestData$baseEndp === void 0 ? this.args.baseEndpointURL : _requestData$baseEndp,
            ...
            },
            {
              ...
              value: function commandToEndpoint(command, args) {
                ...
                var argsQueryLength =
                  args !== null && args !== void 0 && args.query ? Object.values(args.query).length : 0;
            ...
            },
            {
              ...
              value: function prepareHeaders(requestData) {
                ...
                var type = requestData.type,
                  ...
                  params = {
                    signal:
                      (_requestData$args = requestData.args) === null || _requestData$args === void 0
                        ? void 0
                        : (_requestData$args$opt = _requestData$args.options) === null ||
            ...
            },
            {
              ...
              value: function fetch(requestData) {
                ...
                var refresh =
                    (_requestData$args$opt2 = requestData.args.options) === null ||
                    _requestData$args$opt2 === void 0
                      ? void 0
                ...
                return new Promise(
                  /*#__PURE__*/ (function () {
                    var _ref9 = (0, _asyncToGenerator2.default)(
                      /*#__PURE__*/ _regenerator.default.mark(function _callee2(resolve, reject) {
                                  ...
                                  return request.then(
                                    /*#__PURE__*/ (function () {
                                      var _ref10 = (0, _asyncToGenerator2.default)(
                                        /*#__PURE__*/ _regenerator.default.mark(function _callee(_response) {
                                          return _regenerator.default.wrap(function _callee$(_context) {
                                            while (1)
                                              switch ((_context.prev = _context.next)) {
                                                case 0:
            ...
            },
            {
              key: 'register',
              value: function register(component, command, callback) {
                (0, _get2.default)((0, _getPrototypeOf2.default)(Data.prototype), 'register', this).call(
                  this,
                  component,
                  command,
                  callback,
                ...
                var fullCommandName = component.getNamespace() + '/' + command,
                  ...
                  format =
                    commandInstance !== null && commandInstance !== void 0 && commandInstance.getEndpointFormat
            ...
            },
            {
              ...
              value: function run(type, command, args) {
                ...
                return (0, _get2.default)((0, _getPrototypeOf2.default)(Data.prototype), 'run', this).call(
                  this,
                  command,
                  args,
                );
  ...
  \**********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _baseError = _interopRequireDefault(
          __webpack_require__(/*! ./base-error */ '../modules/web-cli/assets/js/core/data/errors/base-error.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \**************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _data = _interopRequireDefault(
          __webpack_require__(/*! ./hooks/data.js */ '../modules/web-cli/assets/js/core/hooks/data.js'),
        );
        var _ui = _interopRequireDefault(
          __webpack_require__(/*! ./hooks/ui.js */ '../modules/web-cli/assets/js/core/hooks/ui.js'),
        );
        /**
  ...
  \*******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _base = _interopRequireDefault(
          __webpack_require__(/*! ./base.js */ '../modules/web-cli/assets/js/core/hooks/base.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
        ...
        var Data = /*#__PURE__*/ (function (_HooksBase) {
          ...
          (0, _createClass2.default)(Data, [
            ...
            },
            {
              ...
              value: function shouldRun(callbacks) {
                return (
                  (0, _get2.default)((0, _getPrototypeOf2.default)(Data.prototype), 'shouldRun', this).call(
                    this,
                    callbacks,
  ...
  \*****************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _base = _interopRequireDefault(
          __webpack_require__(/*! ./base */ '../modules/web-cli/assets/js/core/hooks/base.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \***************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _commands = _interopRequireDefault(
          __webpack_require__(/*! ./commands */ '../modules/web-cli/assets/js/core/commands.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
          ...
          (0, _createClass2.default)(Routes, [
            ...
            },
            {
              ...
              value: function validateRun(route) {
                var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                if (
                  !(0, _get2.default)((0, _getPrototypeOf2.default)(Routes.prototype), 'validateRun', this).call(
                    this,
                    route,
                    args,
                  )
            ...
            },
            {
              ...
              value: function beforeRun(route, args) {
                ...
                (0, _get2.default)((0, _getPrototypeOf2.default)(Routes.prototype), 'beforeRun', this).call(
                  this,
                  route,
                  args,
                  false,
            ...
            },
            {
              ...
              value: function afterRun(route, args) {
                ...
                (0, _get2.default)((0, _getPrototypeOf2.default)(Routes.prototype), 'afterRun', this).call(
                  this,
                  route,
                  args,
                  results,
            ...
            },
            {
              ...
              value: function is(route) {
                var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
                if (
                  !(0, _get2.default)((0, _getPrototypeOf2.default)(Routes.prototype), 'is', this).call(
                    this,
                    route,
                  )
                ) {
          ...
          (0, _createClass2.default)(UiStates, [
            ...
            },
            {
              ...
              value: function getCurrent(state) {
                var _this$get;
                return (_this$get = this.get(state)) === null || _this$get === void 0
                  ? void 0
            ...
            (0, _defineProperty2.default)(this, 'dispatchersList', {
              'e:run': {
                ...
                isSafe: function isSafe(command) {
                  ...
                  return (_$e$commands$getComma = $e.commands.getCommandClass(command)) === null ||
                ...
                isSafeWithArgs: function isSafeWithArgs(command) {
                  ...
                  return (_$e$commands$getComma2 = $e.commands.getCommandClass(command)) === null ||
                          ...
                          switch ((_context.prev = _context.next)) {
                            ...
                            case 4:
                              ...
                              return _context.abrupt(
                                ...
                                Promise.reject(
                                  new Error(
                                    'No dispatcher found for the command: `'.concat(hashCommand.command, '`.'),
                                  ),
                                ),
                              );
                            case 9:
                            ...
                            case 24:
                              ...
                              return _dispatcher.runner()(
                                ...
                                _dispatcher.isSafeWithArgs(_hashCommand.command) ? _hashCommand.args : undefined,
                              );
                            case 29:
                              _context.next = 24;
                              break;
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _commandInfra = _interopRequireDefault(
          __webpack_require__(/*! ./command-infra */ '../modules/web-cli/assets/js/modules/command-infra.js'),
        );
        var _deprecation = _interopRequireDefault(
          __webpack_require__(
            /*! elementor-api/utils/deprecation */ '../modules/web-cli/assets/js/utils/deprecation.js',
  ...
  \*********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _commandBase = _interopRequireDefault(
          __webpack_require__(/*! ./command-base */ '../modules/web-cli/assets/js/modules/command-base.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var CommandInternalBase = /*#__PURE__*/ (function (_CommandBase) {
          ...
          function CommandInternalBase(args) {
            var commandsAPI =
              arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : $e.commandsInternal;
  ...
  \********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _componentBase = _interopRequireDefault(
          __webpack_require__(/*! ./component-base */ '../modules/web-cli/assets/js/modules/component-base.js'),
        );
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands/ */ '../modules/web-cli/assets/js/modules/commands/index.js'),
        );
        var _forceMethodImplementation = _interopRequireDefault(
          __webpack_require__(
            /*! ../utils/force-method-implementation */ '../modules/web-cli/assets/js/utils/force-method-implementation.js',
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _base = _interopRequireDefault(
          __webpack_require__(/*! ./base */ '../modules/web-cli/assets/js/modules/hooks/data/base.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \**************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _base = _interopRequireDefault(
          __webpack_require__(/*! ./base */ '../modules/web-cli/assets/js/modules/hooks/ui/base.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
          ...
          return function (createStore) {
            return function () {
              ...
              return (0, _babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__['default'])(
                (0, _babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_0__['default'])({}, store),
                {},
                {
                  dispatch: _dispatch,
                },
  ...
  \********************************************/
      /***/ (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var _defaultMemoize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
                ...
                t.forEach(function (t) {
                  for (var i = t.path, u = t.op, f = r, s = 0; s < i.length - 1; s++) {
                    ...
                    'string' != typeof p && 'number' != typeof p && (p = '' + p),
                      (0 !== v && 1 !== v) || ('__proto__' !== p && 'constructor' !== p) || n(24),
                ...
                case 2:
                  return (function (n, r, t, e) {
                    ...
                    i(n.R, function (n, i) {
                      ...
                      if (v !== p || 'replace' !== l) {
                        var d = r.concat(n);
                        t.push('remove' === l ? { op: l, path: d } : { op: l, path: d, value: p }),
                          e.push(
                            l === c
                              ? { op: 'remove', path: d }
                              : 'remove' === l
        ...
        var G,
          ...
          en = {
            ...
            deleteProperty: function (n, r) {
              return (
                void 0 !== z(n.t, r) || r in n.t ? ((n.R[r] = !1), E(n), k(n)) : delete n.R[r],
                n.o && delete n.o[r],
                !0
              );
            },
