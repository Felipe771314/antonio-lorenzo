        ...
        class _default extends elementorModules.ViewModule {
          ...
          runElementsHandlers() {
            this.elements.$elements.each((index, element) =>
              setTimeout(() => elementorFrontend.elementsHandler.runReadyTrigger(element)),
            );
          }
          onInit() {
  ...
  \***********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _baseSwiper = _interopRequireDefault(
          __webpack_require__(/*! ./base-swiper */ '../assets/dev/js/frontend/handlers/base-swiper.js'),
        );
            ...
            Object.keys(elementorBreakpoints)
              ...
              .forEach((breakpointName) => {
                ...
                if (elementSettings.image_spacing_custom) {
                  swiperOptions.breakpoints[elementorBreakpoints[breakpointName].value].spaceBetween =
                    this.getSpaceBetween(breakpointName);
                }
                lastBreakpointSlidesToShowValue =
                  +elementSettings['slides_to_show_' + breakpointName] || defaultSlidesToShow;
              });
          ...
          initEditorListeners() {
            ...
            ['page'].forEach(function (settingsType) {
              var listenerMethodName =
                'on' + settingsType[0].toUpperCase() + settingsType.slice(1) + 'SettingsChange';
  ...
  \********************************************/
      /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _modules = _interopRequireDefault(
          __webpack_require__(/*! ../modules/modules */ '../assets/dev/js/modules/modules.js'),
        );
        ...
        var _stretchElement = _interopRequireDefault(
          __webpack_require__(/*! ./tools/stretch-element */ '../assets/dev/js/frontend/tools/stretch-element.js'),
        );
        ...
        var _base = _interopRequireDefault(
          __webpack_require__(/*! ./handlers/base */ '../assets/dev/js/frontend/handlers/base.js'),
        );
        var _baseSwiper = _interopRequireDefault(
          __webpack_require__(/*! ./handlers/base-swiper */ '../assets/dev/js/frontend/handlers/base-swiper.js'),
        );
        ...
        class Scroll {
          ...
          static getPageScrollPercentage() {
            ...
            const offsetStart = offsetObj.start || 0,
              offsetEnd = offsetObj.end || 0,
              initialPageHeight =
                limitPageHeight || document.documentElement.scrollHeight - document.documentElement.clientHeight,
        ...
        class NestedTabs extends _base.default {
            ...
            const settings = this.getSettings(),
              isActiveTabTitle =
                ...
                this.elements.$tabTitles
                  .filter(`[${settings.dataAttributes.tabIndex}="${tabIndex}"]`)
                  .attr(settings.ariaAttributes.titleStateAttribute),
              isActiveTabContent = this.elements.$tabContents
          ...
          onTabClick(event) {
            ...
            this.changeActiveTab(
              event.currentTarget?.getAttribute(this.getSettings('dataAttributes').tabIndex),
              true,
            );
          }
          getTabEvents() {
          ...
          onInit() {
            ...
            if ('nested-tabs.default' === this.getSettings('elementName')) {
              __webpack_require__
                .e(/*! import() | nested-title-keyboard-handler */ 'nested-title-keyboard-handler')
                .then(
                  __webpack_require__.bind(
                    __webpack_require__,
                    /*! elementor-frontend/handlers/accessibility/nested-title-keyboard-handler */ '../assets/dev/js/frontend/handlers/accessibility/nested-title-keyboard-handler.js',
                  ),
                )
                .then((_ref) => {
                  let { default: NestedTitleKeyboardHandler } = _ref;
