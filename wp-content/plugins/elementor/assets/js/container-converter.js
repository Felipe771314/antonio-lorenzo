...
/******/ (() => {
  ...
  \***************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _migrator = _interopRequireDefault(
          __webpack_require__(/*! ../migrator */ '../modules/container-converter/assets/js/editor/migrator.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function responsive(key, value) {
          var breakpoints = [''].concat(
            (0, _toConsumableArray2.default)(Object.keys(elementorFrontend.config.responsive.activeBreakpoints)),
          );
  ...
  \*****************************************************************/
    ...
    var _component = _interopRequireDefault(
      __webpack_require__(/*! ./component */ '../modules/container-converter/assets/js/editor/component.js'),
    );
    function _createSuper(Derived) {
      var hasNativeReflectConstruct = _isNativeReflectConstruct();
      return function _createSuperInternal() {
