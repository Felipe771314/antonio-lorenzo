...
/******/ (() => {
          ...
          (0, _createClass2.default)(Container, [
                ...
                Object.keys(settings).forEach(function (settingKey) {
                  Object.values(_this2.controls).forEach(function (control) {
                    ...
                    if (settingKey === control.name) {
                      ...
                      (_this2$controls$setti = _this2.controls[settingKey]) !== null &&
            ...
            },
            {
              ...
              value: function getAffectingControls() {
                ...
                Object.entries(activeControls).forEach(function (_ref3) {
                  ...
                  if (
                    control.global &&
                    !(controlValue !== null && controlValue !== void 0 && controlValue.length)
                  ) {
                    var _this3$globals$get;
                    if (
                      ((_this3$globals$get = _this3.globals.get(control.name)) !== null &&
            ...
            },
            {
              ...
              value: function render() {
                ...
                this.renderer.view.renderOnChange(
                  this.settings,
                  (_this$view = this.view) === null || _this$view === void 0 ? void 0 : _this$view.$el,
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function getGlobalDefault(controlName) {
                ...
                var controlGlobalArgs =
                  (_this$controls$contro = this.controls[controlName]) === null || _this$controls$contro === void 0
                    ? void 0
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        BaseSettingsModel = Backbone.Model.extend({
          ...
          isGlobalControl: function isGlobalControl(control, controls) {
            ...
            var globalValue =
              (_this$attributes$__gl = this.attributes.__globals__) === null || _this$attributes$__gl === void 0
                ? void 0
          ...
          parseGlobalSettings: function parseGlobalSettings(settings, controls) {
            ...
            jQuery.each(controls, function (index, control) {
              ...
              valueToParse =
                (_settings$__globals__ = settings.__globals__) === null || _settings$__globals__ === void 0
                  ? void 0
          ...
          removeDataDefaults: function removeDataDefaults(data, controls) {
            ...
            jQuery.each(data, function (key) {
              ...
              if (
                ...
                (('text' === control.type || 'textarea' === control.type) && data[key])
              ) {
                return;
              }
              if (control.is_repeater) {
            ...
            var closedClass = 'e-tab-close',
              ...
              childrenUnderTab = this.view.children.filter(function (view) {
                return (
                  ...
                  childView.model.get('tabs_wrapper') === view.model.get('tabs_wrapper')
                );
              }),
  ...
  \*******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _controlsPopover = _interopRequireDefault(
          __webpack_require__(/*! ./controls-popover */ '../assets/dev/js/editor/views/controls-popover.js'),
        );
        var ControlsStack;
        ControlsStack = Marionette.CompositeView.extend(
          {
            ...
            initCollection: function initCollection() {
              this.collection = new Backbone.Collection(
                _.values(elementor.mergeControlsSettings(this.getOption('controls'))),
              );
            },
  ...
  \******************************************/
    ...
    var _introduction = _interopRequireDefault(
      __webpack_require__(/*! ../utils/introduction */ '../assets/dev/js/utils/introduction.js'),
    );
    var _controlsStack = _interopRequireDefault(
      __webpack_require__(/*! ./views/controls-stack */ '../assets/dev/js/editor/views/controls-stack.js'),
    );
    ...
    var _container = _interopRequireDefault(
      __webpack_require__(/*! ./container/container */ '../assets/dev/js/editor/container/container.js'),
    );
