...
!(function () {
        ...
        t.useSyncExternalStoreWithSelector = function (e, t, r, n, o) {
          ...
          s = f(
            function () {
              function e(e) {
                if (!a) {
                  if (((a = !0), (u = e), (e = n(e)), void 0 !== o && p.hasValue)) {
                    var t = p.value;
                    if (o(t, e)) return (c = t);
                  }
                  return (c = e);
  ...
  !(function () {
    ...
    function b(e) {
      ...
      return (
        ...
        ((function (e) {
          ...
          return r === Object || ('function' == typeof r && Function.toString.call(r) === re);
        })(e) ||
          Array.isArray(e) ||
          !!e[ee] ||
    ...
    var B,
      ...
      re = ('undefined' != typeof Symbol && Symbol.iterator, '' + Object.prototype.constructor),
      ne =
      ...
      ue = {
        get: function (e, t) {
          ...
          var n = r[t];
          return e.I || !b(n) ? n : n === z(e.t, t) ? (U(e), (e.o[t] = W(e.A.h, n, e))) : n;
        },
        has: function (e, t) {
          return t in j(e);
        },
        ...
        deleteProperty: function (e, t) {
          return (
            void 0 !== z(e.t, t) || t in e.t ? ((e.R[t] = !1), U(e), L(e)) : delete e.R[t], e.o && delete e.o[t], !0
          );
        },
        ...
        function e(e) {
          ...
          (this.O = Y),
            ...
            (this.produce = function (e, r, n) {
              ...
              var u;
              if (('function' != typeof r && y(6), void 0 !== n && 'function' != typeof n && y(7), b(e))) {
                var c = T(t),
                  a = W(t, e, void 0),
                  f = !0;
                try {
              ...
              if (!e || 'object' != typeof e) {
                if ((void 0 === (u = r(e)) && (u = e), u === Z && (u = void 0), t.D && _(u, !0), n)) {
                  var l = [],
                    s = [];
    ...
    var ye,
      ...
      be =
        ...
        function (e, t) {
          ...
          ye(e, t), (e.prototype = null === t ? Object.create(t) : ((r.prototype = t.prototype), new r()));
        }),
      he = function (e, t) {
      ...
      Ee = function (e, t) {
        ...
        if (Se) for (var n = 0, o = Se(t); n < o.length; n++) (r = o[n]), Pe.call(t, r) && je(e, r, t[r]);
        return e;
      },
      _e = function (e, t) {
        return ge(e, we(t));
    ...
    function Re(e) {
      var t,
        r = function (e) {
          return (function (e) {
            ...
            var t = e.thunk,
              r = void 0 === t || t,
              n = (e.immutableCheck, e.serializableCheck, e.actionCreatorCheck, new Ce());
            return (
              r &&
                ((function (e) {
      ...
      var S = new ke(g),
        O = S;
      return Array.isArray(h) ? (O = he([g], h)) : 'function' == typeof h && (O = h(S)), l(t, v, w.apply(void 0, O));
    }
    function De(e) {
      var t,
        r = {},
        ...
        o = {
          addCase: function (e, t) {
            ...
            if (!n) throw new Error('`builder.addCase` cannot be called with an empty action type');
            if (n in r)
                      ...
                      return (function (e, t) {
                        ...
                        switch (g.label) {
                            ...
                            return (
                              ...
                              c(
                                o(
                                  s,
                                  e,
                                  null == (y = null == r ? void 0 : r.getPendingMeta)
                                    ? void 0
                                    : y.call(r, { requestId: s, arg: e }, { getState: a, extra: f }),
                                ),
                              ),
                              [
                                4,
                                Promise.race([
                                  ...
                                  Promise.resolve(
                                    ...
                                    return t instanceof $e ? n(t.payload, s, e, t.meta) : n(t, s, e);
                                  }),
                                ]),
                              ]
                            );
                          ...
                          case 4:
                            return (
                              (m = g.sent()),
                              (v = m instanceof Ie ? i(null, s, e, m.payload, m.meta) : i(m, s, e)),
                              [3, 5]
                            );
                          case 5:
                            return (
                  ...
                  (function e(t) {
                    if (t && 'object' == typeof t) {
                      ...
                      if (r) {
                        ...
                        if (4 === c)
                          h(i, function (t) {
                            t !== te && (void 0 !== o[t] || g(o, t) ? u[t] || e(i[t]) : ((u[t] = !0), L(r)));
                          }),
                            h(o, function (e) {
                              void 0 !== i[e] || g(i, e) || ((u[e] = !1), L(r));
                            });
                        else if (5 === c) {
                          if ((n(r) && (L(r), (u.length = !0)), i.length < o.length))
                            for (var a = i.length; a < o.length; a++) u[a] = !1;
                          else for (var f = o.length; f < i.length; f++) u[f] = !0;
                          for (var l = Math.min(i.length, o.length), s = 0; s < l; s++)
                            i.hasOwnProperty(s) || (u[s] = !0), void 0 === u[s] && e(i[s]);
                        }
                      }
                    }
                  })(e.p[0]),
          ...
          1 === a
            ...
            : (function (e, t) {
                ...
                return {
                  get: n,
                  put: function (t, o) {
                    n(t) === Le && (r.unshift({ key: t, value: o }), r.length > e && r.pop());
                  },
                  getEntries: function () {
                    return r;
                  },
    ...
    const Qe = () => He;
    var Ye = r(2403);
    const Ze = Symbol.for('react-redux-context'),
      et = 'undefined' != typeof globalThis ? globalThis : {};
    function tt() {
      var e;
      if (!Ye.createContext) return {};
      const t = null != (e = et[Ze]) ? e : (et[Ze] = new Map());
      let r = t.get(Ye.createContext);
      return r || ((r = Ye.createContext(null)), t.set(Ye.createContext, r)), r;
    }
    const rt = tt();
    function nt(e = rt) {
      return function () {
        return (0, Ye.useContext)(e);
      };
    }
    const ot = nt();
    let it = () => {
    ...
    const ut = (e, t) => e === t;
    function ct(e = rt) {
      const t = e === rt ? ot : nt(e);
      return function (e, r = {}) {
        const { equalityFn: n = ut, stabilityCheck: o, noopCheck: i } = 'function' == typeof r ? { equalityFn: r } : r,
          { store: u, subscription: c, getServerState: a, stabilityCheck: f, noopCheck: l } = t(),
          s =
            ((0, Ye.useRef)(!0),
            (0, Ye.useCallback)(
              {
          ...
          p = it(c.addNestedSub, u.getState, a || u.getState, s, n);
        return (0, Ye.useDebugValue)(p), p;
      };
    }
    const at = ct();
    r(8679), r(9864);
    ...
    var pt = function ({
      ...
      const u = Ye.useMemo(() => {
          const t = (function (e, t) {
            ...
            function a() {
              o--, r && 0 === o && (r(), (r = void 0), n.clear(), (n = ft));
            }
            const f = {
      ...
      const a = t || rt;
      return Ye.createElement(a.Provider, { value: u }, r);
    };
    function dt(e = rt) {
      const t = e === rt ? ot : nt(e);
      return function () {
    ...
    ((e) => {
      it = e;
    })(Ge.useSyncExternalStoreWithSelector),
      ((e) => {
        st = e;
      })(Be.useSyncExternalStore),
      (ht = Je.unstable_batchedUpdates),
      (He = ht);
    var mt = null,
      gt = {},
      wt = [],
      St = new Set();
    function Ot(e) {
      if (gt[e.name]) throw new Error(`Slice with name "${e.name}" already exists.`);
      gt[e.name] = e;
    }
    var Pt = (e) => {
        St.add(e);
      ...
      jt = (e) => {
        if (mt) return mt.dispatch(e);
        wt.push(e);
      },
      Et = () => {
        if (!mt) throw new Error('The store instance does not exist.');
        return mt.getState();
      },
      _t = (e) => {
        if (!mt) throw new Error('The store instance does not exist.');
      ...
      xt = () => {
        if (mt) throw new Error('The store instance already exists.');
        return (
          (mt = Re({
            reducer: s(Object.entries(gt).reduce((e, [t, r]) => ((e[t] = r.reducer), e), {})),
            middleware: (e) => [...e(), ...Array.from(St)],
          })),
          wt.length && (wt.forEach((e) => jt(e)), (wt.length = 0)),
          mt
        );
      },
      At = () => mt,
      Ct = () => {
        (mt = null), (gt = {}), (wt.length = 0), St.clear();
      };
  })(),
