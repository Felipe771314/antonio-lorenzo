    ...
    null !== (t = elementorAdminHints) &&
      ...
      (wp.media.view.Attachment.Details = wp.media.view.Attachment.Details.extend({
        ...
        shouldDisplayHint: function shouldDisplayHint(t) {
          var e;
          return (
            !(!elementorAdminHints || null === (e = elementorAdminHints) || void 0 === e || !e.mediaHint) &&
        ...
        onHintAnchorClick: function onHintAnchorClick(t) {
          this.dismiss(t);
        },
        dismiss: function dismiss(t) {
          elementorCommon.ajax.addRequest('dismissed_editor_notices', {
            data: {
              dismissId: t.target.closest('.e-hint__container').dataset.event,
            },
          }),
            this.hideHint(t);
        },
