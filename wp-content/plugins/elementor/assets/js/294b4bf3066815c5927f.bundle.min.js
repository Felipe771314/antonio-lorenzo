          ...
          (0, s.default)(View, [
            {
              ...
              value: function events() {
                var e = this,
                  events = (0, u.default)((0, l.default)(View.prototype), 'events', this).call(this);
                return (
                  (events.click = function (t) {
                    if (
                      ...
                      if (['container', 'widget'].includes(null == r ? void 0 : r.dataset.element_type)) {
                        var n = elementor.getContainer(r.dataset.id);
                        if (n.view.isEmpty()) return !0;
                        o = n;
                      }
                      t.stopPropagation(),
                        $e.run('document/elements/select', {
                          container: o || e.getContainer(),
                        });
                    }
                  }),
                  events
