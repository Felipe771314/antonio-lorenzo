    ...
    9728: (e, t) => {
      ...
      class baseTabs extends elementorModules.frontend.handlers.Base {
        ...
        activateDefaultTab() {
          ...
          this.setSettings({ showTabFn: 'show', hideTabFn: 'hide' }), this.changeActiveTab(t), this.setSettings(a);
        }
        ...
        activateTab(e) {
          ...
          s.add(i).addClass(a),
            ...
            i[t.showTabFn](n, () => elementorFrontend.elements.$window.trigger('elementor-pro/motion-fx/recalc')),
            i.removeAttr('hidden');
        }
        isActiveTab(e) {
