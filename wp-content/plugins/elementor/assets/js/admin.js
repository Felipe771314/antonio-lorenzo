...
/******/ (() => {
          ...
          (0, _createClass2.default)(MenuHandler, [
            ...
            },
            {
              ...
              value: function onInit() {
                (0, _get2.default)((0, _getPrototypeOf2.default)(MenuHandler.prototype), 'onInit', this).call(
                  this,
                );
                var settings = this.getSettings();
            ...
            },
            {
              ...
              value: function setVisibilityForControl(lookupControlIdPrefix, controlSettings, controlId) {
                ...
                var conditions = Object.entries(
                  (_controlSettings$cond = controlSettings.conditions) !== null && _controlSettings$cond !== void 0
  ...
  \*************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function createGenericWarningModal(IntroductionClass) {
          ...
          (_introduction$getDial = introduction.getDialog().getElements('message')) === null ||
          _introduction$getDial === void 0
            ? void 0
            : (_introduction$getDial2 = _introduction$getDial.append) === null || _introduction$getDial2 === void 0
              ? void 0
          ...
          (0, _createClass2.default)(ExperimentsMessages, [
            ...
            },
            {
              ...
              value: function getExperimentActualState(experimentId) {
                ...
                var state =
                  (_this$getExperimentSe = this.getExperimentSelect(experimentId)) === null ||
              ...
              value: function shouldShowDeactivationDialog(experimentId) {
                var getExperimentData = this.getExperimentData(experimentId),
                  isInitialStateActive =
                    ...
                    (getExperimentData.state === STATE_DEFAULT && getExperimentData.default === STATE_ACTIVE),
            ...
            },
            {
              ...
              value: function showDependenciesDialog(experimentId) {
                ...
                var message = __('In order to use %1$s, first you need to activate %2$s.', 'elementor')
            ...
            },
            {
              ...
              value: function getMessage(experimentId, messageId) {
                ...
                return (_this$getExperimentDa = this.getExperimentData(experimentId)) === null ||
  ...
  \****************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _menuHandler = _interopRequireDefault(
          __webpack_require__(/*! elementor-admin/menu-handler */ '../assets/dev/js/admin/menu-handler.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
              ...
              value: function getDefaultSettings() {
                ...
                return {
                  selectors: {
                    ...
                    contactPagesMenuItem: ''
                      .concat(adminMenuSelectors.contactPagesTablePage, ', ')
                      .concat(adminMenuSelectors.contactPagesAddNewPage),
                  },
                };
              },
            },
              ...
              value: function getDefaultElements() {
                var selectors = this.getSettings('selectors'),
                  elements = (0, _get2.default)(
                    (0, _getPrototypeOf2.default)(FloatingButtonsHandler.prototype),
                    'getDefaultElements',
                    this,
                  ).call(this);
            ...
            },
            {
              ...
              value: function onInit() {
                ...
                var settings = this.getSettings(),
                  ...
                  isLContactPagesCreateYourFirstPage = !!window.location.href.includes(
                    settings.paths.contactPagesAddNewPage,
                  );
                ...
                if (
                  (_elementorAdminConfig = elementorAdminConfig.urls) !== null &&
                  _elementorAdminConfig !== void 0 &&
                  _elementorAdminConfig.viewContactPageUrl
                ) {
                  this.elements.$templatesMenuItem
                    .find('li.submenu-e-contact a')
                ...
                if (isContactPagesTablePage || isContactPagesTrashPage || isLContactPagesCreateYourFirstPage) {
                  ...
                  jQuery(settings.selectors.addButton).attr(
                    'href',
                    elementorAdminConfig.urls.addNewLinkUrlContact,
                  );
                }
              },
            },
  ...
  \******************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _floatingButtons = _interopRequireDefault(
          __webpack_require__(
            /*! ./floating-buttons */ '../modules/floating-buttons/assets/js/floating-buttons/admin/floating-buttons.js',
          ),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
            ...
            },
            {
              ...
              value: function onInit() {
                ...
                var settings = this.getSettings(),
                  ...
                  isLandingPagesCreateYourFirstPage = !!window.location.href.includes(
  ...
  \**********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _landingPages = _interopRequireDefault(
          __webpack_require__(/*! ./landing-pages */ '../modules/landing-pages/assets/js/admin/landing-pages.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
          ...
          (0, _createClass2.default)(_default, [
            {
              ...
              value: function runHandler() {
                ...
                var pageName = 'e-landing-page',
                  ...
                  args = {
                    path:
                      (_elementorAdmin$confi = elementorAdmin.config.landingPages) !== null &&
                    ...
                    isLandingPageAdminEdit:
                      (_elementorAdmin$confi2 = elementorAdmin.config.landingPages) === null ||
  ...
  \***************************************/
    ...
    var _module3 = _interopRequireDefault(
      __webpack_require__(
        /*! elementor/modules/floating-buttons/assets/js/floating-buttons/admin/module */ '../modules/floating-buttons/assets/js/floating-buttons/admin/module.js',
      ),
    );
    (function ($) {
      var ElementorAdmin = elementorModules.ViewModule.extend({
        ...
        bindEvents: function bindEvents() {
          ...
          $('.e-notice--cta.e-notice--dismissible[data-notice_id="plugin_image_optimization"] a.e-button--cta').on(
            'click',
            function () {
          ...
          $('.e-a-apps .e-a-item[data-plugin="image-optimization/image-optimization.php"] a.e-btn').on(
            'click',
            function () {
              elementorCommon.ajax.addRequest('elementor_image_optimization_campaign', {
                data: {
          ...
          $('.e-notice--cta.e-notice--dismissible[data-notice_id="site_mailer_promotion"] a.e-button--cta').on(
            'click',
            function () {
            ...
            $.post(ajaxurl, {
              ...
              .fail(function (_ref) {
                ...
                if (
                  ...
                  $thisButton.after(
                    '<div class="e-recreate-kit-error-message">'.concat(responseJSON.data.message, '</div>'),
                  );
                }
              });
          });
        ...
        initTemplatesImport: function initTemplatesImport() {
          ...
          var canImport =
            ...
            ((_elementorAdminConfig =
              (_elementorAdminConfig2 = elementorAdminConfig.user.restrictions) === null ||
              _elementorAdminConfig2 === void 0
                ? void 0
                : _elementorAdminConfig2.includes('json-upload')) !== null && _elementorAdminConfig !== void 0
              ? _elementorAdminConfig
              : false);
                          ...
                          case 16:
                            ...
                            if (
                              !(
                                ...
                                !messages.enableUnfilteredFiles.shown
                              )
                            ) {
                              _context.next = 23;
                              break;
        ...
        roleManager: {
          ...
          bind: function bind() {
            var self = this;
            $(document)
              .on('click', self.selectors.label + ',' + self.selectors.toggleHandle, function (event) {
