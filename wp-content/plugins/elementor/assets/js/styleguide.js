...
/******/ (() => {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = Marionette.Behavior.extend({
          ...
          shouldRenderTools: function shouldRenderTools() {
            ...
            var isFeatureAvailableToUser =
                elementor.helpers.hasPro() && !elementor.helpers.hasProAndNotConnected(),
          ...
          (0, _createClass2.default)(BreakpointValidator, [
              ...
              value: function getPanelActiveBreakpoints() {
                ...
                panelBreakpoints.forEach(function (breakpointName) {
                  panelActiveBreakpoints[breakpointName] =
                    elementorFrontend.config.responsive.breakpoints[breakpointName];
                });
            ...
            },
            {
              ...
              value: function initBreakpointProperties() {
                ...
                this.topBreakpoint =
                  (_activeBreakpoints$br = activeBreakpoints[breakpointKeys[this.breakpointIndex + 1]]) === null ||
                  _activeBreakpoints$br === void 0
                    ? void 0
                    : _activeBreakpoints$br.value;
                this.bottomBreakpoint =
                  (_activeBreakpoints$br2 = activeBreakpoints[breakpointKeys[this.breakpointIndex - 1]]) ===
            ...
            },
            {
              ...
              value: function validateMinMaxForBreakpoint(newValue, validationTerms) {
                var breakpointDefaultValue =
                  elementorFrontend.config.responsive.breakpoints[validationTerms.breakpointName].default_value;
                var isValid = true;
        ...
        ControlBaseDataView = ControlBaseView.extend(
          {
            ...
            isGlobalActive: function isGlobalActive() {
              ...
              return (_this$options$model$g = this.options.model.get('global')) === null ||
                _this$options$model$g === void 0
                ? void 0
            ...
            preparePlaceholderForChildren: function preparePlaceholderForChildren() {
              ...
              var cleanValue = this.getCleanControlValue(),
                parentValue =
                  (_this$getResponsivePa = this.getResponsiveParentView()) === null ||
                  _this$getResponsivePa === void 0
                    ? void 0
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _baseData = _interopRequireDefault(
          __webpack_require__(/*! elementor-controls/base-data */ '../assets/dev/js/editor/controls/base-data.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands */ '../modules/styleguide/assets/js/commands/index.js'),
        );
        var _switcher = _interopRequireDefault(
          __webpack_require__(/*! ./controls/switcher */ '../modules/styleguide/assets/js/controls/switcher.js'),
        );
            ...
            },
            {
              ...
              value: function showStyleguidePreview() {
                ...
                if (
                  ...
                  (!skipPreferencesCheck && !elementor.getPreferences('enable_styleguide_preview'))
                ) {
                  return;
                }
  ...
  \*****************************************************/
    ...
    var _eComponent = _interopRequireDefault(
      __webpack_require__(/*! ./e-component */ '../modules/styleguide/assets/js/e-component.js'),
    );
    function _createSuper(Derived) {
      var hasNativeReflectConstruct = _isNativeReflectConstruct();
      return function _createSuperInternal() {
