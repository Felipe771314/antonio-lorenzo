            ...
            (0, s.default)(View, [
              ...
              },
              {
                ...
                value: function restoreLastValidPreviewSize() {
                  ...
                  this.ui.sizeInputWidth.val(e.width).tipsy({
                    ...
                    gravity: 'n',
                    title: function title() {
                      return i("The value inserted isn't in the breakpoint boundaries", 'elementor');
                    },
                  });
              ...
              },
              {
                ...
                value: function autoScale() {
                  var e = (40 * this.scalePercentage) / 100,
                    ...
                    r = parseInt(elementor.$preview.css('--e-editor-preview-width'));
              ...
              },
              {
                ...
                value: function setScalePercentage() {
                  ...
                  (this.scalePercentage = e), this.ui.scaleValue.text(parseInt(this.scalePercentage));
                },
              },
              {
                key: 'onRender',
              ...
              },
              {
                ...
                value: function onPreviewResize() {
                  if (!this.updatingPreviewSize) {
                    var e = elementor.channels.responsivePreview.request('size');
                    this.ui.sizeInputWidth.val(Math.round(e.width)), this.ui.sizeInputHeight.val(Math.round(e.height));
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function setWidthHeightInputsEditableState() {
                  'desktop' === elementor.channels.deviceMode.request('currentMode')
                    ...
                    : (this.ui.sizeInputWidth.removeAttr('disabled'), this.ui.sizeInputHeight.removeAttr('disabled'));
                },
              },
              {
                key: 'onCloseButtonClick',
                value: function onCloseButtonClick() {
                  elementor.changeDeviceMode('desktop'), elementor.exitDeviceMode();
                },
              },
              {
