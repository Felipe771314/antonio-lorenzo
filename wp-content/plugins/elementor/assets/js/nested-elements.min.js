  ...
  (__webpack_require__.m = r),
    ...
    (() => {
      ...
      var webpackJsonpCallback = (t, r) => {
          ...
          for (t && t(r); u < _.length; u++) (o = _[u]), __webpack_require__.o(e, o) && e[o] && e[o][0](), (e[o] = 0);
        },
        ...
        (elementor.modules.nestedElements = __webpack_require__
          ...
          elementor.modules.nestedElements.then(function (t) {
            (elementor.modules.nestedElements = new t.default()),
              (elementor.modules.elements.types.NestedElementBase = __webpack_require__
                .e(3016)
              ...
              elementor.modules.elements.types.NestedElementBase.then(function (t) {
                (elementor.modules.elements.types.NestedElementBase = t.default),
                  __webpack_require__
                    ...
                    .then(function () {
                      e.default.dispatch(elementorCommon.elements.$window, 'elementor/nested-element-type-loaded');
                    });
              });
          });
      });
