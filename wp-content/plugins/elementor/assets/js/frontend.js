...
(self['webpackChunkelementor'] = self['webpackChunkelementor'] || []).push([
  ...
  \**************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _global = _interopRequireDefault(
          __webpack_require__(/*! ./handlers/global */ '../assets/dev/js/frontend/handlers/global.js'),
        );
        var _background = _interopRequireDefault(
          __webpack_require__(/*! ./handlers/background */ '../assets/dev/js/frontend/handlers/background.js'),
        );
        ...
        var _column = _interopRequireDefault(
          __webpack_require__(/*! ./handlers/column */ '../assets/dev/js/frontend/handlers/column.js'),
        );
        ...
        module.exports = function ($) {
          ...
          if (elementorFrontendConfig.experimentalFeatures['nested-elements']) {
            this.elementsHandlers['nested-accordion.default'] = () =>
              __webpack_require__
                .e(/*! import() | nested-accordion */ 'nested-accordion')
                .then(
                  __webpack_require__.bind(
                    __webpack_require__,
          ...
          if (elementorFrontendConfig.experimentalFeatures.container) {
            this.elementsHandlers['contact-buttons.default'] = () =>
              __webpack_require__
                .e(/*! import() | contact-buttons */ 'contact-buttons')
                .then(
                  __webpack_require__.bind(
                    __webpack_require__,
                    /*! elementor/modules/floating-buttons/assets/js/floating-buttons/frontend/handlers/contact-buttons */ '../modules/floating-buttons/assets/js/floating-buttons/frontend/handlers/contact-buttons.js',
                  ),
                );
            this.elementsHandlers['floating-bars-var-1.default'] = () =>
              __webpack_require__
                .e(/*! import() | floating-bars */ 'floating-bars')
                .then(
                  __webpack_require__.bind(
                    __webpack_require__,
                    /*! elementor/modules/floating-buttons/assets/js/floating-bars/frontend/handlers/floating-bars */ '../modules/floating-buttons/assets/js/floating-bars/frontend/handlers/floating-bars.js',
                  ),
                );
          }
          ...
          this.runReadyTrigger = function (scope) {
            const isDelayChildHandlers =
              !!scope.closest('[data-delay-child-handlers="true"]') &&
              0 !== scope.closest('[data-delay-child-handlers="true"]').length;
  ...
  \*********************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _documentsManager = _interopRequireDefault(
          __webpack_require__(/*! ./documents-manager */ '../assets/dev/js/frontend/documents-manager.js'),
        );
        var _storage = _interopRequireDefault(
          __webpack_require__(/*! elementor-common/utils/storage */ '../core/common/assets/js/utils/storage.js'),
        );
        ...
        var _urlActions = _interopRequireDefault(
          __webpack_require__(/*! ./utils/url-actions */ '../assets/dev/js/frontend/utils/url-actions.js'),
        );
        var _swiper = _interopRequireDefault(
          __webpack_require__(/*! ./utils/swiper */ '../assets/dev/js/frontend/utils/swiper.js'),
        );
        ...
        var _assetsLoader = _interopRequireDefault(
          __webpack_require__(/*! ./utils/assets-loader */ '../assets/dev/js/frontend/utils/assets-loader.js'),
        );
        var _breakpoints = _interopRequireDefault(
          __webpack_require__(/*! elementor-utils/breakpoints */ '../assets/dev/js/utils/breakpoints.js'),
        );
        ...
        var _controls = _interopRequireDefault(
          __webpack_require__(/*! ./utils/controls */ '../assets/dev/js/frontend/utils/controls.js'),
        );
        var _anchorScrollMargin = _interopRequireDefault(
          __webpack_require__(
            /*! ./utils/anchor-scroll-margin */ '../assets/dev/js/frontend/utils/anchor-scroll-margin.js',
          ),
        );
        ...
        const EventManager = __webpack_require__(/*! elementor-utils/hooks */ '../assets/dev/js/utils/hooks.js'),
          ...
          ); // // TODO: Remove anchors.js file in v3.27.0 [ED-15717].
          ...
          buildSwiperElements() {
            ...
            if (kenBurnsActive) {
              ...
              const kenBurnsDirection =
                'in' === elementSettings.background_slideshow_ken_burns_zoom_direction
                  ? 'kenBurnsIn'
                  : 'kenBurnsOut';
  ...
  \********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _backgroundVideo = _interopRequireDefault(
          __webpack_require__(/*! ./background-video */ '../assets/dev/js/frontend/handlers/background-video.js'),
        );
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class _default extends elementorModules.ViewModule {
            ...
            const observer = new MutationObserver((mutationsList) => {
              for (const mutation of mutationsList) {
                if (
                  ...
                  ('attributes' === mutation.type && mutation.target.classList.contains('elementor-sticky'))
                ) {
                  callback();
                }
              }
          ...
          defineCurrentStickyRange(sticky, index, stickyList, anchorList) {
            const nextStickyScrollPosition =
              index + 1 < stickyList.length ? stickyList[index + 1].scrollPosition : Infinity;
            sticky.anchor = anchorList.filter((anchor) => {
              const withinRange =
                anchor.scrollPosition > sticky.scrollPosition && anchor.scrollPosition < nextStickyScrollPosition;
              if (withinRange) {
          ...
          getAllStickyElements() {
            ...
            return Array.from(allStickyElements).filter(
              (anchor, index, self) =>
          ...
          getAllAnchorLinks() {
            ...
            return Array.from(allAnchors).filter(
              (anchor, index, self) =>
        ...
        class AssetsLoader {
          ...
          loadAsset(assetData, assetType) {
            return new Promise((resolve) => {
              const element =
                'style' === assetType ? this.getStyleElement(assetData.src) : this.getScriptElement(assetData.src);
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class LightboxManager extends elementorModules.ViewModule {
          ...
          isLightboxLink(element) {
            ...
            return (
              'yes' === currentLinkOpenInLightbox || (generalOpenInLightbox && 'no' !== currentLinkOpenInLightbox)
            );
          }
          isLightboxSlideshow() {
          ...
          async onLinkClick(event) {
            const element = event.currentTarget,
              ...
              isColorPickingMode =
                editMode &&
                elementor.$previewContents.find('body').hasClass('elementor-editor__ui-state__color-picker'),
          ...
          bindEvents() {
            elementorFrontend.elements.$document.on('click', this.getSettings('selectors.links'), (event) =>
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class _default extends elementorModules.ViewModule {
          ...
          runAction(url) {
            ...
            for (
              var _len = arguments.length, restArgs = new Array(_len > 1 ? _len - 1 : 0), _key = 1;
              _key < _len;
              _key++
            ) {
  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _baseLoader = _interopRequireDefault(
          __webpack_require__(/*! ./base-loader */ '../assets/dev/js/frontend/utils/video-api/base-loader.js'),
        );
            ...
            if (args.withDesktop) {
              ...
              const widescreenIndex = breakpointKeys.indexOf('widescreen'),
                indexToInsertDesktopDevice =
                  -1 === widescreenIndex ? breakpointKeys.length : breakpointKeys.length - 1;
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var descriptor =
          NativeDOMException && DESCRIPTORS && Object.getOwnPropertyDescriptor(global, DOM_EXCEPTION);
