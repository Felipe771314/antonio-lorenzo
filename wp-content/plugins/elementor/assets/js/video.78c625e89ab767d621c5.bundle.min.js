    ...
    5363: (e, t) => {
      ...
      class Video extends elementorModules.frontend.handlers.Base {
        ...
        playVideo() {
          ...
          t && e.attr('src', t),
            this.getElementSettings('autoplay') &&
              (e.attr('allow', 'autoplay'), (e[0].src = this.apiProvider.getAutoplayURL(e[0].src)));
        }
        async animateVideo() {
        ...
        prepareYTVideo(e, t) {
          ...
          i.yt_privacy && ((o.host = 'https://www.youtube-nocookie.com'), (o.origin = window.location.hostname)),
