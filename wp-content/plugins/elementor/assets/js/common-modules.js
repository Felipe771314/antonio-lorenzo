...
/******/ (() => {
  ...
  \*********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _viewModule = _interopRequireDefault(
          __webpack_require__(/*! ../view-module */ '../assets/dev/js/modules/imports/view-module.js'),
        );
  ...
  \*******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _module = _interopRequireDefault(
          __webpack_require__(/*! ./module */ '../assets/dev/js/modules/imports/module.js'),
        );
  ...
  \*******************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _module = _interopRequireDefault(
          __webpack_require__(/*! ./imports/module */ '../assets/dev/js/modules/imports/module.js'),
        );
        var _viewModule = _interopRequireDefault(
          __webpack_require__(/*! ./imports/view-module */ '../assets/dev/js/modules/imports/view-module.js'),
        );
        var _argsObject = _interopRequireDefault(
          __webpack_require__(/*! ./imports/args-object */ '../assets/dev/js/modules/imports/args-object.js'),
        );
        var _masonry = _interopRequireDefault(
          __webpack_require__(/*! ./imports/utils/masonry */ '../assets/dev/js/modules/imports/utils/masonry.js'),
        );
        var _scroll = _interopRequireDefault(
          __webpack_require__(/*! ./imports/utils/scroll */ '../assets/dev/js/modules/imports/utils/scroll.js'),
        );
          ...
          (0, _createClass2.default)(_default, [
            ...
            },
            {
              ...
              value: function isFloatingButtonLibraryClose() {
                ...
                return (
                  window.elementor &&
                  ((_elementor$config = elementor.config) === null || _elementor$config === void 0
                    ? void 0
                    : _elementor$config.admin_floating_button_admin_url) &&
                  'floating-buttons' ===
                    ((_elementor$config2 = elementor.config) === null || _elementor$config2 === void 0
                      ? void 0
                      : (_elementor$config2$do = _elementor$config2.document) === null ||
                          _elementor$config2$do === void 0
                        ? void 0
                        : _elementor$config2$do.type) &&
                  (this.$el
                    .closest('.dialog-lightbox-widget-content')
                    .find('.elementor-template-library-template-floating_button').length ||
                    this.$el.closest('.dialog-lightbox-widget-content').find('#elementor-template-library-preview')
                      .length ||
                    this.$el
                      .closest('.dialog-lightbox-widget-content')
  ...
  \******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _header = _interopRequireDefault(
          __webpack_require__(/*! ./header */ '../core/common/assets/js/views/modal/header.js'),
        );
        var _logo = _interopRequireDefault(
          __webpack_require__(/*! ./logo */ '../core/common/assets/js/views/modal/logo.js'),
        );
        var _loading = _interopRequireDefault(
          __webpack_require__(/*! ./loading */ '../core/common/assets/js/views/modal/loading.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
          ...
          (0, _createClass2.default)(_default, [
            ...
            },
            {
              ...
              value: function initModal() {
                ...
                this.modal
                  .getElements('message')
                  .append(this.modal.addElement('content'), this.modal.addElement('loading'));
  ...
  \*******************************************/
    ...
    var _modules = _interopRequireDefault(
      __webpack_require__(/*! elementor-assets-js/modules/modules */ '../assets/dev/js/modules/modules.js'),
    );
    var _layout = _interopRequireDefault(
      __webpack_require__(/*! ./views/modal/layout */ '../core/common/assets/js/views/modal/layout.js'),
    );
    var _componentBase = _interopRequireDefault(
      __webpack_require__(
