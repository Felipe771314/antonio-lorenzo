...
/******/ (() => {
                        ...
                        while (1)
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              (type = (0, _utils.extractElementType)(container.model)),
                                (previousDefaults = (0, _api.getElementDefaults)(type)),
                                (newDefaults = (0, _extractContainerSettings.default)(container));
                              _context.prev = 3;
                              _context.next = 6;
  ...
  \**********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks */ '../modules/kit-elements-defaults/assets/js/editor/hooks/index.js'),
        );
          ...
          var introduction = new elementorModules.editor.utils.Introduction({
            ...
            dialogOptions: {
              ...
              onShow: function onShow() {
                ...
                (_this$getElements = this.getElements('checkbox-dont-show-again')) === null ||
                _this$getElements === void 0
                  ? void 0
            ...
            },
            {
              ...
              value: function getConditions(args) {
                ...
                return (
                  ...
                  ((_args$model2 = args.model) === null || _args$model2 === void 0 ? void 0 : _args$model2.elType)
                );
              },
            },
            {
              ...
              value: function apply(args) {
                ...
                ['__dynamic__', '__globals__'].forEach(function (type) {
                  ...
                  settings[type] = _objectSpread(
                    ...
                    ((_args$model$settings = args.model.settings) === null || _args$model$settings === void 0
                      ? void 0
  ...
  \*******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/kit-elements-defaults/assets/js/editor/component.js'),
        );
        var _api = __webpack_require__(/*! ./api */ '../modules/kit-elements-defaults/assets/js/editor/api.js');
        var _utils = __webpack_require__(
          /*! ./utils */ '../modules/kit-elements-defaults/assets/js/editor/utils.js',
            ...
            elementor.hooks.addFilter('elements/'.concat(elType, '/contextMenuGroups'), function (groups, view) {
              ...
              if (
                ...
                (0, _utils.extractElementType)(
                  ((_view$options = view.options) === null || _view$options === void 0
                    ? void 0
                    : _view$options.model) || {},
                )
              ) {
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function isPopulatedObject(obj) {
          return (
            obj && 'object' === (0, _typeof2.default)(obj) && !Array.isArray(obj) && Object.keys(obj).length > 0
          );
        }
  ...
  \******************************************************************/
    ...
    var _module = _interopRequireDefault(
      __webpack_require__(/*! ./module.js */ '../modules/kit-elements-defaults/assets/js/editor/module.js'),
    );
    new _module.default();
  })();
