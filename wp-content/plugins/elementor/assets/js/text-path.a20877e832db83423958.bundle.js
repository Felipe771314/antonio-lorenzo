      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class TextPathHandler extends elementorModules.frontend.handlers.Base {
          ...
          attachIdToPath() {
            ...
            const path =
              this.elements.svg.querySelector('[data-path-anchor]') || this.elements.svg.querySelector('path');
            path.id = this.pathId;
          }
          ...
          function createDOMPurify() {
            ...
            const _isClobbered = function _isClobbered(elm) {
              return (
                ...
                ((typeof elm.__depth !== 'undefined' && typeof elm.__depth !== 'number') ||
                  // eslint-disable-next-line unicorn/no-typeof-undefined
                  (typeof elm.__removalCount !== 'undefined' && typeof elm.__removalCount !== 'number') ||
            ...
            const _isValidAttribute = function _isValidAttribute(lcTag, lcName, value) {
              ...
              if (
                ...
                (value in document || value in formElement || value === '__depth' || value === '__removalCount')
              ) {
                return false;
              }
