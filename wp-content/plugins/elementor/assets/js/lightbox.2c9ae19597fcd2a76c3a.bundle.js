  ...
  \************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _screenfull = _interopRequireDefault(
          __webpack_require__(/*! ./screenfull */ '../assets/dev/js/frontend/utils/lightbox/screenfull.js'),
        );
        ...
        module.exports = elementorModules.ViewModule.extend({
              ...
              if (slide.video) {
                ...
                const playVideoLoadingElement = this.isFontIconSvgExperiment ? _eIcons.loading.element : '<i>',
                  $playIcon = $('<div>', {
                    ...
                    $(playVideoLoadingElement).attr('aria-label', i18n.playVideo).addClass(classes.playButtonIcon),
                  );
          ...
          setEntranceAnimation(animation) {
            animation =
              animation ||
              elementorFrontend.getCurrentDeviceSetting(this.getSettings('modalOptions'), 'entranceAnimation');
