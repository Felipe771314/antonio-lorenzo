...
/******/ (() => {
  ...
  \*************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _editorV1Adapters = __webpack_require__(
          /*! @elementor/editor-v1-adapters */ '@elementor/editor-v1-adapters',
        );
        var _checklist = _interopRequireDefault(
          __webpack_require__(
            /*! ./components/checklist */ '../modules/checklist/assets/js/app/components/checklist.js',
          ),
        );
        var _functions = __webpack_require__(
          /*! ../utils/functions */ '../modules/checklist/assets/js/utils/functions.js',
        );
        ...
        var App = function App() {
          ...
          (0, _react.useEffect)(function () {
            fetchData();
            return (0, _editorV1Adapters.__privateListenTo)(
              (0, _editorV1Adapters.commandEndEvent)('document/save/save'),
              function (_ref) {
                ...
                if (
                  ...
                  (args === null || args === void 0
                    ? void 0
                    : (_args$document = args.document) === null || _args$document === void 0
                      ? void 0
                      : (_args$document$config = _args$document.config) === null ||
                          _args$document$config === void 0
                        ? void 0
                        : _args$document$config.type)
                ) {
                  fetchData();
                }
              },
          ...
          if (
            ...
            !userProgress ||
            stepsError ||
            !(steps !== null && steps !== void 0 && steps.length)
          ) {
            return null;
          }
  ...
  \*******************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _consts = __webpack_require__(
          /*! ../../utils/consts */ '../modules/checklist/assets/js/utils/consts.js',
        );
        ...
        var ChecklistCardContent = function ChecklistCardContent(_ref) {
          ...
          var ctaText = promotionData
              ? (promotionData === null || promotionData === void 0 ? void 0 : promotionData.text) ||
                    ...
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        if (
                          !(
                            !elementor ||
                            !_consts.STEP_IDS_TO_COMPLETE_IN_EDITOR.includes(id) ||
                            !_consts.PANEL_ROUTES[id]
                          )
                        ) {
                          _context.next = 3;
                          break;
                    ...
                    while (1)
                      switch ((_context2.prev = _context2.next)) {
                        case 0:
                          ...
                          _context2.next = 6;
                          return (0, _functions.updateStep)(
                            id,
                            (0, _defineProperty2.default)({}, IS_MARKED_COMPLETED, !currState),
                          );
                        case 6:
                          _context2.next = 11;
                          break;
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              shouldShowMarkAsDone
                ? /*#__PURE__*/ _react.default.createElement(
                    ...
                    isMarkedCompleted
                      ? (0, _i18n.__)('Unmark as done', 'elementor')
                      : (0, _i18n.__)('Mark as done', 'elementor'),
                  )
                : null,
              /*#__PURE__*/ _react.default.createElement(
                _ui.Button,
  ...
  \***********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _checklistCardContent = _interopRequireDefault(
          __webpack_require__(
            /*! ./checklist-card-content */ '../modules/checklist/assets/js/app/components/checklist-card-content.js',
          ),
        );
        var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui');
        ...
        function CheckListItem(props) {
          ...
          var getUpgradeIcon = function getUpgradeIcon() {
            return 'default' === (promotionData === null || promotionData === void 0 ? void 0 : promotionData.icon)
              ? /*#__PURE__*/ _react.default.createElement(_icons.UpgradeIcon, {
                  color: 'promotion',
                  sx: {
                    mr: 1,
                  },
  ...
  \**************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _checklistItem = _interopRequireDefault(
          __webpack_require__(
            /*! ./checklist-item */ '../modules/checklist/assets/js/app/components/checklist-item.js',
          ),
        );
        var _propTypes = _interopRequireDefault(
          __webpack_require__(/*! prop-types */ '../node_modules/prop-types/index.js'),
        );
        var _successMessage = _interopRequireDefault(
          __webpack_require__(
            /*! ./success-message */ '../modules/checklist/assets/js/app/components/success-message.js',
          ),
        );
        var _functions = __webpack_require__(
          /*! ../../utils/functions */ '../modules/checklist/assets/js/utils/functions.js',
        ...
        var ChecklistWrapper = function ChecklistWrapper(_ref) {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              steps.map(function (step, index) {
                return /*#__PURE__*/ _react.default.createElement(
                  ...
                  index ? /*#__PURE__*/ _react.default.createElement(_ui.Divider, null) : null,
                  /*#__PURE__*/ _react.default.createElement(_checklistItem.default, {
                    step: step,
                    setSteps: setSteps,
            ...
            isChecklistCompleted
              ? /*#__PURE__*/ _react.default.createElement(_successMessage.default, null)
              : null,
          );
        };
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _header = _interopRequireDefault(
          __webpack_require__(/*! ./header */ '../modules/checklist/assets/js/app/components/header.js'),
        );
        var _checklistWrapper = _interopRequireDefault(
          __webpack_require__(
            /*! ./checklist-wrapper */ '../modules/checklist/assets/js/app/components/checklist-wrapper.js',
          ),
        );
        var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui');
        var _consts = __webpack_require__(
                    ...
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          _context.next = 5;
                          return (0, _functions.updateUserProgress)(
                            (0, _defineProperty2.default)({}, IS_POPUP_MINIMIZED, !currState),
                          );
                        case 5:
                          _context.next = 10;
                          break;
  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _progress = _interopRequireDefault(
          __webpack_require__(/*! ./progress */ '../modules/checklist/assets/js/app/components/progress.js'),
        );
        var _propTypes = _interopRequireDefault(
          __webpack_require__(/*! prop-types */ '../node_modules/prop-types/index.js'),
        );
        ...
        var CHECKLIST_CLOSED_IN_THE_EDITOR_FOR_FIRST_TIME =
          _consts.USER_PROGRESS.CHECKLIST_CLOSED_IN_THE_EDITOR_FOR_FIRST_TIME;
        ...
        var Header = function Header(_ref) {
          ...
          var _useQuery = (0, _query.useQuery)({
            ...
            closedForFirstTime =
              (userProgress === null || userProgress === void 0
                ? void 0
                : userProgress[CHECKLIST_CLOSED_IN_THE_EDITOR_FOR_FIRST_TIME]) || false;
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 4;
                        return (0, _functions.updateUserProgress)(
                          (0, _defineProperty2.default)({}, CHECKLIST_CLOSED_IN_THE_EDITOR_FOR_FIRST_TIME, true),
                        );
                      case 4:
                        window.dispatchEvent(
                          new CustomEvent('elementor/checklist/first_close', {
                            detail: {
                              message: 'firstClose',
                            },
                          }),
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  (0, _i18n.__)("Let's make a productivity boost", 'elementor'),
                ),
                /*#__PURE__*/ React.createElement(
                  _ui.IconButton,
                  {
                  ...
                  isMinimized
                    ? /*#__PURE__*/ React.createElement(_icons.ExpandDiagonalIcon, null)
                    : /*#__PURE__*/ React.createElement(_icons.MinimizeDiagonalIcon, null),
                ),
                /*#__PURE__*/ React.createElement(_ui.CloseButton, {
                  sx: {
                    mr: -0.5,
                  },
                  size: 'small',
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement(
                ...
                'Looking for your Launchpad Checklist?',
              ),
              /*#__PURE__*/ _react.default.createElement(
                _ui.Typography,
                {
  ...
  \*************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _userProgress = __webpack_require__(
          /*! ./user-progress */ '../modules/checklist/assets/js/commands-data/user-progress.js',
        );
  ...
  \********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _togglePopup = __webpack_require__(
          /*! ./toggle-popup */ '../modules/checklist/assets/js/commands/toggle-popup.js',
        );
        var _toggleIcon = __webpack_require__(
          /*! ./toggle-icon */ '../modules/checklist/assets/js/commands/toggle-icon.js',
        );
  ...
  \**************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _togglePopup = _interopRequireDefault(
          __webpack_require__(/*! ./toggle-popup */ '../modules/checklist/assets/js/commands/toggle-popup.js'),
        );
        var _functions = __webpack_require__(
          /*! ../utils/functions */ '../modules/checklist/assets/js/utils/functions.js',
        );
  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _app = _interopRequireDefault(
          __webpack_require__(/*! ../app/app */ '../modules/checklist/assets/js/app/app.js'),
        );
        var _query = __webpack_require__(/*! @elementor/query */ '../node_modules/@elementor/query/dist/index.js');
          ...
          (0, _createClass2.default)(TogglePopup, [
            {
              ...
              value: function apply(args) {
                if (!TogglePopup.isOpen) {
                  ...
                  this.unmount();
                  (0, _functions.updateUserProgress)(
                    (0, _defineProperty2.default)({}, _consts.USER_PROGRESS.EDITOR_VISIT_COUNT, -1),
                  );
                }
            ...
            },
            {
              ...
              value: function mount() {
                this.setRootElement();
                TogglePopup.rootElement.render(
                  /*#__PURE__*/ _react.default.createElement(
  ...
  \***************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands/ */ '../modules/checklist/assets/js/commands/index.js'),
        );
        var commandsData = _interopRequireWildcard(
          __webpack_require__(/*! ./commands-data/ */ '../modules/checklist/assets/js/commands-data/index.js'),
        );
        function _getRequireWildcardCache(nodeInterop) {
          if (typeof WeakMap !== 'function') return null;
          var cacheBabelInterop = new WeakMap();
  ...
  \****************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var EditorAppBar = _interopRequireWildcard(
          __webpack_require__(/*! @elementor/editor-app-bar */ '@elementor/editor-app-bar'),
        );
        var _i18n = __webpack_require__(/*! @wordpress/i18n */ '@wordpress/i18n');
        var React = _interopRequireWildcard(__webpack_require__(/*! react */ 'react'));
        var _topbarIcon = _interopRequireDefault(
          __webpack_require__(/*! ./topbar-icon */ '../modules/checklist/assets/js/topbar-icon.js'),
        );
        var _functions = __webpack_require__(
          /*! ./utils/functions */ '../modules/checklist/assets/js/utils/functions.js',
        );
  ...
  \*****************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _RocketIcon = _interopRequireDefault(
          __webpack_require__(/*! @elementor/icons/RocketIcon */ '@elementor/icons/RocketIcon'),
        );
        var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui');
        var _reminderModal = _interopRequireDefault(
          __webpack_require__(
            /*! ./app/components/reminder-modal */ '../modules/checklist/assets/js/app/components/reminder-modal.js',
          ),
        );
        var _consts = __webpack_require__(/*! ./utils/consts */ '../modules/checklist/assets/js/utils/consts.js');
        var _functions = __webpack_require__(
        ...
        var TopBarIcon = function TopBarIcon() {
          var _useState = (0, React.useState)(false),
            ...
            closedForFirstTime =
              userProgress === null || userProgress === void 0
                ? void 0
                : userProgress[CHECKLIST_CLOSED_IN_THE_EDITOR_FOR_FIRST_TIME];
          (0, React.useEffect)(
            function () {
              return (0, _editorV1Adapters.__privateListenTo)(
                (0, _editorV1Adapters.commandEndEvent)('checklist/toggle-popup'),
                function (e) {
  ...
  \******************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        exports.USER_PROGRESS_ROUTE =
          exports.USER_PROGRESS =
          exports.STEP_IDS_TO_COMPLETE_IN_EDITOR =
          exports.STEPS_ROUTE =
          exports.STEP =
          exports.PANEL_ROUTES =
          exports.MIXPANEL_CHECKLIST_STEPS =
            void 0;
  ...
  \*********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function isStepChecked(step) {
          return (
            !step[PROMOTION_DATA] &&
            (step[IS_MARKED_COMPLETED] || step[IS_ABSOLUTE_COMPLETED] || step[IS_IMMUTABLE_COMPLETED])
          );
        }
        ...
        function _fetchSteps() {
          _fetchSteps = (0, _asyncToGenerator2.default)(
            /*#__PURE__*/ _regenerator.default.mark(function _callee() {
              var _response$data;
              var response;
              return _regenerator.default.wrap(function _callee$(_context) {
                    ...
                    case 2:
                      ...
                      return _context.abrupt(
                        ...
                        (response === null || response === void 0
                          ? void 0
                          : (_response$data = response.data) === null || _response$data === void 0
                            ? void 0
        ...
        function _fetchUserProgress() {
          _fetchUserProgress = (0, _asyncToGenerator2.default)(
            /*#__PURE__*/ _regenerator.default.mark(function _callee2() {
              var _response$data2;
              var response;
                  ...
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 2:
                      ...
                      return _context2.abrupt(
                        ...
                        (response === null || response === void 0
                          ? void 0
                          : (_response$data2 = response.data) === null || _response$data2 === void 0
                            ? void 0
        ...
        function _updateStep() {
          _updateStep = (0, _asyncToGenerator2.default)(
            /*#__PURE__*/ _regenerator.default.mark(function _callee3(id, data) {
        ...
        function _updateUserProgress() {
          _updateUserProgress = (0, _asyncToGenerator2.default)(
            /*#__PURE__*/ _regenerator.default.mark(function _callee4(data) {
...
*/
  ...
  \*******************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        __reExport(
          src_exports,
          __webpack_require__(/*! ./types.cjs */ '../node_modules/@tanstack/query-core/build/modern/types.cjs'),
          module.exports,
        );
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var MutationCache = class extends import_subscribable.Subscribable {
          ...
          find(filters) {
            ...
            return this.getAll().find((mutation) => (0, import_utils.matchMutation)(defaultedFilters, mutation));
          }
          findAll(filters = {}) {
          ...
          resumePausedMutations() {
            ...
            return import_notifyManager.notifyManager.batch(() =>
              Promise.all(pausedMutations.map((mutation) => mutation.continue().catch(import_utils.noop))),
            );
          }
        };
          ...
          #combineResult(input, combine) {
            if (combine) {
              if (!this.#combinedResult || this.#result !== this.#lastResult || combine !== this.#lastCombine) {
                ...
                this.#combinedResult = (0, import_utils.replaceEqualDeep)(this.#combinedResult, combine(input));
              }
  ...
  \************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var QueryCache = class extends import_subscribable.Subscribable {
          ...
          find(filters) {
            const defaultedFilters = { exact: true, ...filters };
            return this.getAll().find((query) => (0, import_utils.matchQuery)(defaultedFilters, query));
          }
          findAll(filters = {}) {
            const queries = this.getAll();
            return Object.keys(filters).length > 0
              ? queries.filter((query) => (0, import_utils.matchQuery)(filters, query))
              : queries;
          }
          notify(event) {
            import_notifyManager.notifyManager.batch(() => {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var QueryClient = class {
          ...
          ensureQueryData(options) {
            ...
            if (cachedData === void 0) return this.fetchQuery(options);
              ...
              if (
                ...
                query.isStaleByTime((0, import_utils.resolveStaleTime)(defaultedOptions.staleTime, query))
              ) {
          ...
          fetchQuery(options) {
            ...
            const query = this.#queryCache.build(this, defaultedOptions);
            return query.isStaleByTime((0, import_utils.resolveStaleTime)(defaultedOptions.staleTime, query))
  ...
  \***************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var QueryObserver = class extends import_subscribable.Subscribable {
          ...
          setOptions(options, notifyOptions) {
            ...
            if (
              ...
              typeof (0, import_utils.resolveEnabled)(this.options.enabled, this.#currentQuery) !== 'boolean'
            ) {
            ...
            if (
              ...
              (this.#currentQuery !== prevQuery ||
                (0, import_utils.resolveEnabled)(this.options.enabled, this.#currentQuery) !==
          ...
          #updateStaleTimeout() {
            this.#clearStaleTimeout();
            const staleTime = (0, import_utils.resolveStaleTime)(this.options.staleTime, this.#currentQuery);
            if (
              import_utils.isServer ||
              this.#currentResult.isStale ||
              !(0, import_utils.isValidTimeout)(staleTime)
            ) {
              return;
            }
          ...
          #updateRefetchInterval(nextInterval) {
            ...
            if (
              import_utils.isServer ||
              (0, import_utils.resolveEnabled)(this.options.enabled, this.#currentQuery) === false ||
          ...
          createResult(query, options) {
            ...
            if (options.placeholderData !== void 0 && data === void 0 && status === 'pending') {
              ...
              if (placeholderData !== void 0) {
                status = 'success';
                data = (0, import_utils.replaceData)(prevResult?.data, placeholderData, options);
        ...
        function shouldLoadOnMount(query, options) {
          return (
            (0, import_utils.resolveEnabled)(options.enabled, query) !== false &&
            query.state.data === void 0 &&
        ...
        function shouldFetchOptionally(query, prevQuery, options, prevOptions) {
          return (
            (query !== prevQuery || (0, import_utils.resolveEnabled)(prevOptions.enabled, query) === false) &&
        ...
        function isStale(query, options) {
          return (
            (0, import_utils.resolveEnabled)(options.enabled, query) !== false &&
            query.isStaleByTime((0, import_utils.resolveStaleTime)(options.staleTime, query))
          );
        }
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        function createRetryer(config) {
          ...
          const canContinue = () =>
            ...
            (config.networkMode === 'always' || import_onlineManager.onlineManager.isOnline()) &&
            config.canRun();
  ...
  \**********************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var React = __toESM(__webpack_require__(/*! react */ 'react'), 1);
        var import_jsx_runtime = __webpack_require__(
  ...
  \********************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        __reExport(
          src_exports,
          __webpack_require__(/*! ./types.cjs */ '../node_modules/@tanstack/react-query/build/modern/types.cjs'),
          module.exports,
        );
        ...
        var import_prefetch = __webpack_require__(
          /*! ./prefetch.cjs */ '../node_modules/@tanstack/react-query/build/modern/prefetch.cjs',
        );
            ...
            React.useCallback(
              (onStoreChange) => {
                const unsubscribe = isRestoring
                  ? () => void 0
                  : observer.subscribe(import_query_core.notifyManager.batchCalls(onStoreChange));
  ...
  \**************************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        function useMutation(options, queryClient) {
          const client = (0, import_QueryClientProvider.useQueryClient)(queryClient);
          const [observer] = React.useState(() => new import_query_core.MutationObserver(client, options));
          React.useEffect(() => {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        function useQueries({ queries, ...options }, queryClient) {
          ...
          const shouldAtLeastOneSuspend = optimisticResult.some((result, index) =>
            (0, import_suspense.shouldSuspend)(defaultedQueries[index], result),
          );
  ...
  \************************************************/
    ...
    var _component = _interopRequireDefault(
      __webpack_require__(/*! ./component */ '../modules/checklist/assets/js/component.js'),
    );
    var _consts = __webpack_require__(/*! ./utils/consts */ '../modules/checklist/assets/js/utils/consts.js');
    var _functions = __webpack_require__(
      /*! ./utils/functions */ '../modules/checklist/assets/js/utils/functions.js',
    ...
    function _checklistStartup() {
      _checklistStartup = (0, _asyncToGenerator2.default)(
        /*#__PURE__*/ _regenerator.default.mark(function _callee() {
              ...
              switch ((_context.prev = _context.next)) {
                ...
                case 7:
                  ...
                  editorVisitCount =
                    (userProgress === null || userProgress === void 0
                      ? void 0
                      : userProgress[_consts.USER_PROGRESS.EDITOR_VISIT_COUNT]) || null;
