...
/******/ (() => {
          ...
          (0, _createClass2.default)(CreateStyle, [
            ...
            },
            {
              ...
              value: function apply(args) {
                ...
                var label = sprintf(
                  (0, _i18n.__)('%1$s Style %2$s', 'elementor'),
                  container.label,
                  Object.keys(oldStyles).length + 1,
                );
                var newStyle = {
                ...
                var oldBindSetting =
                  (_container$settings$g = container.settings.get(bind)) !== null &&
                  _container$settings$g !== void 0
                    ? _container$settings$g
                    : {
                ...
                var newStyles = _objectSpread(
                  _objectSpread({}, oldStyles),
                  {},
                  (0, _defineProperty2.default)({}, newStyle.id, newStyle),
                );
  ...
  \**************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _getVariants = __webpack_require__(
          /*! ../utils/get-variants */ '../modules/atomic-widgets/assets/js/editor/utils/get-variants.js',
        );
        function ownKeys(object, enumerableOnly) {
          var keys = Object.keys(object);
          if (Object.getOwnPropertySymbols) {
            ...
            },
            {
              ...
              value: function apply(args) {
                ...
                var newStyles = _objectSpread(
                  _objectSpread({}, oldStyles),
                  {},
                  (0, _defineProperty2.default)({}, styleDefID, style),
                );
                container.model.set('styles', newStyles);
              },
            },
            ...
            },
            {
              ...
              value: function apply(args) {
                ...
                var newStyles = _objectSpread(
                  _objectSpread({}, oldStyles),
                  {},
                  (0, _defineProperty2.default)({}, style.id, style),
                );
                container.model.set('styles', newStyles);
              },
            },
  ...
  \*****************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _updateProps = __webpack_require__(
          /*! ./update-props */ '../modules/atomic-widgets/assets/js/editor/commands-internal/update-props.js',
        );
        var _createStyle = __webpack_require__(
          /*! ./create-style */ '../modules/atomic-widgets/assets/js/editor/commands-internal/create-style.js',
        );
        var _deleteStyle = __webpack_require__(
          /*! ./delete-style */ '../modules/atomic-widgets/assets/js/editor/commands-internal/delete-style.js',
        );
        var _createVariant = __webpack_require__(
          /*! ./create-variant */ '../modules/atomic-widgets/assets/js/editor/commands-internal/create-variant.js',
        );
        var _deleteVariant = __webpack_require__(
          /*! ./delete-variant */ '../modules/atomic-widgets/assets/js/editor/commands-internal/delete-variant.js',
        );
                ...
                return _objectSpread(
                  ...
                  {},
                  {
                    variants: style.variants.map(function (v) {
                      return variant.meta.breakpoint === v.breakpoint && variant.meta.state === v.state
                        ? variant
                        : v;
                    }),
                  },
  ...
  \********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _styles = __webpack_require__(
          /*! ./styles */ '../modules/atomic-widgets/assets/js/editor/commands/styles.js',
        );
            ...
            [
              ...
              },
              {
                ...
                value: function apply(args) {
                  ...
                  var styleDefID =
                    (_args$styleDefID = args.styleDefID) !== null && _args$styleDefID !== void 0
                      ? _args$styleDefID
                      : null;
                  var currentStyle =
                    (_structuredClone = structuredClone(container.model.get('styles'))) !== null &&
                    _structuredClone !== void 0
                      ? _structuredClone
                      : {};
                  var style = {};
                  if (!styleDefID) {
                  ...
                  var nonEmptyValues = Object.values(
                    _objectSpread(
                      _objectSpread(
                        {},
                        currentVariant === null || currentVariant === void 0 ? void 0 : currentVariant.props,
                      ),
                      props,
                    ),
                  ...
                  if (this.isHistoryActive()) {
                    ...
                    var oldProps =
                      oldStyleDef !== null && oldStyleDef !== void 0 && oldStyleDef.variants
                        ? (_getVariantByMeta = (0, _getVariants.getVariantByMeta)(oldStyleDef.variants, meta)) ===
                            null || _getVariantByMeta === void 0
                          ? void 0
                          : _getVariantByMeta.props
                        : {};
  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands/ */ '../modules/atomic-widgets/assets/js/editor/commands/index.js'),
        );
        var commandsInternal = _interopRequireWildcard(
          __webpack_require__(
            /*! ./commands-internal/ */ '../modules/atomic-widgets/assets/js/editor/commands-internal/index.js',
          ),
        );
  ...
  \************************************************************/
    ...
    var _component = _interopRequireDefault(
      __webpack_require__(/*! ./component */ '../modules/atomic-widgets/assets/js/editor/component.js'),
    );
    function _createSuper(Derived) {
      var hasNativeReflectConstruct = _isNativeReflectConstruct();
      return function _createSuperInternal() {
