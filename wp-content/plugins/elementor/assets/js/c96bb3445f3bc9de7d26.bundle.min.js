    ...
    30158: (e, t, r) => {
      ...
      var n = o(r(42081)),
        ...
        i = (0, n.default)(function Module() {
          (0, u.default)(this, Module), elementor.elementsManager.registerElementType(new s.default());
        });
      t.default = i;
    },
    22790: (e, t, r) => {
      'use strict';
      var o = r(73203);
      Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = t.NestedAccordion = void 0);
      var n = o(r(78983)),
        u = o(r(42081)),
        s = o(r(58724)),
        i = o(r(71173)),
          ...
          (0, u.default)(View, [
            {
              ...
              value: function onAddChild(e) {
                var t,
                  r = null === (t = e._parent.$el.find('summary')) || void 0 === t ? void 0 : t.attr('aria-controls');
