...
/******/ (() => {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = elementorModules.Module.extend({
          ...
          isPositionValid: function isPositionValid(position) {
            var _position$of;
            var positionToCheck =
              (_position$of = position === null || position === void 0 ? void 0 : position.of) !== null &&
              _position$of !== void 0
                ? _position$of
                            ...
                            switch ((_context.prev = _context.next)) {
                              case 0:
                                ...
                                if (
                                  !(
                                    this.file.size >
                                    parseInt(window._wpPluploadSettings.defaults.filters.max_file_size, 10)
                                  )
                                ) {
                                  _context.next = 3;
                                  break;
                                ...
                                throw new Error(
                                  __('The file exceeds the maximum upload size for this site.', 'elementor'),
                                );
                              case 3:
                                if (
                                  !(
                                ...
                                _filesUploadHandler.default
                                  .getUnfilteredFilesNotEnabledDialog(function () {})
                                  .show();
      ...
      /***/ (module) => {
        ...
        var Debug = function Debug() {
          ...
          var onError = function onError(event) {
            ...
            var error =
              (_event$originalEvent = event.originalEvent) === null || _event$originalEvent === void 0
                ? void 0
                ...
                jQuery.fn.elementorConnect = function (options) {
                  ...
                  if (options !== null && options !== void 0 && options.popup) {
                    jQuery(this).on('click', function (event) {
                      ...
                      var width =
                          ((_options$popup = options.popup) === null || _options$popup === void 0
                            ? void 0
                            : _options$popup.width) || 600,
                        height =
                          ((_options$popup2 = options.popup) === null || _options$popup2 === void 0
                            ? void 0
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _time = _interopRequireDefault(
          __webpack_require__(/*! elementor-utils/time */ '../assets/dev/js/utils/time.js'),
        );
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands/ */ '../core/common/modules/finder/assets/js/commands/index.js'),
        );
        function _getRequireWildcardCache(nodeInterop) {
          if (typeof WeakMap !== 'function') return null;
          var cacheBabelInterop = new WeakMap();
  ...
  \*********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../core/common/modules/finder/assets/js/component.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \*************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _category = _interopRequireDefault(
          __webpack_require__(/*! ./category */ '../core/common/modules/finder/assets/js/modal/views/category.js'),
        );
  ...
  \***********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _item = _interopRequireDefault(
          __webpack_require__(/*! ./item */ '../core/common/modules/finder/assets/js/modal/views/item.js'),
        );
        var _item2 = _interopRequireDefault(
          __webpack_require__(/*! ../model/item */ '../core/common/modules/finder/assets/js/modal/model/item.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
          ...
          (0, _createClass2.default)(_default, [
            {
              ...
              value: function className() {
                return (
                  (0, _get2.default)((0, _getPrototypeOf2.default)(_default.prototype), 'className', this).call(
                    this,
  ...
  \*********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _content = _interopRequireDefault(
          __webpack_require__(/*! ./content */ '../core/common/modules/finder/assets/js/modal/views/content.js'),
        );
        function _createSuper(Derived) {
          var hasNativeReflectConstruct = _isNativeReflectConstruct();
          return function _createSuperInternal() {
  ...
  \******************************************/
    ...
    var _notifications = _interopRequireDefault(
      __webpack_require__(/*! elementor-utils/notifications */ '../assets/dev/js/utils/notifications.js'),
    );
    function _createSuper(Derived) {
      var hasNativeReflectConstruct = _isNativeReflectConstruct();
      return function _createSuperInternal() {
    ...
    var ElementorCommonApp = /*#__PURE__*/ (function (_elementorModules$Vie) {
      ...
      (0, _createClass2.default)(ElementorCommonApp, [
        ...
        },
        {
          key: 'onInit',
          value: function onInit() {
            (0, _get2.default)((0, _getPrototypeOf2.default)(ElementorCommonApp.prototype), 'onInit', this).call(
              this,
            );
