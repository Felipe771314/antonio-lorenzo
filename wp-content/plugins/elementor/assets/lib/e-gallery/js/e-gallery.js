...
var EGallery = /******/ (function (modules) {
  ...
  \*****************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default =
          /*#__PURE__*/ __webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__);
        ...
        /* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default =
          /*#__PURE__*/ __webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__);
        /* harmony import */ var _types_grid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./types/grid */ './src/js/types/grid.js',
        );
        /* harmony import */ var _types_justified__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./types/justified */ './src/js/types/justified.js',
        );
        /* harmony import */ var _types_masonry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./types/masonry */ './src/js/types/masonry.js',
        );
        /* harmony import */ var _scss_e_gallery_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../scss/e-gallery.scss */ './src/scss/e-gallery.scss',
        );
        /* harmony import */ var _scss_e_gallery_scss__WEBPACK_IMPORTED_MODULE_5___default =
          /*#__PURE__*/ __webpack_require__.n(_scss_e_gallery_scss__WEBPACK_IMPORTED_MODULE_5__);
                  ...
                  $items.each(function (index, item) {
                    ...
                    promise.then(function () {
                      $item
                        ...
                        .addClass(_this6.getItemClass(_this6.settings.classes.imageLoaded));
  ...
  \******************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3__);
        ...
        /* harmony import */ var _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default =
          /*#__PURE__*/ __webpack_require__.n(_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__);
          ...
          (function (_BaseGalleryType) {
            ...
            function Grid() {
              ...
              return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(
                this,
                _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Grid).apply(
                  this,
                  arguments,
                ),
              );
        ...
        var Justified =
          ...
          (function (_BaseGalleryType) {
            ...
            function Justified() {
              ...
              return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(
                this,
                _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Justified).apply(
                  this,
                  arguments,
                ),
              );
                ...
                value: function makeJustifiedRow(startIndex) {
                  ...
                  for (var index = startIndex; ; index++) {
                    ...
                    var itemComputedWidth = Math.round(
                      this.getCurrentDeviceSetting('idealRowHeight') * imageData.ratio,
                    );
                    ...
                    if (isLastItem) {
                      ...
                      if ('hide' !== lastRowMode) {
                        var totalRowWidth =
                          'fit' === lastRowMode || 0.7 <= newRowWidth / this.containerWidth
                            ? newRowWidth
                            : this.containerWidth;
                ...
                value: function fitImagesInContainer(startIndex, endIndex, rowWidth) {
                  ...
                  for (var index = startIndex; index < endIndex; index++) {
                    ...
                    if (index === startIndex) {
                      ...
                      var imagePxWidth =
                        percentWidth *
                        (this.containerWidth - gapCount * this.getCurrentDeviceSetting('horizontalGap'));
                ...
                value: function inflateGalleryHeight() {
                  var totalRowsHeight = this.rowsHeights.reduce(function (total, item) {
                    ...
                    finalContainerHeight =
                      totalRowsHeight + this.rowsCount * this.getCurrentDeviceSetting('verticalGap'),
        ...
        var Masonry =
          ...
          (function (_BaseGalleryType) {
            ...
            function Masonry() {
              ...
              return _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(
                this,
                _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(Masonry).apply(
                  this,
                  arguments,
                ),
              );
  ...
  \*******************************/
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _element_in_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ./element-in-view */ './src/js/utils/element-in-view.js',
        );
        /* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, 'elementInView', function () {
