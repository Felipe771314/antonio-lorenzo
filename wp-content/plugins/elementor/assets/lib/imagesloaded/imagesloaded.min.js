!(function (global, factory) {
  ...
  (function (window, factory) {
    ...
    function makeArray(obj) {
      ...
      else if ('number' == typeof obj.length) for (var i = 0; i < obj.length; i++) ary.push(obj[i]);
      else ary.push(obj);
      return ary;
    }
    ...
    return (
      ...
      (ImagesLoaded.prototype.complete = function () {
        ...
        if (
          ((this.isComplete = !0), this.emitEvent(eventName, [this]), this.emitEvent('always', [this]), this.jqDeferred)
        ) {
