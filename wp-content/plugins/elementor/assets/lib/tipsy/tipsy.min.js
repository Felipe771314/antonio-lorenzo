  ...
  (Tipsy.prototype = {
    show: function () {
      ...
      if (title && this.enabled) {
        ...
        2 == gravity.length &&
          ...
          this.options.className && $tip.addClass(maybeCall(this.options.className, this.$element[0])),
          this.options.fade
            ? $tip
                .stop()
    ...
    ($.fn.tipsy = function (options) {
      function get(ele) {
        ...
        return (
          tipsy || ((tipsy = new Tipsy(ele, $.fn.tipsy.elementOptions(ele, options))), $.data(ele, 'tipsy', tipsy)),
          tipsy
        );
      }
      function enter() {
    ...
    ($.fn.tipsy.autoBounds = function (margin, prefer) {
      return function () {
        ...
        return (
          ...
          $(window).width() + $(document).scrollLeft() - $this.offset().left < margin && (dir.ew = 'e'),
          $(window).height() + $(document).scrollTop() - $this.offset().top < margin && (dir.ns = 's'),
