!(function (root, factory) {
  ...
  (NProgress.configure = function (options) {
    ...
    (NProgress.done = function (force) {
      return force || NProgress.status ? NProgress.inc(0.3 + 0.5 * Math.random()).set(1) : this;
    }),
    (NProgress.inc = function (amount) {
      var n = NProgress.status;
      return n
        ? ('number' != typeof amount && (amount = (1 - n) * clamp(Math.random() * n, 0.1, 0.95)),
        ...
        return $promise && 'resolved' !== $promise.state()
          ? (0 === current && NProgress.start(),
            ...
            $promise.always(function () {
              current--,
                0 === current ? ((initial = 0), NProgress.done()) : NProgress.set((initial - current) / initial);
            }),
            this)
          : this;
      };
        ...
        if (2 == args.length)
          for (prop in properties)
            (value = properties[prop]),
              void 0 !== value && properties.hasOwnProperty(prop) && applyCss(element, prop, value);
