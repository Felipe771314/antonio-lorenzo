...
!(function (a, b) {
  ...
  (g._console = 'undefined' != typeof console ? console : {}),
      ...
      return function (d, e, f) {
        ...
        return (
          ...
          c.isFunction(d.trigger) &&
            (g + f.length > 1 ? d.trigger.apply(d, g ? f : [e].concat(c.drop(f, 0))) : d.trigger(e)),
          h
        );
      };
    })()),
    ...
    (f.MonitorDOMRefresh = function (a) {
      ...
      a._isDomRefreshMonitored || ((a._isDomRefreshMonitored = !0), a.on({ show: b, render: c }));
    }),
    (function (a) {
      function b(b, d, e, f) {
        var g = f.split(/\s+/);
  ...
  return (
    ...
    (f.Region = f.Object.extend(
      {
        ...
        show: function (a, b) {
          if (this._ensureElement()) {
            ...
            if (
              ...
              return (
                l && n.triggerBeforeAttach && ((m = this._displayedViews(a)), this._triggerAttach(m, 'before:')),
                this.attachHtml(a),
                (this.currentView = a),
                l && n.triggerAttach && ((m = this._displayedViews(a)), this._triggerAttach(m)),
        ...
        _ensureElement: function () {
          if (
            (c.isObject(this.el) || ((this.$el = this.getEl(this.el)), (this.el = this.$el[0])),
    ...
    (f.View = b.View.extend({
      ...
      triggerMethod: function () {
        ...
        return (
          this._triggerEventOnBehaviors(arguments), this._triggerEventOnParentLayout(arguments[0], c.rest(arguments)), a
        );
      },
    ...
    (f.ItemView = f.View.extend({
      ...
      serializeData: function () {
        ...
        return (
          ...
          this.model ? this.serializeModel.apply(this, a) : { items: this.serializeCollection.apply(this, a) }
        );
      },
    ...
    (f.CollectionView = f.View.extend({
      ...
      endBuffering: function () {
        ...
        (this.isBuffering = !1),
          ...
          b &&
            ...
            ((a = this._getNestedViews()), this._triggerMethodMany(a, this, 'before:attach')),
          this.attachBuffer(this, this._createBuffer()),
          b && this._triggerAttach && ((a = this._getNestedViews()), this._triggerMethodMany(a, this, 'attach')),
      ...
      _onCollectionAdd: function (a, b, d) {
        ...
        if (
          ((this.getOption('filter') || e === !1) && (e = c.indexOf(this._filteredSortedModels(e), a)),
          ...
          h.once(
            ...
            function () {
              this._isShown && f.triggerMethodOn(h, 'before:show', h),
                e &&
                  this._triggerBeforeAttach &&
                  ((d = this._getViewAndNested(h)), this._triggerMethodMany(d, this, 'before:attach'));
            },
            this,
          ),
          this.children.add(h),
          this.renderChildView(h, this._emptyViewIndex),
          e && this._triggerAttach && ((d = this._getViewAndNested(h)), this._triggerMethodMany(d, this, 'attach')),
          ...
          a.once(
            ...
            function () {
              this._isShown && !this.isBuffering && f.triggerMethodOn(a, 'before:show', a),
                d &&
                  this._triggerBeforeAttach &&
                  ((c = this._getViewAndNested(a)), this._triggerMethodMany(c, this, 'before:attach'));
            },
            this,
          ),
          this.children.add(a),
          this.renderChildView(a, b),
          d && this._triggerAttach && ((c = this._getViewAndNested(a)), this._triggerMethodMany(c, this, 'attach')),
    ...
    (f.CompositeView = f.CollectionView.extend({
      ...
      getChildViewContainer: function (a, b) {
        ...
        if (d) {
          ...
          if (((c = '@' === e.charAt(0) && a.ui ? a.ui[e.substr(4)] : a.$(e)), c.length <= 0))
            throw new f.Error({
    ...
    (f.Behaviors = (function (a, b) {
      function c(a, d) {
        return b.isObject(a.behaviors)
          ? ((d = c.parseBehaviors(a, d || b.result(a, 'behaviors'))), c.wrap(a, d, b.keys(g)), d)
          : {};
      }
      function d(a, b) {
