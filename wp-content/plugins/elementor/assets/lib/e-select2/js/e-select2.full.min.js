      ...
      return (
              ...
              (t = function (t, n, i, r) {
                ...
                if (((m = $((r = r || t))), 'undefined' === x || 'function' === x)) {
                  ...
                  (p = i ? i.apply(l[t], b) : void 0),
                    t &&
                      (o && o.exports !== e && o.exports !== l[t] ? (l[t] = o.exports) : (p === e && w) || (l[t] = p));
                } else t && (l[t] = i);
              }),
              (n =
                i =
          ...
          return (
            ...
            (i.prototype.select = function (e) {
              ...
              if (((e.selected = !0), n(e.element).is('option')))
                return (e.element.selected = !0), void this.$element.trigger('change');
            ...
            (i.prototype.unselect = function (e) {
              ...
              if (this.$element.prop('multiple')) {
                if (((e.selected = !1), n(e.element).is('option')))
                  return (e.element.selected = !1), void this.$element.trigger('change');
                this.current(function (i) {
        ...
        t.define('select2/data/ajax', ['./array', '../utils', 'jquery'], function (e, t, n) {
          ...
          return (
            ...
            (i.prototype.query = function (e, t) {
              var i = this;
              null != this._request &&
                (typeof this._request.abort === 'function' && this._request.abort(), (this._request = null));
        ...
        t.define('select2/data/tags', ['jquery'], function (e) {
          function t(t, n, i) {
            ...
            if ((void 0 !== s && (this.insertTag = s), t.call(this, n, i), Array.isArray(r)))
              for (var a = 0; a < r.length; a++) {
                var l = r[a],
        ...
        t.define('select2/data/tokenizer', ['jquery'], function (e) {
          ...
          return (
            ...
            (t.prototype.query = function (t, n, i) {
              ...
              o.term !== n.term &&
                (this.$search.length && (this.$search.val(o.term), this.$search.trigger('focus')), (n.term = o.term)),
                t.call(this, n, i);
            }),
        ...
        t.define(
          ...
          function (e, t, n, i, r, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, w, $, b, x, A, D, S, C, E) {
            function O() {
              this.reset();
            }
            return (
              (O.prototype.apply = function (d) {
                ...
                if (
                  ...
                  if (
                    (0 !== d.minimumResultsForSearch && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, D)),
                    d.closeOnSelect && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, C)),
                ...
                if (null == d.selectionAdapter) {
                  if (
                    (d.multiple ? (d.selectionAdapter = r) : (d.selectionAdapter = i),
          ...
          return (
            (r.prototype.fromElement = function (e) {
              ...
              for (var s in (o = i._convertData(o)))
                t.inArray(s, n) > -1 ||
                  (t.isPlainObject(this.options[s]) ? t.extend(this.options[s], o[s]) : (this.options[s] = o[s]));
              return this;
            }),
            ...
            (t.prototype.current = function (t, n) {
              ...
              this._isInitialized
                ...
                : this.initSelection.call(null, this.$element, function (t) {
                    (i._isInitialized = !0), Array.isArray(t) || (t = [t]), n(t);
                  });
            }),
            t
          );
        ...
        (o = function (e) {
          ...
          var a = (e.event.special.mousewheel = {
            ...
            getLineHeight: function (t) {
              ...
              return (
                i.length || (i = e('body')), parseInt(i.css('fontSize'), 10) || parseInt(n.css('fontSize'), 10) || 16
              );
            },
