    ...
    (n.Widget = function (e) {
      ...
      (this.addElement = function (e, n, i) {
        ...
        (this.init = function (s, a) {
          ...
          var u;
          return (
            (u = c.concat(i.getClosureMethods())),
            t.each(u, function () {
              var t = i[this];
              i[this] = function () {
                t.apply(i, arguments);
            ...
            (function () {
              ...
              t.each(i.types, function () {
                ...
                r.widget.addClass(n.join(' ')).attr({ 'aria-modal': !0, role: 'document', tabindex: 0 });
            })(),
            i.buildWidget(),
            i.attachEvents(),
            i.trigger('ready'),
                    ...
                    1 === o.length && (/left|right/.test(o[0]) ? o.push('center') : o.unshift('center')),
                      o.forEach(function (t, o) {
                        var r = t.replace(e, function (t) {
                          return (
                            (t = +t || 0), (t += o ? n.top - i.scrollY : n.left - i.scrollX) >= 0 && (t = '+' + t), t
                          );
                        });
                        s.push(r);
                      }),
    ...
    n.addWidgetType(
      ...
      n.getWidgetType('lightbox').extend('confirm', {
        ...
        getDefaultSettings: function () {
          ...
          return (t.strings = { confirm: 'OK', cancel: 'Cancel' }), (t.defaultOption = 'cancel'), t;
        },
      }),
    ),
    n.addWidgetType(
