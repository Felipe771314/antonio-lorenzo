...
!(function (A, e) {
  ...
  function w(A, e, t, r, n) {
    ...
    if (
      (-1 !== [M, b].indexOf(i) && (c === D || (-1 !== [v, f].indexOf(c) && e[1 + o] === D))) ||
      (-1 !== [v, f].indexOf(i) && c === D) ||
    ...
    try {
      if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
        ...
        var t = A.contentWindow.document.documentElement
            ? AB(getComputedStyle(A.contentWindow.document.documentElement).backgroundColor)
            : He.TRANSPARENT,
    ...
    PB =
      ...
      (xB.prototype.createStyleClone = function (A) {
        try {
          ...
          if (
            (De.getInstance(this.options.id).error('Unable to access cssRules property', A), 'SecurityError' !== A.name)
          )
            throw A;
        }
    ...
    cs = function (A) {
      ...
      (this.topLeftBorderBox = 0 < n || 0 < B ? us(t.left, t.top, n, B, is.TOP_LEFT) : new ts(t.left, t.top)),
        (this.topRightBorderBox =
          0 < o || 0 < i ? us(t.left + g, t.top, o, i, is.TOP_RIGHT) : new ts(t.left + t.width, t.top)),
        ...
        (this.topLeftPaddingBox =
          0 < n || 0 < B
            ? us(t.left + p, t.top + H, Math.max(0, n - p), Math.max(0, B - H), is.TOP_LEFT)
      ...
      return a(this, void 0, void 0, function () {
        ...
        return S(this, function (A) {
          switch (A.label) {
            ...
            case 11:
              return (
                A.sent(), De.getInstance(this.options.id).error('Error loading svg ' + e.svg.substring(0, 255)), [3, 12]
              );
            case 12:
                ...
                (e = function (e) {
                  ...
                  return S(this, function (A) {
                    switch (A.label) {
                      ...
                      case 3:
                        return (
                          A.sent(), De.getInstance(D.options.id).error('Error loading background-image ' + r), [3, 4]
                        );
                      case 4:
                        return (
                          t &&
                            ((n = Hs(b, O, [t.width, t.height, t.width / t.height])),
                            (g = n[0]),
                            (f = n[1]),
                            (p = n[2]),
                            (h = n[3]),
        ...
        switch (A.label) {
          ...
          case 5:
            return (
              !0 === Q.removeContainer &&
                (PB.destroy(l) ||
                  De.getInstance(r).error('Cannot detach cloned iframe as it is not in the DOM anymore')),
