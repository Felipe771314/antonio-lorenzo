 ...
 * Copyright Vasil Dinkov, Vadikom Web Ltd. http://vadikom.com; Licensed MIT */ !(function (a) {
  ...
  function b(b) {
    ...
    if (h || b) h && b && (a(document).off(i), (h = !1));
      ...
      (l[g ? 'touchstart' : 'pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut'] = function (
        a,
      ) {
    ...
    a.extend(a.SmartMenus, {
      ...
      prototype: {
        ...
        itemActivate: function (b, c) {
          ...
          if (
            ((this.isCollapsible() && !c) ||
              this.menuHideSubMenus(this.activatedItems[e - 1] && this.activatedItems[e - 1][0] == b[0] ? e : e - 1),
            ...
            if (d) {
              ...
              if (d.is(':visible')) {
                if (!g && this.opts.showOnClick && e)
                  return this.menuHide(d), (this.clickActivated = !1), (this.focusActivated = !1), !1;
        ...
        itemLeave: function (b) {
          ...
          this.handleItemEvents(c) &&
            (this.isTouchMode() ||
              (c[0].blur(), this.showTimeout && (clearTimeout(this.showTimeout), (this.showTimeout = 0))),
              ...
              if (
                (b
                  ...
                  .css({
                    ...
                    width:
                      k - (parseInt(b.css('border-left-width')) || 0) - (parseInt(b.css('border-right-width')) || 0),
        ...
        menuScrollStop: function (a) {
          if (this.scrollTimeout)
            return j(this.scrollTimeout), (this.scrollTimeout = 0), (a.dataSM('scroll').step = 1), !0;
        },
          ...
          if (((d = d.originalEvent), c(d))) {
            ...
            if (this.getClosestMenu(e.target) == b[0]) {
              ...
              if (/(start|down)$/i.test(d.type))
                ...
                void 0 !== f.touchY &&
                  ((f.momentum =
                    15 * Math.pow(Math.abs(e.pageY - f.touchStartY) / (d.timeStamp - f.touchStartTime), 2)) &&
