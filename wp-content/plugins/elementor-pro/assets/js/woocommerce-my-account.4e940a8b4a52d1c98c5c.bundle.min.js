      ...
      class MyAccountHandler extends i.default {
        ...
        toggleEndpointClasses() {
          ...
          this.elements.$tabWrapper.removeClass(
            'e-my-account-tab__' + e.join(' e-my-account-tab__') + ' e-my-account-tab__dashboard--custom',
          ),
            ...
            e.includes(this.currentPage) &&
              this.elements.$tabWrapper.addClass('e-my-account-tab__' + this.currentPage + t);
        }
