      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class MenuTitleKeyboardHandler extends elementorModules.frontend.handlers.Base {
            ...
            switch (event.key) {
              case 'Tab':
                ...
                const $menuItemElements = this.elements.$focusableMenuElements,
                  ...
                  isLastMenuItemElementForward =
                    isForward && $menuItemElements.last().is(jQuery(event.currentTarget)),
                  isFirstMenuItemElementBackwards =
                    !isForward && $menuItemElements.first().is(jQuery(event.currentTarget));
                if (this.isDropdownLayout() && !isLastMenuItemElementForward && !isFirstMenuItemElementBackwards) {
                  return;
                }
                const isNotOpenDropdown =
                    !event.currentTarget.getAttribute('aria-expanded') ||
                    'false' === event.currentTarget?.getAttribute('aria-expanded'),
          ...
          setTitleFocus(titleIndexUpdated) {
            const $newTitle = this.elements.$focusableMenuElements.filter(
          ...
          updateIndexValues(view) {
            const {
                selectors: { directTabTitle, tabDropdown },
          ...
          updateListeners(view) {
            ...
            const {
              selectors: { focusableMenuElement, itemContainer },
            } = this.getSettings();
