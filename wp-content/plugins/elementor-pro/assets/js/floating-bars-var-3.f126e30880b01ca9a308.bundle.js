  ...
  \***********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _base = _interopRequireDefault(
          __webpack_require__(
            /*! elementor-frontend/handlers/base */ '../../elementor/assets/dev/js/frontend/handlers/base.js',
          ),
        );
        var _copyToClipboard = __webpack_require__(
          /*! ../../../../../notes/assets/js/services/copy-to-clipboard */ '../modules/notes/assets/js/services/copy-to-clipboard/index.js',
        );
        var _floatinBarDom = _interopRequireDefault(
          __webpack_require__(
            /*! ../classes/floatin-bar-dom */ '../modules/floating-buttons/assets/js/frontend/classes/floatin-bar-dom.js',
          ),
        );
        var _clickTracking = _interopRequireDefault(
          __webpack_require__(
            /*! ../../shared/frontend/handlers/click-tracking */ '../modules/floating-buttons/assets/js/shared/frontend/handlers/click-tracking.js',
          ),
        );
        class FloatingBarsHandler extends _base.default {
          ...
          isStickyTop() {
            ...
            return (
              this.elements.main.classList.contains(isSticky) &&
              this.elements.main.classList.contains(hasVerticalPositionTop)
            );
          }
          isStickyBottom() {
            ...
            return (
              this.elements.main.classList.contains(isSticky) &&
              this.elements.main.classList.contains(hasVerticalPositionBottom)
            );
          }
          hasStickyElements() {
          ...
          initEntranceAnimation() {
            const { animated, couponEntranceAnimation, couponEntranceAnimationDelay, hasEntranceAnimation } =
          ...
          initDefaultState() {
            ...
            if (
              this.elements.main &&
              !this.elements.couponButton.classList.contains(hasEntranceAnimation) &&
