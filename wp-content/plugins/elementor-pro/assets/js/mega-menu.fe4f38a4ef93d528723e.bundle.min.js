  ...
  [727],
  {
    3556: (e, t, n) => {
      ...
      t.default = class AnchorLinks {
        constructor(e, t) {
          (0, o.default)(this, 'observer', null),
            (this.$anchorLinks = e),
    ...
    6974: (e, t) => {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        (t.setHorizontalScrollAlignment = function setHorizontalScrollAlignment(e) {
          let { element: t, direction: n, justifyCSSVariable: i, horizontalScrollStatus: o } = e;
          if (!t) return;
    ...
    3431: (e, t, n) => {
      ...
      class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
        ...
        getDefaultSettings() {
          ...
          return (
            (e.selectors.elementorWidgetWrapper = '.elementor-widget-n-menu'),
            ...
            (e.selectors.menuItem = '.e-n-menu-item'),
            (e.selectors.tabTitle = '.e-n-menu-title'),
            (e.selectors.tabTitleText = '.e-n-menu-title-text'),
            (e.selectors.directTabTitle =
              ':scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-title'),
            (e.selectors.tabClickableTitle = '.e-n-menu-title.e-click'),
            (e.selectors.tabDropdown = '.e-n-menu-dropdown-icon'),
            (e.selectors.menuContent = '.e-n-menu-content'),
            (e.selectors.tabContent = '.e-n-menu-content > .e-con, .e-n-menu-heading > .e-con'),
            (e.selectors.directTabContent =
            ...
            (e.selectors.tabContentBeforeInterlacing =
              '> .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con'),
            (e.selectors.newContainerAfterRepeaterAction =
        ...
        getDefaultElements() {
          ...
          return (
            ...
            (e.$menuItems = this.$element.find(t.menuItem)),
            ...
            (e.$tabContentsBeforeInterlacing = this.$element.find(t.tabContentBeforeInterlacing)),
            e
          );
        }
        ...
        handleContentContainerPosition() {
          ...
          (e = e || this.elements.$tabContents.filter(this.getTabContentFilterSelector(n))),
        ...
        activateTab(e) {
          ...
          this.addAnimationToContentIfNeeded(e),
            ...
            s.prev('.e-n-menu-title-container').find('a').attr(this.getTitleActivationAttributes('link')),
            this.elements.$menuContent.addClass(n),
            l.addClass(n),
            l.css({ display: 'var(--display)' }),
            l.removeAttr('display'),
            elementorFrontend.isEditMode() && l.length && this.activeContainerWidthListener(l),
        ...
        getTitleActivationAttributes() {
          const e = {};
          return (
            'tab' === (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'tab') &&
        ...
        changeActiveTab(e) {
          ...
          this.deactivateActiveTab(),
            (!i || (i && !t)) && ((this.clickInProgress = !0), this.activateTab(e)),
            setTimeout(() => {
        ...
        onMouseLeave(e) {
          ...
          this.isHoveredDropdownMenu(t, e) || this.deactivateActiveTab();
        }
        onInit() {
          if (
        ...
        setHorizontalTitleScrollValuesAndDispatch(e, t) {
          (0, r.setHorizontalTitleScrollValues)(e, this.getHorizontalScrollSetting(), t),
            elementorFrontend.elements.$window.trigger('elementor-pro/mega-menu/heading-mouse-event');
        }
        linkContainer(e) {
        ...
        updateIndexValues(e) {
          const {
            ...
            r = this.getSettings(),
            l = s[0].getAttribute('id').slice(0, -1);
          s.forEach((e, t) => {
            const n = t + 1,
              i = l + n,
            ...
            e.setAttribute('id', i),
              e.querySelector(r.selectors.tabDropdown)?.setAttribute('data-tab-index', n),
              e.querySelector(r.selectors.tabDropdown)?.setAttribute('id', a),
              e.querySelector(r.selectors.tabDropdown)?.setAttribute('aria-controls', s),
              e.querySelector(r.selectors.tabTitleText)?.setAttribute('data-binding-index', n),
              o[t]?.setAttribute('aria-labelledby', a),
        ...
        updateListeners(e) {
          const {
              selectors: { tabClickableTitle: t, tabDropdown: n, tabContent: i, tabTitle: o },
            } = this.getSettings(),
            s = e.find(o),
            r = e.find(t);
        ...
        changeMegaMenuTitleContainerTag(e) {
          const { element: t, actionName: n, value: i } = e.detail,
            ...
            l = this.maybeReplaceMenuItemTitleContent(o, r, s),
            a = t.dataset?.currentUrl || null;
          ...
          return t
            ? (Array.from(e.attributes).forEach((e) => {
              ...
              'A' === t.tagName
                ...
                : 'DIV' === t.tagName && t.classList.remove('e-link', 'e-focus'),
