      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        var _default = (exports['default'] = elementorModules.frontend.handlers.Base.extend({
          ...
          onError(xhr, desc) {
            const $form = this.elements.$form;
            $form.append(
              '<div class="elementor-message elementor-message-danger" role="alert">' + desc + '</div>',
            );
        ...
        class FormSteps extends elementorModules.frontend.handlers.Base {
          ...
          buildSteps() {
            this.elements.$stepWrapper.each((index, el) => {
              ...
              $currentStep.append(
                $currentStep.nextUntil(this.elements.$stepWrapper).not(this.elements.$submitWrapper),
              );
            });
          }
          ...
          createStepsIndicators() {
            ...
            if ('none' !== stepsSettings.step_type) {
              ...
              if ('progress_bar' === stepsSettings.step_type) {
                ...
                stepsElements.$progressBarMeter = stepsElements.$indicatorsWrapper.find(
          ...
          injectButtonsToSteps() {
            ...
            this.elements.$stepWrapper.each((index, el) => {
              ...
              if (index) {
                ...
                $nextButton =
                  index === totalSteps - 1 ? this.getSubmitButton() : this.getStepButton('next', index);
              } else {
