      ...
      class Cart extends i.default {
        ...
        applyButtonsHoverAnimation() {
          ...
          e.checkout_button_hover_animation &&
            jQuery('.checkout-button').addClass('elementor-animation-' + e.checkout_button_hover_animation),
            e.forms_buttons_hover_animation &&
              jQuery('.shop_table .button').addClass('elementor-animation-' + e.forms_buttons_hover_animation);
        }
