  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _baseTabs = _interopRequireDefault(
          __webpack_require__(/*! ./base-tabs */ '../modules/video-playlist/assets/js/frontend/base-tabs.js'),
        );
          ...
          activateInnerTabInEditMode() {
            if (this.isEdit && this.getEditSettings('innerActiveIndex')) {
              const innerTabActivated = this.getEditSettings('innerActiveIndex'),
                innerTabs = jQuery(
                  this.elements.$innerTabs.eq(this.currentPlaylistItemIndex - 1).find('.e-inner-tab-title a'),
                );
              ...
              playListItem.playerInstance.create().then(() => {
                ...
                playListItem.playerInstance.handleFullScreenChange((isEnterFullScreenMode) => {
                  ...
                  (0, _eventTrigger.default)(
                    this,
                    isEnterFullScreenMode ? 'videoFullScreen' : 'videoExitFullScreen',
                    'click',
                  );
                });
                ...
                playListItem.playerInstance.handlePlayed(() => {
                  ...
                  (0, _eventTrigger.default)(
                    this,
                    currentPlaylistItem.playerInstance.isVideoPausedLocal ? 'videoResume' : 'videoStart',
                    videoTrigger,
                  );
                });
  ...
  \*********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _playerBase = _interopRequireDefault(
          __webpack_require__(/*! ./player-base */ '../modules/video-playlist/assets/js/frontend/player-base.js'),
        );
        ...
        class playerYoutube extends _playerBase.default {
          ...
          async setVideoProviderData() {
            ...
            if (this.currentVideoID && 11 === this.currentVideoID.length) {
              this.playlistItem.thumbnail = {
                url:
                  'https://img.youtube.com/vi/' + this.playerObject.getVideoData().video_id + '/maxresdefault.jpg',
              };
