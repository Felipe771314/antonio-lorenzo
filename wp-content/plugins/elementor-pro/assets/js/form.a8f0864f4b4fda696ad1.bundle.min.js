          ...
          if (
            ...
            elementorFrontendConfig.experimentalFeatures.e_font_icon_svg && (s += ' elementor-message-svg'),
              void 0 !== e.data.message &&
                '' !== e.data.message &&
                t.append('<div class="' + s + '" role="alert">' + e.data.message + '</div>');
          } else
            e.data.errors &&
              ...
              t.trigger('error')),
              t.append(
                '<div class="elementor-message elementor-message-danger" role="alert">' + e.data.message + '</div>',
              );
        },
        onError(e, t) {
          ...
          if ('none' !== e.step_type) {
            ...
            (t.$indicatorsWrapper = jQuery('<div>', { class: n.join(' ') })),
              ...
              'progress_bar' === e.step_type
                ? ((t.$progressBar = t.$indicatorsWrapper.find(s.indicatorProgress)),
                  (t.$progressBarMeter = t.$indicatorsWrapper.find(s.indicatorProgressMeter)))
          ...
          this.elements.$stepWrapper.each((t, s) => {
            ...
            t
              ? (i.append(this.getStepButton('previous', t)),
                (n = t === e - 1 ? this.getSubmitButton() : this.getStepButton('next', t)))
        ...
        addRecaptcha() {
          ...
          this.elements.$form.on('reset error', () => {
            ...
            t
              ...
              : (s.push(r), this.elements.$submit.on('click', (e) => this.onV3FormSubmit(e, r)));
        }
        onV3FormSubmit(e, t) {
          e.preventDefault(),
            window.grecaptcha.ready(() => {
              ...
              grecaptcha.execute(t, { action: this.elements.$recaptcha.data('action') }).then((t) => {
                ...
                (!e[0].reportValidity || 'function' != typeof e[0].reportValidity || e[0].reportValidity()) &&
                  e.trigger('submit');
              });
            });
        }
