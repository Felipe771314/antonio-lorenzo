  ...
  [993],
  {
                  ...
                  createElement({
                    ...
                    children: [
                      document.createTextNode(
                        l === t ? d.replace('%s', n) : o('Save %s', 'elementor-pro').replace('%s', n),
                      ),
                    ],
                  }),
                ],
    ...
    2813: (e, t, n) => {
      ...
      class Loop extends i.default {
        ...
        attachEditDocumentHandle() {
          ...
          const t = this.getElementSettings(),
            ...
            s =
              ...
              ('[data-elementor-type="loop-item"]' === t?.edit_handle_selector ? `.elementor-${e}` : ''),
            i = this.$element.find(s).first()[0];
          i &&
            (this.isFirstEdit()
              ? this.$element.find('.elementor-swiper-button').remove()
              : (0, l.default)(
                  { element: i, title: o('Template', 'elementor-pro'), id: e },
                  l.EDIT_CONTEXT,
        ...
        onElementChange(e) {
          '_skin' === e && elementorPro.modules.loopBuilder.onApplySkinChange(),
            i.default.prototype.onElementChange.apply(this);
        }
        bindEvents() {
          super.bindEvents(),
        ...
        onInit() {
          super.onInit(...arguments),
            elementorFrontend.isEditMode() &&
              (this.doEditorInitAction(), this.attachEditDocumentHandle(), this.handleCTA());
        }
      }
      t.default = Loop;
    },
      ...
      t.default = elementorModules.frontend.handlers.Base.extend({
        ...
        fitImages() {
          ...
          t.isMasonryEnabled()
            ...
            : (this.elements.$postsContainer.toggleClass(o.classes.hasItemRatio, !!n.match(/\d/)),
