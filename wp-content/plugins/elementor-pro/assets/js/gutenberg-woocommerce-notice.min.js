...
(() => {
  ...
  var t = {
          ...
          createMethod = function (t) {
            return function (e, r, c) {
              ...
              var u,
                p = o(c, s);
              if (t && r != r) {
                for (; s > p; ) if ((u = a[p++]) != u) return !0;
              } else for (; s > p; p++) if ((t || p in a) && a[p] === r) return t || p || 0;
              return !t && -1;
            };
          };
      ...
      6726: (t, e, r) => {
        ...
        t.exports = function (t, e, r) {
          for (var a = o(e), s = c.f, u = i.f, p = 0; p < a.length; p++) {
            var f = a[p];
      ...
      8612: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          var r,
            ...
            m = t.global,
            y = t.stat;
          if ((r = m ? n : y ? n[h] || a(h, {}) : n[h] && n[h].prototype))
            for (p in e) {
              if (
                ((l = e[p]),
                (f = t.dontCallGetSet ? (v = o(r, p)) && v.value : r[p]),
                !u(m ? p : h + (y ? '.' : '#') + p, t.forced) && void 0 !== f)
              ) {
                if (typeof l == typeof f) continue;
                s(l, f);
              }
              (t.sham || (f && f.sham)) && i(l, 'sham', !0), c(r, p, l, t);
            }
        };
      },
      8473: (t) => {
      ...
      4483: (t, e, r) => {
        ...
        t.exports = {
          ...
          getterFor: function (t) {
            return function (e) {
              var r;
              if (!s(e) || (r = o(e)).type !== t) throw new m('Incompatible receiver, ' + t + ' required');
              return r;
            };
          },
        };
      ...
      169: (t, e, r) => {
        var n = r(4762),
          ...
          w = (t.exports = function (t, e, r) {
            'Symbol(' === m(v(e), 0, 7) && (e = '[' + y(v(e), /^Symbol\(([^)]*)\).*$/, '$1') + ']'),
              r && r.getter && (e = 'get ' + e),
              r && r.setter && (e = 'set ' + e),
              (!c(t, 'name') || (s && t.name !== e)) &&
                (a ? h(t, 'name', { value: e, configurable: !0 }) : (t.name = e)),
              b && r && c(r, 'arity') && t.length !== r.arity && h(t, 'length', { value: r.arity });
            try {
            ...
            var n = f(t);
            return c(n, 'source') || (n.source = g(d, 'string' == typeof e ? e : '')), t;
          });
      ...
      6742: (t, e, r) => {
        ...
        t.exports = function (t, e) {
          var r,
            ...
            u = 0,
            p = [];
          for (r in n) !o(a, r) && o(n, r) && s(p, r);
          for (; e.length > u; ) o(n, (r = e[u++])) && (~c(p, r) || s(p, r));
          return p;
        };
      },
      7611: (t, e) => {
      ...
      1: (t, e, r) => {
        ...
        t.exports = function (t) {
          return i(p, t) || (p[t] = a && i(u, t) ? u[t] : f('Symbol.' + t)), p[t];
        };
      },
      5724: (t, e, r) => {
        var n = r(8612),
  ...
  var r = __webpack_require__(2470).__;
      ...
      const c = {
        handleGutenbergEditorNotices() {
          wp.data.subscribe(async () => {
            const t = wp.data.select('core/block-editor').getBlocks();
            (i = this.getBlockNames(t)),
              1 === t.length && (i = this.maybeRemoveEmptyDefaultBlockFromBlockNames(t)),
              i.length !== e && (await this.maybeCreateNotice());
          });
        },
        getPostId: () => wp.data.select('core/editor').getCurrentPostId(),
        async maybeCreateNotice() {
          if (((e = i.length || 0), null === this.getPostId())) return;
          const t = ['woocommerce/cart', 'woocommerce/classic-shortcode'];
          if (!(void 0 !== Object.keys(i).find((e) => t.includes(i[e]))))
            return o && this.setCartNoticeDismissalState(!1), void this.removeNotice();
          (await this.shouldHideNotice()) ? this.removeNotice() : this.createNotice();
        },
        createNotice() {
          const t = r(
            ...
            e = r('Read More', 'elementor-pro');
          wp.data.dispatch('core/notices').createNotice('warning', t, {
            id: 'elementor-woocommerce-editor-block-notice',
            isDismissible: !0,
            actions: [
              {
                label: e,
                onClick: () => window.open('https://go.elementor.com/wp-dash-woocommerce-cart-block/', '_blank'),
              },
            ],
            onDismiss: () => this.setCartNoticeDismissalState(!0),
          });
        },
        removeNotice() {
        ...
        getCartNoticeDismissalState() {
          return fetch(`${elementorCommon.config.urls.rest}elementor-pro/v1/get-notice-dismissed/${this.getPostId()}`, {
            ...
            .then((t) => (t instanceof Response && (!t.ok || 400 <= t.status) ? {} : t.json()))
            .catch(() => ({}));
        },
        setCartNoticeDismissalState(t) {
          return fetch(`${elementorCommon.config.urls.rest}elementor-pro/v1/set-notice-dismissed`, {
            ...
            body: JSON.stringify({
              ...
              is_custom_wc_cart_notice_dismissed: t,
            }),
          })
            .then((e) =>
              e instanceof Response ? (!e.ok || 400 <= e.status ? {} : ((o = !0), (n = t), e.json())) : e.json(),
            )
            .catch(() => ({}));
        },
        async shouldHideNotice() {
          if (void 0 !== n) return n;
          const t = await this.getCartNoticeDismissalState(this.getPostId());
          return (
            t.hasOwnProperty('is_custom_wc_cart_notice_dismissed') && (o = !0),
            (n = 'true' === t.is_custom_wc_cart_notice_dismissed || !1),
            n
          );
        },
        getBlockNames(t, e = []) {
          return (
            ...
            Object.keys(t).forEach((e) => {
              const r = t[e];
              i.push(r.name);
              0 !== (r.innerBlocks?.length || 0) && this.getBlockNames(r.innerBlocks, i);
            }),
            i
          );
        },
        maybeRemoveEmptyDefaultBlockFromBlockNames: (t) =>
          1 === t.length && 'core/paragraph' === t[0].name && '' === t[0].attributes.content ? [] : i,
        init() {
