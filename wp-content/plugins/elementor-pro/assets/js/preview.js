...
*/
  ...
  \*******************************************/
    ...
    var _documentHandle = _interopRequireWildcard(
      __webpack_require__(/*! ./utils/document-handle */ '../assets/dev/js/preview/utils/document-handle.js'),
    );
      ...
      createDocumentsHandles() {
        Object.values(elementorFrontend.documentsManager.documents).forEach((document) => {
          const element = document.$element.get(0),
            { elementorTitle: title, customEditHandle: hasCustomEditHandle } = element.dataset;
