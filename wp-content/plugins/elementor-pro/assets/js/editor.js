...
/******/ (() => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          addControlError(controlName, error, location = '.elementor-control-content') {
            ...
            $el
              .find(location)
              .first()
              .after(`<span class="elementor-control-field-description e-control-error">${error}</span>`);
          },
          /**
  ...
  \*********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function createHandleElement({ title, onClick }, context, element = null) {
          const handleTitle = ['header', 'footer'].includes(element?.dataset.elementorType)
            ? '%s'
              ...
              success(data) {
                ...
                if (data.font_url) {
                  elementor.$previewContents
                    .find('link')
                    .last()
                    .after('<link href="' + data.font_url + '" rel="stylesheet" type="text/css">');
                }
              },
            });
  ...
  \******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ */ '../modules/forms/assets/js/editor/hooks/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = class extends elementor.modules.controls.Repeater {
          ...
          initialize(...args) {
            ...
            this.listenTo(formFields, 'change', (model) => this.onFormFieldChange(model)).listenTo(
              formFields,
              'remove',
              (model) => this.onFormFieldRemove(model),
            );
          }
          getFirstChild() {
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class FormFieldsAddFirstStep extends $e.modules.hookData.After {
          ...
          getConditions(args) {
            const { containers = [args.container] } = args;
            return (
              'form' === containers[0].parent.parent.model.get('widgetType') && 'step' === args.settings.field_type
            );
          }
          apply(args) {
            const { containers = [args.container] } = args;
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          onApiUpdate() {
            ...
            if (
              ...
              ('' === apikeyControlView.getControlValue() || '' === apiUrlControlView.getControlValue())
            ) {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          updatGetResonseList() {
            ...
            self
              .getCache('fields', 'get_fields', cacheKey, {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          onApiUpdate() {
            ...
            // Fetch data
            self
              .getMailchimpCache('lists', 'lists', cacheKey)
              .done(function (data) {
          ...
          updatMailchimpList() {
            ...
            // Fetch The data
            self
              .getMailchimpCache('list_details', 'list_details', controlView.getControlValue(), {
  ...
  \***************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/forms/assets/js/editor/component.js'),
        );
        class FormsModule extends elementorModules.editor.utils.Module {
          onElementorInit() {
            const ReplyToField = __webpack_require__(
              ...
              EmailDeliverability = __webpack_require__(
                /*! ./hints/email-deliverability */ '../modules/forms/assets/js/editor/hints/email-deliverability.js',
              );
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          getDataSettings(item) {
            ...
            switch (config.type) {
              case 'v3':
                recaptchaData +=
                  ' data-action="form" data-size="invisible" data-badge="' + item.recaptcha_badge + '"';
                break;
              case 'v2_checkbox':
            ...
            return (
              '<div class="elementor-g-recaptcha' + _.escape(item.css_classes) + '" ' + recaptchaData + '></div>'
            );
          },
          filterItem(item) {
  ...
  \**************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands/ */ '../modules/global-widget/assets/js/editor/commands/index.js'),
        );
        ...
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ */ '../modules/global-widget/assets/js/editor/hooks/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
          ...
          updateGlobalsRecursive(targetContainer) {
            ...
            elementor.getPreviewContainer().forEachChildrenRecursive((container) => {
              ...
              if (
                ...
                parseInt(container.model.get('templateID')) === parseInt(targetContainer.model.get('templateID'))
              ) {
                modelsToUpdate.forEach((modelName) => {
                  const model = targetContainer[modelName];
                  if (model instanceof Backbone.Model) {
                    const accordingTo =
                      'settings' === modelName ? targetContainer.settings.attributes : model.changed;
        ...
        class GlobalWidgetLoadTemplates extends $e.modules.hookData.After {
          ...
          addTemplateToCache(id) {
            const container = elementor
              .getPreviewContainer()
              .findChildrenRecursive((i) => parseInt(i.model.get('templateID')) === parseInt(id));
            if (!container) {
  ...
  \***********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/global-widget/assets/js/editor/component.js'),
        );
        class Module extends elementorModules.editor.utils.Module {
        ...
        class Model extends ElementModel {
          ...
          initSettingsFromTemplate() {
            const id = this.get('templateID'),
              component = $e.components.get('document/global'),
              data =
                $e.data.getCache(component, `document/global/global-widget/templates/${id}`) || this.attributes,
  ...
  \*************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ */ '../modules/loop-builder/assets/js/editor/hooks/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \**********************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/loop-builder/assets/js/editor/component.js'),
        );
        var _behavior = _interopRequireDefault(
          __webpack_require__(/*! ./behavior */ '../modules/loop-builder/assets/js/editor/behavior.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
        ...
        class loopBuilderModule extends elementorModules.editor.utils.Module {
          ...
          getCtaStyles = () => {
            ...
            ctaStyle.setAttribute(
              'href',
              `${elementorAppProConfig.baseUrl}/assets/css/modules/loop-grid-cta.min.css`,
            );
            return ctaStyle;
          };
          ...
          updateControlQuery = ({ control, controlView, postType, shouldResetControlValues }) => {
            control.set({
              autocomplete: {
                object: 'tax',
                query: {
  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var commands = _interopRequireWildcard(
          __webpack_require__(/*! ./commands/ */ '../modules/page-transitions/assets/js/editor/commands/index.js'),
        );
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ */ '../modules/page-transitions/assets/js/editor/hooks/index.js'),
        );
  ...
  \**************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/page-transitions/assets/js/editor/component.js'),
        );
        class _default extends elementorModules.editor.utils.Module {
          /**
  ...
  \******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _stripe = _interopRequireDefault(
          __webpack_require__(/*! ./stripe */ '../modules/payments/assets/js/editor/stripe.js'),
        );
  ...
  \******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ */ '../modules/popup/assets/js/editor/hooks/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \***************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/popup/assets/js/editor/component.js'),
        );
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          onElementorPreviewLoaded() {
            ...
            __webpack_require__
              .e(/*! import() */ 'modules_query-control_assets_js_editor_template-query-control_js')
              .then(
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var dataHooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/data */ '../modules/screenshots/assets/js/editor/hooks/data/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \*********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/screenshots/assets/js/editor/component.js'),
        );
        class Module extends elementorModules.editor.utils.Module {
          onElementorInit() {
            $e.components.register(new _component.default());
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ui */ '../modules/scroll-snap/assets/js/editor/hooks/ui/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \*********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/scroll-snap/assets/js/editor/component.js'),
        );
        class Module extends elementorModules.editor.utils.Module {
          /**
           * Init
      ...
      /***/ (module) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          hasCounter(networkName, settings) {
            return (
              'icon' !== settings.view && 'yes' === settings.show_counter && this.config[networkName].has_counter
            );
          },
        });
      ...
      /***/ (module) => {
        ...
        module.exports = elementor.modules.controls.RepeaterRow.extend({
          ...
          onRender() {
            ...
            if (
              !conditionConfig ||
              (_.isEmpty(conditionConfig.sub_conditions) && _.isEmpty(conditionConfig.controls)) ||
        ...
        class ThemeBuilderRemoveEditorUI extends $e.modules.hookUI.After {
          ...
          removePanelFooterSubmenuItems() {
            ...
            behavior.ui.buttonPreview
              .tipsy('enable')
              .removeClass('elementor-panel-footer-theme-builder-buttons-wrapper elementor-toggle-state');
          }
          removePublishTabs() {
            const component = $e.components.get('theme-builder-publish');
            ...
            $e.run('document/save/auto', {
              ...
              onSuccess: () => {
                ...
                const isInitialDocument =
                  elementor.config.initial_document.id === elementor.documents.getCurrentId();
  ...
  \**********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _content = _interopRequireDefault(
          __webpack_require__(/*! ./content */ '../modules/theme-builder/assets/js/editor/publish/content.js'),
        );
        var _layout = _interopRequireDefault(
          __webpack_require__(/*! ./layout */ '../modules/theme-builder/assets/js/editor/publish/layout.js'),
        );
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ../hooks */ '../modules/theme-builder/assets/js/editor/hooks/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ui */ '../modules/video-playlist/assets/js/editor/hooks/ui/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/video-playlist/assets/js/editor/component.js'),
        );
        class Module extends elementorModules.editor.utils.Module {
          /**
           * Init
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports['default'] = void 0;
        var hooks = _interopRequireWildcard(
          __webpack_require__(/*! ./hooks/ */ '../modules/woocommerce/assets/js/editor/hooks/index.js'),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
  ...
  \*********************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _component = _interopRequireDefault(
          __webpack_require__(/*! ./component */ '../modules/woocommerce/assets/js/editor/component.js'),
        );
        class WoocommerceModule extends elementorModules.editor.utils.Module {
          ...
          onElementorFrontendInit() {
            ...
            if (
              ...
              'product' === elementor.documents.currentDocument.config.settings.settings.source
            ) {
            ...
            for (const section of noticeSections) {
              elementor.channels.editor.on('kit_settings:' + section + ':activated', () => {
                this.renderMockNotices(
                  elementor.documents.getCurrent().container.settings.get('woocommerce_notices_elements'),
                );
              });
            }
          ...
          onUpdateDocument() {
            ...
            if (
              postId ===
              elementorPro.config.woocommerce.woocommercePages[lastWidgetCreatedOptions.woocommercePageName]
            ) {
              return;
            }
          ...
          openSiteSettingsTab(tabId = '', sectionId = '') {
            ...
            const isInSettingsPanelActive =
              'panel/global/menu' === elementor.documents.currentDocument.config.panel.default_route;
...
*/
  ...
  /******/ (() => {
    ...
    /******/ __webpack_require__.u = (chunkId) => {
      ...
      /******/ if (chunkId === 'modules_query-control_assets_js_editor_template-query-control_js')
        return '36c2990924ec9596ffad.bundle.js';
  ...
  \*****************************************/
    ...
    var _module11 = _interopRequireDefault(
      __webpack_require__(
    ...
    var ElementorPro = Marionette.Application.extend({
      ...
      initModules() {
        ...
        if (elementorCommon.config.experimentalFeatures['nested-elements']) {
          elementorCommon.elements.$window.on('elementor/nested-element-type-loaded', async () => {
            ...
            this.modules.nestedCarousel = new (
              await __webpack_require__
                .e(/*! import() | nested-carousel-editor */ 'nested-carousel-editor')
                .then(
                  __webpack_require__.bind(
                    __webpack_require__,
        ...
        if (elementorCommon.config.experimentalFeatures['nested-elements']) {
          elementorCommon.elements.$window.on('elementor/nested-element-type-loaded', async () => {
            // The module should be loaded only when `nestedElements` is available.
            this.modules.offCanvas = new (
              await __webpack_require__
                .e(/*! import() | off-canvas-editor */ 'off-canvas-editor')
                .then(
                  __webpack_require__.bind(
                    __webpack_require__,
                    /*! modules/off-canvas/assets/js/editor/module */ '../modules/off-canvas/assets/js/editor/module.js',
                  ),
                )
            ).default();
          });
