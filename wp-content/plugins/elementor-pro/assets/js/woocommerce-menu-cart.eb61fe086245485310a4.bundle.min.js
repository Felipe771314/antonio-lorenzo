      ...
      class _default extends elementorModules.frontend.handlers.Base {
        ...
        bindEvents() {
          ...
          'mouseover' === this.getElementSettings().open_cart
            ? (this.elements.$toggleWrapper.on('mouseover click', s.toggleButton, (e) => {
            ...
            elementorFrontend.elements.$body.on('wc_fragments_refreshed removed_from_cart added_to_cart', (e, t) =>
              this.refreshFragments(e.type, t),
            ),
            elementorFrontend.addListenerOnce(this.getUniqueHandlerID() + '_window_resize_dropdown', 'resize', () =>
