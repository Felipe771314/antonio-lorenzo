!(function () {
  'use strict';
  var e = window.elementorV2.store,
    t = window.elementorV2.editorV1Adapters,
    n = window.elementorV2.editorAppBar,
    i = window.wp.i18n,
    o = window.elementorV2.editorDocuments,
    C = window.React,
  ...
  function s(e) {
    return {
      id: e.id,
      locationKey: e.config.theme_builder?.settings?.location || null,
    };
  }
  var l = C.forwardRef((e, t) =>
      C.createElement(
        r.SvgIcon,
  ...
  function a() {
    const e = (0, o.__useActiveDocument)(),
      n = 'popup' === e?.type.value;
    return {
      icon: p,
      title: (0, i.__)('Triggers', 'elementor-pro'),
      visible: n,
      onClick: () => {
        (0, t.__privateOpenRoute)('theme-builder-publish/triggers');
      },
    };
  }
  function m() {
    ...
    return {
      icon: c.SettingsIcon,
      title: (0, i.__)('Advanced Rules', 'elementor-pro'),
      visible: n,
      onClick: () => {
        (0, t.__privateOpenRoute)('theme-builder-publish/timing');
      },
    };
  }
  function V() {
    const n = (function () {
        const t = (0, o.__useActiveDocument)(),
          n = (0, e.__useSelector)((e) => (t && e.documentsExtended.entities[t.id]) || null);
        return n ? { ...t, ...n } : null;
      })(),
      C = !!n?.locationKey;
    return {
      icon: l,
      title: (0, i.__)('Display Conditions', 'elementor-pro'),
      visible: C,
      onClick: () => {
        (0, t.__privateOpenRoute)('theme-builder-publish/conditions');
      },
    };
  }
  n.documentOptionsMenu.registerAction({
    id: 'popup-triggers',
    priority: 20,
    useProps: a,
  }),
    ...
    (0, e.__registerSlice)(d),
    (function () {
      const { init: n } = d.actions;
      (0, t.__privateListenTo)((0, t.v1ReadyEvent)(), () => {
        const t = u(),
          i = Object.entries(t.documents).reduce((e, [t, n]) => ((e[t] = s(n)), e), {});
        (0, e.__dispatch)(n({ entities: i }));
      });
    })(),
    (function () {
      const { addDocument: n } = d.actions;
      (0, t.__privateListenTo)((0, t.commandEndEvent)('editor/documents/open'), () => {
        const t = s(u().getCurrent());
        (0, e.__dispatch)(n(t));
      });
    })(),
    ((window.elementorV2 = window.elementorV2 || {}).editorDocumentsExtended = {});
})();
