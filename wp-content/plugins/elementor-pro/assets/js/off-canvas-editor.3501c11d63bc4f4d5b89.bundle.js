...
(self['webpackChunkelementor_pro'] = self['webpackChunkelementor_pro'] || []).push([
  ...
  \********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _offCanvas = _interopRequireDefault(
          __webpack_require__(/*! ./off-canvas */ '../modules/off-canvas/assets/js/editor/off-canvas.js'),
        );
        class Module extends elementorModules.editor.utils.Module {
          ...
          populateOffCanvasDropdownOptions = (eventName, ...args) => {
            ...
            for (const offCanvasWidget of offCanvasWidgets) {
              ...
              const offCanvasName = offCanvasWidget
                .querySelector(`#off-canvas-${offCanvasId}`)
          ...
          getOffCanvasWidgetsForCurrentDocument() {
            return elementor.$previewContents[0].querySelectorAll(
              `[data-elementor-id="${elementor.config.document.id}"] .elementor-widget-off-canvas`,
            );
          }
  ...
  */
          ...
          onInit() {
            elementor.channels.editor.on(
              'editor:widget:off-canvas:section_layout:activated',
              this.showOffCanvas.bind(this),
            );
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _emptyComponent = _interopRequireDefault(
          __webpack_require__(
            /*! ./components/empty-component */ '../modules/off-canvas/assets/js/editor/components/empty-component.js',
          ),
        );
