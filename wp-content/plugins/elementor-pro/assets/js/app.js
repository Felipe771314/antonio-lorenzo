...
/******/ (() => {
  ...
  \*******************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _connectButton = _interopRequireDefault(
          __webpack_require__(/*! ../ui/connect-button */ '../core/app/assets/js/ui/connect-button.js'),
        );
  ...
  \***********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class ConditionsProvider extends _baseContext.default {
           ...
           */
          componentDidMount() {
            this.executeAction(ConditionsProvider.actions.FETCH_CONFIG, () => _conditionsConfig.default.create())
          ...
          saveConditions() {
            ...
            return this.executeAction(ConditionsProvider.actions.SAVE, () =>
              ...
              const contextConditions = Object.values(this.state.conditions).map((condition) =>
                condition.forContext(),
              );
              this.props.onConditionsSaved(this.props.currentTemplate.id, {
                ...
                isActive: !!(
                  Object.keys(this.state.conditions).length && 'publish' === this.props.currentTemplate.status
                ),
              });
            });
          }
  ...
  \***********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function useTemplatesScreenshot(templateType = null) {
          const { updateTemplateItemState, templates } = React.useContext(_templates.Context);
          ...
          React.useEffect(() => {
            screenshot.posts
              .filter((post) => post.status === _useScreenshot.SCREENSHOT_STATUS_SUCCEED)
              .forEach((post) =>
          ...
          React.useEffect(() => {
            screenshot.posts
              .filter((post) => post.status === _useScreenshot.SCREENSHOT_STATUS_FAILED)
              .forEach((post) =>
                updateTemplateItemState(post.id, {
                  screenshot_url: null,
                }),
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement('b', null, __('Instances', 'elementor-pro'), ':'),
              ),
              /*#__PURE__*/ _react.default.createElement(
                _appUi.Text,
                {
        ...
        const SiteTemplateHeader = (props) => {
          const status = props.status && 'publish' !== props.status ? ` (${props.status})` : '',
            ...
            IndicatorDot = props.showInstances
              ? /*#__PURE__*/ _react.default.createElement(_indicatorBullet.Indicator, {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            props.extended && /*#__PURE__*/ _react.default.createElement(MetaData, null),
            props.extended && /*#__PURE__*/ _react.default.createElement(ActionButtons, null),
          );
        };
        ...
        function SiteTemplate(props) {
          ...
          const CardFooter =
            props.extended && props.showInstances
              ? /*#__PURE__*/ _react.default.createElement(_siteTemplateFooter.SiteTemplateFooter, props)
              : '';
          return /*#__PURE__*/ _react.default.createElement(
            _appUi.Card,
            {
            ...
            /*#__PURE__*/ _react.default.createElement(_siteTemplateHeader.SiteTemplateHeader, props),
            /*#__PURE__*/ _react.default.createElement(_siteTemplateBody.SiteTemplateBody, props),
            CardFooter,
          );
        }
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function SiteTemplates(props) {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(_dialogsAndButtons.PartActionsDialogs, null),
            action.error &&
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement(
                ...
                isLocked && /*#__PURE__*/ _react.default.createElement(ConnectButton, null),
              ),
            ),
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function ConditionConflicts(props) {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            __('Elementor recognized that you have set this location for other templates: ', 'elementor-pro'),
            ' ',
            conflictLinks,
          );
        }
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function ConditionSubId(props) {
          const settings = _react.default.useMemo(
            () => (Object.keys(props.subIdAutocomplete).length ? getSettings(props.subIdAutocomplete) : null),
  ...
  \*************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _conditionButtonPortal = _interopRequireDefault(
          __webpack_require__(
            /*! ./condition-button-portal */ '../core/app/modules/site-editor/assets/js/pages/conditions/condition-button-portal.js',
          ),
        );
        function ConditionsRows(props) {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              props?.loadPortal
                ? /*#__PURE__*/ _react.default.createElement(
                    _conditionButtonPortal.default,
                    null,
                    /*#__PURE__*/ _react.default.createElement(SaveButton, null),
                  )
                : /*#__PURE__*/ _react.default.createElement(SaveButton, null),
            ),
          );
  ...
  \********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Conditions(props) {
          const { findTemplateItemInState, updateTemplateItemState } = _react.default.useContext(
              _templates.Context,
            ),
  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Import() {
          const { importTemplates, action, resetActionState } = _react.default.useContext(_templates.Context),
  ...
  \************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function TemplateType(props) {
          const { templateTypes } = _react.default.useContext(_siteEditor.TemplateTypesContext),
  ...
  \*******************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function DialogDelete(props) {
          const { deleteTemplate, findTemplateItemInState } = _react.default.useContext(_templates.Context);
          ...
          return /*#__PURE__*/ _react.default.createElement(_appUi.Dialog, {
            ...
            text:
              __('Are you sure you want to move this item to trash:', 'elementor-pro') + ` "${template.title}"`,
  ...
  \*******************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function DialogRename(props) {
          const { findTemplateItemInState, updateTemplate } = _react.default.useContext(_templates.Context),
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _addNew = _interopRequireDefault(
          __webpack_require__(/*! ./pages/add-new */ '../core/app/modules/site-editor/assets/js/pages/add-new.js'),
        );
        var _conditions = _interopRequireDefault(
          __webpack_require__(
        ...
        var _import = _interopRequireDefault(
          __webpack_require__(/*! ./pages/import */ '../core/app/modules/site-editor/assets/js/pages/import.js'),
        );
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement(
                  ...
                  /*#__PURE__*/ _react.default.createElement(
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                      ...
                      /*#__PURE__*/ _react.default.createElement(
                        _router.Router,
                        null,
                        /*#__PURE__*/ _react.default.createElement(SiteEditorDefault, {
                          path: basePath,
                        }),
                ...
                /*#__PURE__*/ _react.default.createElement(
                  ...
                  window.location.href.indexOf('conditions') !== -1 &&
        ...
        function useScreenshot(initialPosts, { numberOfScreenshotInParallel } = defaultOptions) {
          ...
          useEffect(() => {
            const postsDiff = initialPosts.filter(
              (initialPost) => !posts.find((statePost) => statePost.id === initialPost.id),
            );
            if (!postsDiff.length) {
              return;
            }
