  ...
  \*******************************************************/
        ...
        class lottieHandler extends elementorModules.frontend.handlers.Base {
          ...
          setCaption() {
            ...
            if (
              ...
              ('media_file' === lottieSettings.source && 'custom' === lottieSettings.caption_source)
            ) {
    ...
    */
          ...
          getInitialFrameNumberByPercent(percent) {
            ...
            return (
              this.lottie.__initialFirstFrame +
              ((this.lottie.__initialTotalFrames - this.lottie.__initialFirstFrame) * percent) / 100
            );
          }
          ...
          isReverseMode() {
            ...
            return (
              ...
              ('reverse' === lottieSettings.on_hover_out && 'backward' === this.state.animationDirection)
            );
          }
      ...
      */
          ...
          onLoopStateChange() {
            const isInActiveViewportMode =
              'arriving_to_viewport' === this.state.currentAnimationTrigger && this.state.isInViewport;
