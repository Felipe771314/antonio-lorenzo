    ...
    3827: (e, t, s) => {
      ...
      class TOCHandler extends elementorModules.frontend.handlers.Base {
        ...
        getContainer() {
          ...
          if (e.container) return jQuery(n.default.sanitize(e.container));
        ...
        activateItem(e) {
          ...
          (s = e.hasClass(t.firstLevelListItem) ? e.parent().next() : e.parents('.' + t.listWrapper).eq(-2)),
            s.length ? ((this.$activeList = s), this.$activeList.stop().slideDown()) : delete this.$activeList;
        }
        ...
        followAnchor(e, t) {
          ...
          this.createObserver(s, i, { rootMargin: '0px', threshold: 0 }, e, t).observe(i[0]);
        }
        createObserver(e, t, s, i, n) {
          let l = 0;
          return new IntersectionObserver((e) => {
            e.forEach((e) => {
              const s = document.documentElement.scrollTop,
                a = s > l,
                o = t.attr('id');
              e.isIntersecting && !this.itemClicked
                ? ((this.viewportItems[o] = !0), this.activateItem(i))
                : e.isIntersecting && a
                  ? (delete this.viewportItems[o],
                    Object.keys(this.viewportItems).length && this.activateItem(this.$listItemTexts.eq(n + 1)))
                  : a || (delete this.viewportItems[o], this.activateItem(this.$listItemTexts.eq(n - 1))),
                (l = s <= 0 ? 0 : s);
            });
          }, s);
        }
        ...
        getNestedLevel(e) {
          ...
          i &&
            (l =
              elementorFrontend.config.experimentalFeatures.e_font_icon_svg && !elementorFrontend.isEditMode()
                ...
                : i.value
                  ? `<i class="${i.value}"></i>`
                  : '');
          let a = `<${t.listWrapperTag} class="${t.classes.listWrapper}">`;
          for (; this.listItemPointer < this.headingsData.length; ) {
            ...
            if (e === o.level) {
              (a += `<li class="${t.classes.listItem}">`), (a += `<div class="${t.classes.listTextWrapper}">`);
              let h = `<a href="#${o.anchorLink}" class="${r}">${o.text}</a>`;
              'bullets' === s.marker_view && i && (h = `${l}${h}`),
                (h = n.default.sanitize(h)),
                (a += h),
                (a += '</div>'),
                this.listItemPointer++;
              const c = this.headingsData[this.listItemPointer];
              c && e < c.level && (a += this.getNestedLevel(c.level)), (a += '</li>');
            }
          }
          return (a += `</${t.listWrapperTag}>`), a;
        }
        handleNoHeadingsFound() {
          const e = this.getElementSettings('no_headings_message');
        ...
        collapseBodyListener() {
          ...
          'desktop' === t || e.indexOf(t) >= e.indexOf(s) ? i || this.collapseBox(!1) : i && this.expandBox(!1);
        }
        onElementChange(e) {
        ...
        getHeadingAnchorLink(e, t) {
          ...
          return (
            s ? (n = s) : i && (n = i),
            s || i ? jQuery(this.elements.$headings[e]).data('hasOwnID', !0) : (n = `${t.headingAnchor}-${e}`),
            n
          );
        }
        setHeadingsData() {
        ...
        run() {
          if (((this.elements.$headings = this.getHeadings()), !this.elements.$headings.length))
        ...
        onListItemClick(e) {
          ...
          let n;
          i && t.hasClass(this.getSettings('classes.firstLevelListItem')) && s.is(':visible') && (n = !0),
            this.activateItem(t),
            i && n && s.slideUp();
        }
      }
