    ...
    1195: (e, t, s) => {
      ...
      class NestedCarousel extends elementorModules.frontend.handlers.CarouselBase {
        getDefaultSettings() {
          ...
          return (
            (e.selectors.carousel = '.e-n-carousel'), (e.selectors.slidesWrapper = '.e-n-carousel > .swiper-wrapper'), e
          );
        }
        getSwiperSettings() {
          ...
          return (
            elementorFrontend.isEditMode() &&
              (delete e.autoplay, (e.loop = !1), (e.noSwipingSelector = '.swiper-slide > .e-con .elementor-element')),
            'yes' === t.arrows &&
              (e.navigation = {
        ...
        applySwipeOptions(e) {
          this.isTouchDevice()
            ? ((e.touchRatio = 1), (e.longSwipesRatio = 0.3), (e.followFinger = !0), (e.threshold = 10))
            : (e.shortSwipes = !1);
        }
        isTouchDevice() {
