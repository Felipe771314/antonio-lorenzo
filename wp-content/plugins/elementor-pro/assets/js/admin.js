...
/******/ (() => {
        ...
        class CustomIcons extends _customAssetsBase.default {
          ...
          onSuccess(data) {
            ...
            if (data.data.config.duplicate_prefix) {
              ...
              return this.showAlertDialog('duplicate-prefix', this.getSettings('templates.duplicatePrefix'), () =>
        ...
        class CustomFontsManager extends _customAssetsBase.default {
          ...
          getPreviewStyle($table) {
            ...
            return {
              ...
              styleAttribute:
                'font-family: ' + fontFamily + ' ;font-style: ' + style + '; font-weight: ' + weight + ';',
            };
          }
          updateRowLabel(event, $table) {
            ...
            return this.renderTemplate(fontLabelTemplate, {
              ...
              preview:
                '<span style="' + previewStyle.styleAttribute + '">Elementor is making the web beautiful</span>',
              toolbar: toolbarHtml,
            });
          }
          ...
          onInit(...args) {
            ...
            $document.on(
              'change',
              'input[name$="variable_width]"], input[name$="variable_weight]"]',
              this.onFontVariableTypeChange,
            );
            markMetaboxIfVariableFont();
          }
          markMetaboxIfVariableFont() {
            ...
            jQuery('input[name$="variable_width]"], input[name$="variable_weight]"]').each(
              this.onFontVariableTypeChange,
            );
          }
  ...
  \*******************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = function () {
          ...
          jQuery(
            '.e-notice--cta.e-notice--dismissible[data-notice_id="site_mailer_forms_submissions_notice"] a.e-button--cta',
          ).on('click', function () {
  ...
  \***************************************/
    ...
    var _admin = _interopRequireDefault(
      __webpack_require__(/*! modules/popup/assets/js/admin/admin */ '../modules/popup/assets/js/admin/admin.js'),
    );
    var _admin2 = _interopRequireDefault(
      __webpack_require__(/*! ../../../../license/assets/js/admin */ '../license/assets/js/admin.js'),
    );
    const modules = {
