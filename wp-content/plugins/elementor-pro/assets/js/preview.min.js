      ...
      2098: (e, t, r) => {
        ...
        Object.defineProperty(t, '__esModule', { value: !0 }),
          ...
          (t.default = function addDocumentHandle(
            ...
            const p = (function createHandleElement({ title: e, onClick: t }, r, i = null) {
              const u = ['header', 'footer'].includes(i?.dataset.elementorType) ? '%s' : n('Edit %s', 'elementor-pro'),
                s = createElement({
                  tag: 'div',
                    ...
                    createElement({
                      ...
                      children: [
                        document.createTextNode(
                          a === r ? u.replace('%s', e) : n('Save %s', 'elementor-pro').replace('%s', e),
                        ),
                      ],
                    }),
                  ],
        ...
        function getHandleIcon(e) {
          let t = 'eicon-edit';
          return u === e && (t = elementorFrontend.config.is_rtl ? 'eicon-arrow-right' : 'eicon-arrow-left'), t;
        }
      ...
      8612: (e, t, r) => {
        ...
        e.exports = function (e, t) {
          var r,
            ...
            m = e.global,
            y = e.stat;
          if ((r = m ? n : y ? n[v] || c(v, {}) : n[v] && n[v].prototype))
            for (l in t) {
              if (
                ((f = t[l]),
      ...
      4483: (e, t, r) => {
        ...
        e.exports = {
          ...
          getterFor: function (e) {
            return function (t) {
              var r;
              if (!u(t) || (r = o(t)).type !== e) throw new m('Incompatible receiver, ' + e + ' required');
              return r;
            };
          },
        };
        ...
        var n = r(4762),
          ...
          w = (e.exports = function (e, t, r) {
            'Symbol(' === m(d(t), 0, 7) && (t = '[' + y(d(t), /^Symbol\(([^)]*)\).*$/, '$1') + ']'),
              ...
              g && r && a(r, 'arity') && e.length !== r.arity && v(e, 'length', { value: r.arity });
            try {
            ...
            var n = p(e);
            return a(n, 'source') || (n.source = h(b, 'string' == typeof t ? t : '')), e;
          });
  ...
  (() => {
    ...
    class Preview extends elementorModules.ViewModule {
      ...
      addDocumentClass() {
        ...
        e && e.$element && e.$element.parents('[data-elementor-id]').addClass('e-embedded-document-active');
      }
      removeDocumentClass() {
      ...
      createDocumentsHandles() {
        Object.values(elementorFrontend.documentsManager.documents).forEach((t) => {
          ...
          (0, e.default)({ element: r, title: n, id: i }, e.EDIT_CONTEXT, null, '.elementor-' + i);
        });
      }
