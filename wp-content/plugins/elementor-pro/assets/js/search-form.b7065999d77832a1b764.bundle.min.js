    ...
    9319: (e, t) => {
      ...
      t.default = elementorModules.frontend.handlers.Base.extend({
        ...
        bindEvents() {
          ...
          'full_screen' === i
            ? (r
                .on('click', () => (t.addClass(c.isFullScreen).addClass(c.lightbox), void n.trigger('focus')))
              ...
              s
                .on('click', () => (t.removeClass(c.isFullScreen).removeClass(c.lightbox), void r.trigger('focus')))
                .on('keyup', (e) => triggerClickOnEnterSpace(e)),
