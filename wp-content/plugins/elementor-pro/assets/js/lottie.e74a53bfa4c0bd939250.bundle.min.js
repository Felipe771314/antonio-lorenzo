  ...
  [970],
  {
    5200: (t, e) => {
      ...
      class lottieHandler extends elementorModules.frontend.handlers.Base {
        ...
        getAnimationPath() {
          const t = this.getLottieSettings();
          return t.source_json?.url && 'json' === t.source_json.url.toLowerCase().substr(-4)
            ? t.source_json.url
        ...
        playAnimationWhenBindToScroll() {
          ...
          (this.intersectionObservers.animation.observer = elementorModules.utils.Scroll.scrollObserver({
            ...
            (this.intersectionObservers.animation.element =
              'viewport' === t.effects_relative_to ? this.elements.$widgetWrapper[0] : document.documentElement),
            this.intersectionObservers.animation.observer.observe(this.intersectionObservers.animation.element);
        }
        ...
        getAnimationFrames() {
          ...
          return (
            ...
            'backward' === this.state.animationDirection &&
              this.isReverseMode() &&
              ((n = e), (o = i && i > this.lottie.__initialFirstFrame ? i : this.lottie.__initialFirstFrame)),
            {
              first: n,
              last: o,
              current: e,
        ...
        getInitialFrameNumberByPercent(t) {
          return (
            ...
            this.lottie.__initialFirstFrame +
              ((this.lottie.__initialTotalFrames - this.lottie.__initialFirstFrame) * t) / 100
          );
        }
          ...
          (this.state.isNewLoopCycle = !0),
            t.loop && !this.isReverseMode()
              ...
              : t.loop && this.isReverseMode()
                ...
                : !t.loop && this.isReverseMode() && this.setReverseAnimationOnSingleTrigger();
        }
        isReverseMode() {
          const t = this.getLottieSettings();
          return (
            'yes' === t.reverse_animation ||
            ('reverse' === t.on_hover_out && 'backward' === this.state.animationDirection)
          );
        }
        ...
        onLottieIntersection(t) {
          if (t.isInViewport)
            this.state.isAnimationScrollUpdateNeededOnFirstLoad &&
              ((this.state.isAnimationScrollUpdateNeededOnFirstLoad = !1), this.updateAnimationByScrollPosition()),
        ...
        onAnimationFrameRequest() {
          window.scrollY !== this.animationFrameRequest.lastScrollY &&
            (this.updateAnimationByScrollPosition(), (this.animationFrameRequest.lastScrollY = window.scrollY)),
            (this.animationFrameRequest.timer = requestAnimationFrame(() => this.onAnimationFrameRequest()));
        }
      }
