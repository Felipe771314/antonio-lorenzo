    ...
    9585: (e, t, n) => {
      ...
      class BaseFilterFrontendModule extends elementorModules.Module {
        ...
        updateURLQueryString(e, t) {
          ...
          (r =
            i.pageNum > 1 ? (r ? this.formatQueryString(i.baseUrl, r) : i.baseUrl) : r ? `?${r}` : location.pathname),
          ...
          super.onInit(),
            ...
            this.isEdit
              ...
              : (this.$element.show().remove(),
                ...
                elementorFrontend.isEditMode() ||
                  (elementorFrontend.isWPPreviewMode() && elementorFrontend.config.post.id === this.getSettings('id')
                    ? this.showModal()
                    : this.startTiming()));
        }
        onSettingsChange(e) {
