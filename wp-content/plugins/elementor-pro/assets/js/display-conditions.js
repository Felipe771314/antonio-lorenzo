...
/******/ (() => {
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _app = _interopRequireDefault(
          __webpack_require__(/*! ./app */ '../modules/display-conditions/assets/js/editor/app.js'),
        );
  ...
  \*********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const CacheNotice = ({ setCacheNoticeStatus }) => {
  ...
  \********************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _useConditions = _interopRequireDefault(
          __webpack_require__(
            /*! ../hooks/use-conditions */ '../modules/display-conditions/assets/js/editor/hooks/use-conditions.js',
          ),
        );
        var _ui = __webpack_require__(/*! @elementor/ui */ '@elementor/ui');
        var _controlRenderer = _interopRequireDefault(
          __webpack_require__(
            /*! ./control-renderer */ '../modules/display-conditions/assets/js/editor/components/control-renderer.js',
          ),
        );
        var _conditionSelectControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/ui/condition-select-control */ '../modules/display-conditions/assets/js/editor/components/controls/ui/condition-select-control.js',
          ),
        );
        var _conditionSelectOption = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/ui/condition-select-option */ '../modules/display-conditions/assets/js/editor/components/controls/ui/condition-select-option.js',
          ),
        );
        var _rowControls = _interopRequireDefault(
          __webpack_require__(
            /*! ./ui/row-controls */ '../modules/display-conditions/assets/js/editor/components/ui/row-controls.js',
          ),
        );
        ...
        var _constants = __webpack_require__(
          /*! ../utils/constants */ '../modules/display-conditions/assets/js/editor/utils/constants.js',
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          var r = new WeakMap(),
        ...
        const ConditionsRepeaterRow = ({ andConditionIndex, orConditionIndex }) => {
          const { selectedConditions, conditionsConfig, dispatch } = (0, _useConditions.default)(),
            { conditions: availableConditions, flattenedConditionOptions } = conditionsConfig,
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              _conditionSelectControl.default,
              {
                id: 'condition-select',
              ...
              flattenedConditionOptions.map(({ key, label, isGroup }) =>
                isGroup
                  ? /*#__PURE__*/ React.createElement(
                      _ui.ListSubheader,
                      {
                      ...
                      /*#__PURE__*/ React.createElement(
                        _conditionSelectOption.default,
                        {
                          variant: 'caption',
                          controlCount: controlCount,
                        },
            ...
            Object.keys(conditionControls).map((controlKey) =>
              /*#__PURE__*/ React.createElement(_controlRenderer.default, {
                key: controlKey,
  ...
  \*****************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ConditionsSelectors = ({ orConditionIndex }) => {
          const { selectedConditions } = (0, _useConditions.default)(),
            orCondition = selectedConditions[orConditionIndex];
          return /*#__PURE__*/ _react.default.createElement(
            _ui.Box,
            {
            ...
            orCondition.map((andCondition, andConditionIndex) =>
              /*#__PURE__*/ _react.default.createElement(_conditionsRepeaterRow.default, {
  ...
  \*******************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _orRowGroup = _interopRequireDefault(
          __webpack_require__(
            /*! ./or-row-group */ '../modules/display-conditions/assets/js/editor/components/or-row-group.js',
          ),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(
                ...
                __('It will only appear on your website when all the conditions are met.', 'elementor-pro'),
                ' ',
                /*#__PURE__*/ React.createElement(
                  _ui.Link,
                  {
              ...
              /*#__PURE__*/ React.createElement(_orRowGroup.default, props),
            ),
          );
        };
        ...
        const Content = ({
          ...
          const handleEmptyFieldsAndGetFirstInvalidIndex = () => {
            ...
            selectedConditions.forEach((orCondition, orConditionIndex) => {
              const { hasFoundInvalidConditionInConditionSet, invalidAndConditionIndex: andConditionIndex } =
          ...
          const handleInvalidRequiredKeysPerCondition = ({
            ...
            requiredKeys.forEach((controlKey) => {
              const value = andCondition[controlKey],
                { type, variant = null } = conditionsConfig.conditions[conditionKey].controls[controlKey];
              if (
                value?.length ||
                (0, _utils.shouldEmptyValuePassValidation)(andCondition.condition, andCondition.comparator)
              ) {
                return;
              }
          ...
          const handleSave = () => {
            const { hasFoundInvalidCondition, invalidOrConditionIndex, invalidAndConditionIndex } =
            ...
            if (hasFoundInvalidCondition) {
              ...
              setTimeout(
                () =>
                  conditionRepeaterRows?.scrollIntoView({
                    behavior: 'smooth',
                  }),
                100,
              );
  ...
  \*************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _selectControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/select-control */ '../modules/display-conditions/assets/js/editor/components/controls/select-control.js',
          ),
        );
        var _autocompleteControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/autocomplete-control */ '../modules/display-conditions/assets/js/editor/components/controls/autocomplete-control.js',
          ),
        );
        ...
        var _textFieldControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/text-field-control */ '../modules/display-conditions/assets/js/editor/components/controls/text-field-control.js',
          ),
        );
        var _datePickerControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/date-picker-control */ '../modules/display-conditions/assets/js/editor/components/controls/date-picker-control.js',
          ),
        );
        var _timePickerControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./controls/time-picker-control */ '../modules/display-conditions/assets/js/editor/components/controls/time-picker-control.js',
          ),
        );
        var _constants = __webpack_require__(
          /*! ../utils/constants */ '../modules/display-conditions/assets/js/editor/utils/constants.js',
        ...
        const ControlRenderer = ({ controlKey, andConditionIndex, orConditionIndex, controlCount }) => {
          const { conditionsConfig, selectedConditions, dispatch } = (0, _useConditions.default)(),
            { conditions: availableConditions } = conditionsConfig,
            orCondition = selectedConditions[orConditionIndex],
            andCondition = orCondition[andConditionIndex];
          const selectedConditionKey = andCondition.condition,
            { controls = {} } = availableConditions[selectedConditionKey],
          ...
          const getControlValueRelatedProps = (defaultAltValue) => {
            defaultAltValue = (0, _utils.getControlValue)(
              defaultAltValue,
              _constants.DEFAULT_CONTROL_VALUES[control.type],
            );
            const defaultValue = (0, _utils.getControlValue)(
                control?.default,
                Object.keys(options)[0] || defaultAltValue,
              ),
          ...
          const handleChangeOption = (value) => {
            const { type, variant } = controls[controlKey],
          ...
          const getDateAndTimeBasedControl = (variant) => {
            switch (variant) {
              case 'date':
                return /*#__PURE__*/ React.createElement(
                  _datePickerControl.default,
                  extractControlPropsFromGlobals(),
                );
              case 'time':
                return /*#__PURE__*/ React.createElement(
                  _timePickerControl.default,
                  extractControlPropsFromGlobals(),
                );
            }
          };
  ...
  \**************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _conditionSelectOption = _interopRequireDefault(
          __webpack_require__(
            /*! ./ui/condition-select-option */ '../modules/display-conditions/assets/js/editor/components/controls/ui/condition-select-option.js',
          ),
        );
        function _getRequireWildcardCache(e) {
          if ('function' != typeof WeakMap) return null;
  ...
  \*************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const formattedValue = (dateString) => {
          return (0, _dayjs.default)(dateString, dateFormat, true).isValid()
            ? (0, _dayjs.default)(dateString, dateFormat)
            : null;
        };
  ...
  \*******************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const QueryControl = ({
          ...
          const { fetchData } = (0, _react.useContext)(_conditionsContext.ConditionsContext),
  ...
  \********************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _conditionSelectControl = _interopRequireDefault(
          __webpack_require__(
            /*! ./ui/condition-select-control */ '../modules/display-conditions/assets/js/editor/components/controls/ui/condition-select-control.js',
          ),
        );
        var _conditionSelectOption = _interopRequireDefault(
          __webpack_require__(
  ...
  \************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const TextFieldControl = ({
          ...
          const [controlValue, setControlValue] = (0, _react.useState)(value),
            { step = 1, min = 0, variant = null } = control;
          const numericProps =
            'number' === variant
              ? {
                  type: 'number',
          ...
          return /*#__PURE__*/ React.createElement(
            _ui.TextField,
            (0, _extends2.default)({}, numericProps, {
              sx: {
                flex: 1,
              },
              error: shouldShowError,
  ...
  \*************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const formattedValue = (dateString) => {
          return (0, _dayjs.default)(dateString, timeFormat, true).isValid()
            ? (0, _dayjs.default)(dateString, timeFormat)
            : null;
        };
        const TimePickerControl = ({
          ...
          const handleChangeOption = (newValue) => {
            const dateString = (0, _dayjs.default)(newValue, dateFormat, true).isValid()
  ...
  \*********************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ConditionSelect = ({ controlCount, ...props }) =>
          /*#__PURE__*/ _react.default.createElement(
            _ui.Select,
  ...
  \********************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ConditionSelectOption = ({ controlCount, sx = {}, ...props }) =>
          /*#__PURE__*/ _react.default.createElement(
            _ui.Typography,
            (0, _extends2.default)(
              {
  ...
  \***************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const Footer = ({ onClickSaveButton, isButtonDisabled }) => {
          return /*#__PURE__*/ React.createElement(
            _ui.Stack,
            {
              direction: 'row',
  ...
  \*********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _conditionsOrDivider = _interopRequireDefault(
          __webpack_require__(
            /*! ./ui/conditions-or-divider */ '../modules/display-conditions/assets/js/editor/components/ui/conditions-or-divider.js',
          ),
        );
        var _constants = __webpack_require__(
          /*! ../utils/constants */ '../modules/display-conditions/assets/js/editor/utils/constants.js',
        ...
        const OrRowGroup = ({ showConditions, setShowConditions }) => {
          const { selectedConditions, conditionsConfig, dispatch } = (0, _useConditions.default)(),
            { conditions: availableConditions, conditionsByGroup } = conditionsConfig,
            addButtonText = selectedConditions.length
              ? __('Add condition group', 'elementor-pro')
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            null,
            showConditions &&
              selectedConditions.map((orCondition, orConditionIndex) =>
                /*#__PURE__*/ _react.default.createElement(
                  _react.Fragment,
                  {
                  ...
                  orConditionIndex > 0 &&
                    /*#__PURE__*/ _react.default.createElement(_conditionsOrDivider.default, null),
                  /*#__PURE__*/ _react.default.createElement(_conditionsSelectors.default, {
                    orConditionIndex: orConditionIndex,
                  }),
                ),
              ),
  ...
  \************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const RowControls = ({ orConditionIndex, andConditionIndex }) => {
          const { conditionsConfig, dispatch } = (0, _useConditions.default)(),
            { conditions: availableConditions, conditionsByGroup } = conditionsConfig;
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _behavior = _interopRequireDefault(
          __webpack_require__(/*! ./behavior */ '../modules/display-conditions/assets/js/editor/behavior.js'),
        );
        class Module extends elementorModules.editor.utils.Module {
          ...
          onElementorInit() {
            ...
            elTypes.forEach((type) => {
              elementor.hooks.addFilter(
                ...
                this.registerContextMenuGroups.bind(this),
              );
            });
          }
          ...
          registerContextMenuGroups(groups, currentElement) {
            ...
            if (-1 !== pasteStyleIndex) {
              clipboardGroup.actions.splice(pasteStyleIndex + 1, 0, {
                ...
                callback: () =>
                  $e.run(
                    'document/elements/paste-display-conditions',
                    elementor.selection.getElements(currentElement.getContainer()),
                  ),
              });
            }
            clipboardGroup.actions.push({
              ...
              callback: () =>
                $e.run(
                  'document/elements/clear-display-conditions',
                  elementor.selection.getElements(currentElement.getContainer()),
                ),
            });
            return groups;
          ...
          getSelectedElementDisplayCondition(selectedElement) {
            return JSON.parse(
              selectedElement?.model?.getSetting(this.getSettings('controls').displayConditions) || '[]',
            );
          }
          ...
          tryContextMenuActions(containers, action) {
            ...
            try {
              const controlView = container.panel.getControlView(this.getSettings('controls').displayConditions),
                icon = this.getEditorControlView(this.getSettings('controls').trigger).$el.find(
                  this.getSettings('selectors').icon,
                );
          ...
          registerControlBehavior = (behaviors, view) => {
            ...
            behaviors.displayConditions = {
              ...
              setControlValue: (value) => {
                const displayConditionsInput = this.getEditorControlView(
                    this.getSettings('controls').displayConditions,
                  ),
          ...
          highlightIcon = (icon, controlView) => {
            ...
            const conditionValue = controlView.getControlValue() || '[]',
              conditionArray =
                '[]' !== conditionValue ? this._getStructuredConditions(JSON.parse(conditionValue)) : [];
  ...
  \*************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            case _constants.ACTION_TYPES.REMOVE_OR_CONDITION:
              return {
                ...
                selectedConditions: state.selectedConditions.filter(
                  (_, index) => index !== action.orConditionIndex,
                ),
              };
        ...
        const _changeConditionType = ({
          ...
          const newOrCondition = selectedConditions[orConditionIndex].map((andCondition, index) =>
          ...
          return selectedConditions.map((orCondition, index) =>
            index === orConditionIndex ? newOrCondition : [...orCondition],
          );
        };
        const _changeControlValue = ({
          ...
          const newAndCondition = {
            ...
            newOrCondition = existingOrCondition.map((andCondition, index) =>
              index === andConditionIndex
                ? newAndCondition
                : {
                    ...andCondition,
        ...
        const _addAndCondition = ({ selectedConditions, orConditionIndex, andConditionIndex, andCondition }) => {
          const existingOrCondition = selectedConditions[orConditionIndex],
            newOrCondition = existingOrCondition.reduce((newAndConditions, condition, index) => {
              ...
              if (
                index === andConditionIndex ||
                (existingOrCondition.length === andConditionIndex && existingOrCondition.length - 1 === index)
              ) {
        ...
        const _removeAndCondition = ({ selectedConditions, orConditionIndex, andConditionIndex }) => {
          const newOrCondition = selectedConditions[orConditionIndex].reduce(
            (newAndConditions, condition, index) => {
        ...
        const _setErrors = ({ selectedConditions, orConditionIndex, andConditionIndex, errors }) => {
  ...
  \*************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        exports.DISABLED_CONTROL_CONFIG =
          exports.DEFAULT_CONTROL_VALUES =
  ...
  \*********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _constants = __webpack_require__(
          /*! ./constants */ '../modules/display-conditions/assets/js/editor/utils/constants.js',
        );
        ...
        const getControlDefaults = (controlKey, control) => {
          const { type, variant = null, options } = control,
            defaultValue =
              control?.default ||
              (options && _constants.CONTROL_TYPES.MULTIPLE_SELECT !== type
                ? Object.keys(options)[0]
                : _constants.DEFAULT_CONTROL_VALUES[type]),
            formattedDefaultValue =
              shouldCastToArray(type) && !Array.isArray(defaultValue) ? [defaultValue] : defaultValue,
        ...
        const getConditionInitialState = (conditions, conditionKey) => {
          const { controls = {} } = conditions?.[conditionKey] || {};
        ...
        function shouldDisableControl(control, comparator) {
          return (
            _constants.DISABLED_CONTROL_CONFIG.CONTROL_NAME === control &&
            _constants.DISABLED_CONTROL_CONFIG.COMPARATORS.includes(comparator)
          );
        }
        function shouldEmptyValuePassValidation(condition, comparator) {
          return (
            _constants.DISABLED_CONTROL_CONFIG.CONDITION_NAME === condition &&
            _constants.DISABLED_CONTROL_CONFIG.COMPARATORS.includes(comparator)
          );
        }
...
*/
  ...
  \***************************************************************/
    ...
    var _module = _interopRequireDefault(
      __webpack_require__(/*! ./module.js */ '../modules/display-conditions/assets/js/editor/module.js'),
    );
    new _module.default();
  })();
