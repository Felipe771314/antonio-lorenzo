        ...
        class OffCanvas extends elementorModules.frontend.handlers.Base {
          ...
          bindEvents() {
            ...
            elementorFrontend.elements.$window.on(
              'elementor-pro/off-canvas/toggle-display-mode',
              this.handleDisplayToggle.bind(this),
            );
          }
          unbindEvents() {
          ...
          getTriggerElements() {
            const links = elementorFrontend.elements.window.document.body.querySelectorAll('a'),
              unfilteredTriggerElements = Array.from(links).filter((link) =>
          ...
          updateAriaExpandedOfTriggerElements(isExpanded) {
            const triggerElements = elementorFrontend.elements.window.document.body.querySelectorAll(
              `[aria-controls="off-canvas-${this.getID()}"]`,
            );
            triggerElements.forEach((triggerElement) => {
