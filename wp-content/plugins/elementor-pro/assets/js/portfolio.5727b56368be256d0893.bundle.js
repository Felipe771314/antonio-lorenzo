  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _posts = _interopRequireDefault(
          __webpack_require__(/*! ./posts */ '../modules/posts/assets/js/frontend/handlers/posts.js'),
        );
        var _default = (exports['default'] = _posts.default.extend({
          ...
          handleEmptyColumns() {
            ...
            var settings = this.getSettings(),
              ...
              $ghostItems = this.elements.$postsContainer.find('.' + settings.classes.ghostItem),
              emptyColumns =
                (settings.colsCount - (($shownItems.length + $ghostItems.length) % settings.colsCount)) %
                settings.colsCount;
            ...
            setTimeout(function () {
              $activeItems.each(function () {
                ...
                setTimeout(function () {
                  $item.css(
                    'transform',
                    'translate3d(' + requiredOffset.start + 'px, ' + requiredOffset.top + 'px, 0)',
                  );
                });
              });
            });
        ...
        var _default = (exports['default'] = elementorModules.frontend.handlers.Base.extend({
          ...
          setColsCountSettings() {
            const settings = this.getElementSettings(),
              ...
              colsCount = elementorProFrontend.utils.controls.getResponsiveControlValue(
                settings,
                `${skinPrefix}columns`,
              );
          ...
          getVerticalSpaceBetween() {
            ...
            let verticalSpaceBetween = elementorProFrontend.utils.controls.getResponsiveControlValue(
