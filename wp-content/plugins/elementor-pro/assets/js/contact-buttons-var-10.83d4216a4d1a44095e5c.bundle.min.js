...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
  [61],
  {
    7263: (t, e, n) => {
      ...
      var i = s(n(8562)),
        o = s(n(8243));
      class ContactButtonsv10Handler extends i.default {
        getDefaultSettings() {
          return {
            selectors: {
        ...
        getDefaultElements() {
          ...
          return {
            ...
            links: this.$element[0].querySelectorAll(t.links),
          };
        }
        isMobileDevice() {
        ...
        handleLinkClick(t) {
          t.preventDefault();
          const { active: e } = this.getSettings('constants');
          if (t.currentTarget.classList.contains(e)) {
            const n = t.currentTarget.getAttribute('href'),
              s = t.currentTarget.getAttribute('target');
            s ? window.open(n, s) : n && (window.location.href = n), t.currentTarget.classList.remove(e);
          } else this.closeAllLinks(), t.currentTarget.classList.add(e);
        }
        closeAllLinks() {
          const { active: t } = this.getSettings('constants');
          this.elements.links.forEach((e) => e.classList.remove(t));
        }
        linksEventListeners() {
          this.elements.links.length &&
            ...
            document.addEventListener('click', (t) => {
              this.elements.main.contains(t.target) || this.closeAllLinks();
            }));
        }
        bindEvents() {
      ...
      e.default = ContactButtonsv10Handler;
    },
    8243: (t, e, n) => {
      var s = n(6784);
      Object.defineProperty(e, '__esModule', { value: !0 }), (e.default = void 0);
