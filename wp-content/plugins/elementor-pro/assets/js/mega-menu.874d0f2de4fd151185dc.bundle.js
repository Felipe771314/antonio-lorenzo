      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class AnchorLinks {
          ...
          followMenuAnchor($element) {
            const $targetElement = $element.hasClass(this.anchorClass)
              ? $element
              : $element.closest(`.${this.anchorClass}`);
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class MegaMenu extends elementorModules.frontend.handlers.NestedTabs {
          ...
          getDefaultSettings() {
            ...
            settings.selectors.directTabTitle =
              ':scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-title';
            ...
            settings.selectors.directTabContent =
              ':scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-content > .e-con, :scope > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con';
            settings.selectors.tabContentBeforeInterlacing =
              '> .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con';
            settings.selectors.newContainerAfterRepeaterAction =
              '> .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-con, > .elementor-widget-container > .e-n-menu > .e-n-menu-wrapper > .e-n-menu-heading > .e-n-menu-item > .e-n-menu-content > .e-con:nth-child( 2 )';
          ...
          handleContentContainerPosition() {
            ...
            $contentContainer =
              $contentContainer || this.elements.$tabContents.filter(this.getTabContentFilterSelector(tabIndex));
              ...
              const direction = elementorFrontend.config.is_rtl ? 'right' : 'left',
                menuItemContainerOffset =
                  0 < this.getMenuItemContainerAbsolutePosition($contentContainer)
                    ? this.getMenuItemContainerAbsolutePosition($contentContainer)
                    : 0;
          ...
          getLeftDirectionContainerOffset(contentContainerWidth, titleBoundingBox) {
            return elementorFrontend.config.is_rtl
              ? this.getRtlLeftDirectionContainerOffset(contentContainerWidth, titleBoundingBox)
          ...
          getRightDirectionContainerOffset(contentContainerWidth, titleBoundingBox) {
            return elementorFrontend.config.is_rtl
              ? this.getRtlRightDirectionContainerOffset(contentContainerWidth, titleBoundingBox)
          ...
          isNestedElementRenderedInContentContainer(elementView) {
            ...
            return elementAncestors.some(
              (parent) => this.getID().toString() === parent.model.get('id').toString(),
            );
          }
          getTabEvents() {
          ...
          onMouseTitleEnter(event) {
            ...
            const settings = this.getSettings(),
              ...
              currentTargetWidgetId = currentTarget
                ?.closest(settings.selectors.elementorWidgetWrapper)
          ...
          setLayoutType() {
            const layoutType =
              'none' === this.elements.$dropdownMenuToggle.css('display') ? 'horizontal' : 'dropdown';
          ...
          updateIndexValues(view) {
            const {
                selectors: { directTabTitle, directTabContent },
            ...
            tabTitles.forEach((element, index) => {
              ...
              element
                .querySelector(settings.selectors.tabDropdown)
                ?.setAttribute('aria-controls', updatedContainerID);
          ...
          updateListeners(view) {
            const {
                selectors: { tabClickableTitle, tabDropdown, tabContent, tabTitle },
              } = this.getSettings(),
          ...
          eCurrentClassHandler(actionName, closestMenuItemTitle, isCurrentUrl) {
            const settings = this.getSettings(),
              {
                classes: { activeAnchorItem: eCurrentClassName },
                postUrl,
                internalUrl,
              } = settings;
            switch (actionName) {
