    ...
    4992: (e, t) => {
      ...
      t.default = class DropdownMenuHeightController {
        ...
        reassignMenuHeight(e) {
          ...
          e.height() > t &&
            (e.css('height', this.calculateMenuTabContentHeight(e) + 'px'), e.css('overflow-y', 'scroll'));
        }
        resetMenuHeight(e) {
        ...
        prepareOptions(e) {
          ...
          jQuery.each(t, (n, i) => {
            ...
            jQuery.each(t, (t, n) => {
              ...
              if (!i) return;
              'effect' !== i[1] &&
                ('object' == typeof n && (n = Object.keys(n.sizes).length ? n.sizes : n.size), (a[i[1]] = n));
            });
    ...
    739: (e, t, n) => {
      ...
      class _default extends elementorModules.ViewModule {
        ...
        addBackgroundLayer() {
          ...
          (e.addBackgroundLayerTo ? this.$element.find(e.addBackgroundLayerTo) : this.$element).prepend(
            this.elements.$motionFXContainer,
          );
        }
    ...
    2121: (e, t) => {
      ...
      t.default = elementorModules.frontend.handlers.Base.extend({
        ...
        getResponsiveSettingList: (e) =>
          ['', ...Object.keys(elementorFrontend.config.responsive.activeBreakpoints)].map((t) => (t ? `${e}_${t}` : e)),
        getConfig() {
          ...
          return (
            ...
            e.sticky_parent && !s && (t.parent = '.e-con, .e-con-inner, .elementor-widget-wrap'),
            t
          );
        },
        activate() {
