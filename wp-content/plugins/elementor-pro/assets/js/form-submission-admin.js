  ...
  \***********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _item = _interopRequireDefault(
          __webpack_require__(/*! ./pages/item */ '../modules/forms/submissions/assets/js/admin/pages/item.js'),
        );
        var _pages = _interopRequireDefault(
          __webpack_require__(/*! ./pages */ '../modules/forms/submissions/assets/js/admin/pages/index.js'),
        );
        ...
        function DateFilter(props) {
          ...
          const selectedValue = useMemo(() => {
            ...
            const selected = options.find(
              (option) => option.filter.after === props.value.after && option.filter.before === props.value.before,
            );
            if (!selected) {
              return 'custom';
            }
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            props.isLoading
              ? /*#__PURE__*/ _react.default.createElement(
                  ...
                  ' \xA0',
                  /*#__PURE__*/ _react.default.createElement('span', null, ' ', ProgressPercentage, '% '),
                  ' \xA0',
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        Notice.propTypes = {
          model: PropTypes.shape({
            ...
            type: PropTypes.oneOf([_noticesContext.NOTICE_TYPE_SUCCESS, _noticesContext.NOTICE_TYPE_ERROR])
              .isRequired,
  ...
  \**************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _notice = _interopRequireDefault(
          __webpack_require__(/*! ./notice */ '../modules/forms/submissions/assets/js/admin/components/notice.js'),
        );
        function Notices() {
  ...
  \*********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _link = _interopRequireDefault(
          __webpack_require__(/*! ./link */ '../modules/forms/submissions/assets/js/admin/components/link.js'),
        );
              ...
              'a',
              {
                ...
                onClick: () =>
                  props.order.onChange({
                    by: props.order.key,
                    direction:
                      props.order.key === props.order.current.by && 'asc' === props.order.current.direction
                        ? 'desc'
                        : 'asc',
                  }),
              },
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            props.actions.map((action, index) => {
              ...
              return /*#__PURE__*/ _react.default.createElement(
                ...
                !isLastAction && /*#__PURE__*/ _react.default.createElement('span', null, '\xA0|\xA0'),
              );
            }),
          );
        }
  ...
  \************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function useExport(hookOptions) {
          ...
          const [exportSubmissions, { status: exportStatus }] = (0, _useDataAction.default)(
        ...
        function transformFormResultIntoBlob(formResult, currentDate) {
          return {
            filename: EXPORT_FILE_NAME_FORMAT.replace('{FORM_LABEL}', formResult.form_label)
  ...
  \*******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Index() {
          ...
          const [updateRead] = (0, _useDataAction.default)(([query, isRead], { abortController }) => {
          ...
          const [restoreItems] = (0, _useDataAction.default)(([query], { abortController }) => {
            if (!validateRestAction(query)) {
              return Promise.reject();
            }
            return $e.data
              ...
              .then((result) =>
                notifySuccess(_noticeMessages.default.restored.success(result.data.meta?.affected || 1)),
              )
              .then(fetchData)
              .catch(() => notifyError(_noticeMessages.default.restored.error()));
          });
          const [deleteItems] = (0, _useDataAction.default)(([query], { abortController }) => {
            if (!validateRestAction(query)) {
              return Promise.reject();
            }
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement(
                ...
                headerFooterRow &&
                  /*#__PURE__*/ _react.default.createElement(_wpTable.default.Header, null, headerFooterRow),
                /*#__PURE__*/ _react.default.createElement(
                ...
                headerFooterRow &&
                  /*#__PURE__*/ _react.default.createElement(_wpTable.default.Footer, null, headerFooterRow),
              ),
              /*#__PURE__*/ _react.default.createElement(
                'div',
                {
          ...
          const [update, { status: updateStatus }] = (0, _useDataAction.default)(
            ([values]) => {
              return $e.data
                ...
                .then(() => notifySuccess(_noticeMessages.default.updated.success(1)))
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement(
                          ...
                          ? data.values.map((value) =>
                              /*#__PURE__*/ _react.default.createElement(
                                ...
                                /*#__PURE__*/ _react.default.createElement(
                                  _wpTable.default.Cell,
                                  null,
                                  /*#__PURE__*/ _react.default.createElement(_submissionValue.default, {
                                    value: value.value,
                ...
                data.form_actions_log &&
                  /*#__PURE__*/ _react.default.createElement(_formActionsLog.default, {
                    ...
                    /*#__PURE__*/ _react.default.createElement(
                      ...
                      /*#__PURE__*/ _react.default.createElement(
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                          'strong',
                          null,
                          (0, _date.formatToLocalDateTime)(data.created_at),
                        ),
                      ),
                      /*#__PURE__*/ _react.default.createElement(
                        'div',
                        ...
                        /*#__PURE__*/ _react.default.createElement(
                          'strong',
                          null,
                          (0, _date.formatToLocalDateTime)(data.updated_at),
                        ),
                      ),
                      data.user_name &&
                        /*#__PURE__*/ _react.default.createElement(
                          ...
                          ' ',
                          /*#__PURE__*/ _react.default.createElement('strong', null, data.user_name),
                        ),
                      data.user_ip &&
                        /*#__PURE__*/ _react.default.createElement(
                          'div',
                          ...
                          ' ',
                          /*#__PURE__*/ _react.default.createElement('strong', null, data.user_ip),
                        ),
                      data.user_agent &&
                        /*#__PURE__*/ _react.default.createElement(
                          'div',
                          ...
                          ' ',
                          /*#__PURE__*/ _react.default.createElement('strong', null, data.user_agent),
                        ),
                    ),
                    /*#__PURE__*/ _react.default.createElement(
                      'div',
