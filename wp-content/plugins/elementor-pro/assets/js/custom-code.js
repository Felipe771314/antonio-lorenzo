        ...
        function ConditionsModal() {
          const [showModal, setShowModal] = (0, _react.useState)(false),
            ...
            onPostSubmit = () => {
              ...
              if (!title.$input.attr('value').length) {
                ...
                title.$input.attr(
                  'value',
                  __('Elementor Custom-Code #', 'elementor-pro') + elementorProAdmin.customCode.post.ID,
                );
              }
            },
            onPublishClick = (e) => {
          ...
          return /*#__PURE__*/ _react.default.createElement(
            ...
            /*#__PURE__*/ _react.default.createElement(
              ...
              /*#__PURE__*/ _react.default.createElement('b', null, data.instances + ' '),
            ),
            /*#__PURE__*/ _react.default.createElement(_appUi.Button, {
    ...
    class CustomCode extends elementorModules.Module {
      ...
      addOpenAIButton() {
        const $buttonOpenAI = jQuery(
          `<button class="e-ai-button"><i class="eicon-ai"></i> ${__('Code with AI', 'elementor-pro')}</button>`,
        );
