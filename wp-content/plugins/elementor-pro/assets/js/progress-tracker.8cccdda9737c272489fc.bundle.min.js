  ...
  [581],
  {
      ...
      r.default = class CircularProgress {
        constructor(e, r) {
          (this.settings = r),
            ...
            (this.circularProgressTracker = e.find('.elementor-scrolling-tracker-circular')[0]),
            ...
            (this.circularCurrentProgressPercentage =
              this.circularProgressTracker.getElementsByClassName('current-progress-percentage')[0]);
        ...
        updateProgress(e) {
          if (e <= 0)
            return (
              ...
              void (this.elements.circularCurrentProgressPercentage.style.display = 'none')
            );
          ...
          (this.lastKnownProgress = e),
            ...
            (this.elements.circularCurrentProgress.style.strokeDashoffset = 'ltr' === this.settings.direction ? -s : s),
            'yes' === this.settings.percentage &&
              (this.elements.circularCurrentProgressPercentage.innerHTML = Math.round(e) + '%');
        }
        onDestroy() {
    ...
    5138: (e, r) => {
      ...
      r.default = class LinearProgress {
        constructor(e, r) {
          (this.settings = r),
            (this.linearProgressTracker = e.find('.elementor-scrolling-tracker-horizontal')[0]),
            ...
            (this.linearCurrentProgressPercentage =
              this.linearProgressTracker.getElementsByClassName('current-progress-percentage')[0]),
            (this.elements = this.cacheElements());
        }
        cacheElements() {
          return {
          ...
          e < 1
            ...
            : ((this.elements.linearCurrentProgress.style.display = 'flex'),
              ...
              this.elements.linearCurrentProgress.getBoundingClientRect().width >
                1.5 * this.elements.linearCurrentProgressPercentage.getBoundingClientRect().width
                ? ((this.elements.linearCurrentProgressPercentage.innerHTML = Math.round(e) + '%'),
      ...
      class ProgressTracker extends elementorModules.frontend.handlers.Base {
        ...
        scrollHandler() {
          ...
          const e = this.getTrackingElementSelector(),
            r = e.is(elementorFrontend.elements.$body) || e.is(jQuery('#e-scroll-snap-container')) ? -100 : 0;
