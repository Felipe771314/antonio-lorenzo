      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class TaxonomyFilter extends elementorModules.frontend.handlers.Base {
          ...
          bindEvents() {
            ...
            this.resizeListenerNestedTabs = _flexHorizontalScroll.setHorizontalScrollAlignment.bind(
              this,
              settingsObject,
            );
          ...
          deactivateFilterButton(clickedFilter) {
            ...
            const $activeButton = $filterButtons.filter('[data-filter="' + clickedFilter + '"]'),
              ...
              isActivateDefaultFilterButtonNeeded =
                ...
                (!currentlyActiveButtons.includes(defaultFilter) && 1 === currentlyActiveButtons.length);
          ...
          populateLoopWidgetsStoreOnInitialPageLoad() {
            ...
            let selectedTermSlugs = urlParams.get(
              'e-filter-' + elementSettings.selected_element + '-' + elementSettings.taxonomy,
            );
